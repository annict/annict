...
### フェーズ 2: activities への anime_id 追加

- [ ] **2-1**: activities への anime_id 追加
...
### フェーズ 3: casts への anime_id 追加

- [ ] **3-1**: casts への anime_id 追加
...
### フェーズ 4: channel_works への anime_id 追加

- [ ] **4-1**: channel_works への anime_id 追加
...
### フェーズ 5: collection_items への anime_id 追加

- [ ] **5-1**: collection_items への anime_id 追加
