...
- [ ] **2-1**: Userモデルからfacebook関連コードとomniauthable設定を削除
...
- [ ] **2-2**: Providerモデルからfacebook関連コードを削除
...
- [ ] **3-1**: CallbacksController・FriendsControllerとルーティング設定を削除
