...
module Deprecated::Headers
  class WorkHeaderComponent < Deprecated::ApplicationV6Component
          ...
          h.tag :div, class: "container" do
            h.tag :div, class: "gx-3 row" do
              h.tag :div, class: "col-12 col-sm-auto" do
                h.tag :div, class: "c-work-header__work-picture text-center" do
                  ...
                  h.tag :div, class: "mt-2 text-center" do
                    h.html Deprecated::ButtonGroups::WorkButtonGroupComponent.new(view_context, work: @work).render
                  end
                end
              end
              ...
              h.tag :div, class: "col mt-3 mt-sm-0" do
                h.tag :div do
                  h.html Deprecated::Badges::WorkMediaBadgeComponent.new(view_context, work: @work).render
                  h.html Deprecated::Badges::WorkSeasonBadgeComponent.new(view_context, work: @work, class_name: "ms-2").render
                end
                ...
                h.tag :div, class: "mt-3" do
                  h.html Deprecated::Buttons::ShareToTwitterButtonComponent.new(
                    view_context,
