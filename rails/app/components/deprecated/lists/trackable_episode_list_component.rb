...
module Deprecated::Lists
  class TrackableEpisodeListComponent < Deprecated::ApplicationV6Component
        ...
        h.tag :div, id: "trackable-episode-list" do
          if @library_entries.present?
                        ...
                        h.tag :div, class: "col" do
                          ...
                          if started_at
                            h.tag :div, class: "small" do
                              ...
                              h.html Deprecated::Badges::SlotStartDateBadgeComponent.new(
                                view_context,
                      ...
                      if episode
                        h.tag :div, class: "align-items-center gx-3 mt-3 row" do
                          h.tag :div, class: "col-4" do
                            h.html Deprecated::Buttons::WatchEpisodeButtonComponent.new(
                              view_context,
                          ...
                          h.tag :div, class: "col-4" do
                            h.html Deprecated::Buttons::SkipEpisodeButtonComponent.new(
                              view_context,
            ...
            h.tag :div, class: "mt-3 text-center" do
              h.html Deprecated::ButtonGroups::PaginationButtonGroupComponent.new(view_context, collection: @library_entries, controller: @controller, action: @action).render
            end
          else
            h.tag :div, class: "container u-container-flat" do
              h.tag :div, class: "card u-card-flat" do
                h.tag :div, class: "card-body" do
                  h.html Deprecated::EmptyV6Component.new(view_context, text: t("messages.tracks.no_trackable_episodes")).render
                end
              end
            end
          end
