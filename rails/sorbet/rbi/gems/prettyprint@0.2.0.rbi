...
class PrettyPrint
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:226
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:157
  ...
  # specify this when +sep+ is a multibyte character, for example.
  #
  # pkg:gem/prettyprint#prettyprint.rb:214
  def fill_breakable(sep = T.unsafe(nil), width = T.unsafe(nil)); end

  # outputs buffered data.
  #
  # pkg:gem/prettyprint#prettyprint.rb:290
  def flush; end
  ...
  #   lambda {|n| ' ' * n}
  #
  # pkg:gem/prettyprint#prettyprint.rb:120
  def genspace; end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:251
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:126
  def group_queue; end

  # Takes a block and queues a new group that is indented 1 level further.
  #
  # pkg:gem/prettyprint#prettyprint.rb:262
  def group_sub; end

  # The number of spaces to be indented
  #
  # pkg:gem/prettyprint#prettyprint.rb:123
  def indent; end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:108
  def maxwidth; end

  # Increases left margin after newline with +indent+ for line breaks added in
  # the block.
  #
  # pkg:gem/prettyprint#prettyprint.rb:279
  def nest(indent); end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:113
  def newline; end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:103
  def output; end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:182
  ...
  class << self
    ...
    #   end
    #
    # pkg:gem/prettyprint#prettyprint.rb:47
    ...
    #
    # pkg:gem/prettyprint#prettyprint.rb:61
...
class PrettyPrint::Breakable
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:347
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:367
  def indent; end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:359
  def obj; end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:373
  def output(out, output_width); end

  # The width of +obj+ / +sep+
  #
  # pkg:gem/prettyprint#prettyprint.rb:362
  def width; end
end
...
class PrettyPrint::Group
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:401
  def initialize(depth); end

  # Makes a break for this Group, and returns true
  #
  # pkg:gem/prettyprint#prettyprint.rb:414
  def break; end

  # Boolean of whether this Group has made a break
  #
  # pkg:gem/prettyprint#prettyprint.rb:419
  def break?; end

  # Array to hold the Breakable objects for this Group
  #
  # pkg:gem/prettyprint#prettyprint.rb:411
  def breakables; end

  # This group's relation to previous groups
  #
  # pkg:gem/prettyprint#prettyprint.rb:408
  def depth; end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:426
  def first?; end
end
...
class PrettyPrint::GroupQueue
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:447
  def initialize(*groups); end

  # Remote +group+ from this queue
  #
  # pkg:gem/prettyprint#prettyprint.rb:479
  def delete(group); end

  # Returns the outer group of the queue
  #
  # pkg:gem/prettyprint#prettyprint.rb:463
  def deq; end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:456
  def enq(group); end
end
...
class PrettyPrint::SingleLine
  ...
  #               This argument is a noop.
  #
  # pkg:gem/prettyprint#prettyprint.rb:505
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:520
  def breakable(sep = T.unsafe(nil), width = T.unsafe(nil)); end

  # This is used as a predicate, and ought to be called first.
  #
  # pkg:gem/prettyprint#prettyprint.rb:552
  def first?; end

  # Method present for compatibility, but is a noop
  #
  # pkg:gem/prettyprint#prettyprint.rb:548
  def flush; end
  ...
  #
  # pkg:gem/prettyprint#prettyprint.rb:539
  def group(indent = T.unsafe(nil), open_obj = T.unsafe(nil), close_obj = T.unsafe(nil), open_width = T.unsafe(nil), close_width = T.unsafe(nil)); end
  ...
  # Yields to a block.
  #
  # pkg:gem/prettyprint#prettyprint.rb:527
  def nest(indent); end
  ...
  # +width+ argument is here for compatibility. It is a noop argument.
  #
  # pkg:gem/prettyprint#prettyprint.rb:513
  def text(obj, width = T.unsafe(nil)); end
end
...
class PrettyPrint::Text
  ...
  # Output the text to +out+, and increment the width to +output_width+
  #
  # pkg:gem/prettyprint#prettyprint.rb:323
  def output(out, output_width); end

  # The total width of the objects included in this Text object.
  #
  # pkg:gem/prettyprint#prettyprint.rb:318
  def width; end
end

# pkg:gem/prettyprint#prettyprint.rb:36
