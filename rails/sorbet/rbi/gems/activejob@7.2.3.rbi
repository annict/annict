...
#
# pkg:gem/activejob#lib/active_job/queue_adapters/delayed_job_adapter.rb:18
class ActiveJob::QueueAdapters::DelayedJobAdapter < ::ActiveJob::QueueAdapters::AbstractAdapter
  # pkg:gem/activejob#lib/active_job/queue_adapters/delayed_job_adapter.rb:19
  def initialize(enqueue_after_transaction_commit: T.unsafe(nil)); end

  # pkg:gem/activejob#lib/active_job/queue_adapters/delayed_job_adapter.rb:27
  def enqueue(job); end

  # pkg:gem/activejob#lib/active_job/queue_adapters/delayed_job_adapter.rb:23
  def enqueue_after_transaction_commit?; end

  # pkg:gem/activejob#lib/active_job/queue_adapters/delayed_job_adapter.rb:33
  def enqueue_at(job, timestamp); end
end

# pkg:gem/activejob#lib/active_job/queue_adapters/delayed_job_adapter.rb:39
class ActiveJob::QueueAdapters::DelayedJobAdapter::JobWrapper
  # pkg:gem/activejob#lib/active_job/queue_adapters/delayed_job_adapter.rb:42
  def initialize(job_data); end

  # pkg:gem/activejob#lib/active_job/queue_adapters/delayed_job_adapter.rb:46
  def display_name; end

  # pkg:gem/activejob#lib/active_job/queue_adapters/delayed_job_adapter.rb:40
  def job_data; end

  # pkg:gem/activejob#lib/active_job/queue_adapters/delayed_job_adapter.rb:40
  def job_data=(_arg0); end

  # pkg:gem/activejob#lib/active_job/queue_adapters/delayed_job_adapter.rb:54
  def perform; end

  private

  # pkg:gem/activejob#lib/active_job/queue_adapters/delayed_job_adapter.rb:59
  def log_arguments?; end
end
