...
# deprecated alias
#
# source://faraday_middleware//lib/faraday_middleware/request/oauth.rb#92
Faraday::Request::OAuth = FaradayMiddleware::OAuth

# deprecated alias
#
# source://faraday_middleware//lib/faraday_middleware/request/oauth2.rb#90
...
class FaradayMiddleware::Caching < ::Faraday::Middleware
  ...
  #
  # source://faraday_middleware//lib/faraday_middleware/response/caching.rb#39
  ...
  # source://faraday_middleware//lib/faraday_middleware/response/caching.rb#68
  def cache_key(env); end

  # source://faraday_middleware//lib/faraday_middleware/response/caching.rb#88
  def cache_on_complete(env); end

  # source://faraday_middleware//lib/faraday_middleware/response/caching.rb#49
  def call(env); end
  ...
  # @return [Boolean]
  #
  # source://faraday_middleware//lib/faraday_middleware/response/caching.rb#84
  def full_key?; end
  ...
  # source://faraday_middleware//lib/faraday_middleware/response/caching.rb#102
...
# * 410 - 'Gone'
#
# source://faraday_middleware//lib/faraday_middleware/response/caching.rb#19
...
class FaradayMiddleware::OAuth < ::Faraday::Middleware
  ...
  # source://faraday_middleware//lib/faraday_middleware/request/oauth.rb#66
  ...
  # @return [Boolean]
  #
  # source://faraday_middleware//lib/faraday_middleware/request/oauth.rb#76
  def include_body_params?(env); end

  # source://faraday_middleware//lib/faraday_middleware/request/oauth.rb#47
  def oauth_header(env); end

  # source://faraday_middleware//lib/faraday_middleware/request/oauth.rb#58
  ...
  # @return [Boolean]
  #
  # source://faraday_middleware//lib/faraday_middleware/request/oauth.rb#54
  def sign_request?(env); end

  # source://faraday_middleware//lib/faraday_middleware/request/oauth.rb#81
...
class FaradayMiddleware::OAuth2 < ::Faraday::Middleware
  ...
  # source://faraday_middleware//lib/faraday_middleware/request/oauth2.rb#79
...
module FaradayMiddleware::OptionsExtension
  ...
  #
  # source://faraday_middleware//lib/faraday_middleware/response_middleware.rb#97
  def each; end

  # source://faraday_middleware//lib/faraday_middleware/response_middleware.rb#104
  ...
  # source://faraday_middleware//lib/faraday_middleware/response_middleware.rb#93
  def to_hash; end
end
...
class FaradayMiddleware::ResponseMiddleware < ::Faraday::Middleware
  ...
  #
  # source://faraday_middleware//lib/faraday_middleware/response_middleware.rb#53
  def parse(body); end

  # @return [Boolean]
  #
  # source://faraday_middleware//lib/faraday_middleware/response_middleware.rb#80
  def parse_response?(env); end
  ...
  # source://faraday_middleware//lib/faraday_middleware/response_middleware.rb#43
  def process_response(env); end

  # @return [Boolean]
  #
  # source://faraday_middleware//lib/faraday_middleware/response_middleware.rb#74
  def process_response_type?(type); end

  # source://faraday_middleware//lib/faraday_middleware/response_middleware.rb#68
