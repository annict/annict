...
class RedisClient
  ...
  # source://redis-client//lib/redis_client.rb#359
  ...
  # source://redis-client//lib/redis_client.rb#295
...
module RedisClient::Config::Common
  ...
  # source://redis-client//lib/redis_client/config.rb#78
  def new_client(**kwargs); end

  # source://redis-client//lib/redis_client/config.rb#73
  ...
  # @return [Boolean]
  #
  # source://redis-client//lib/redis_client/config.rb#82
  def retry_connecting?(attempt, _error); end

  # @return [Boolean]
  #
  # source://redis-client//lib/redis_client/config.rb#69
  def sentinel?; end
  ...
  # source://redis-client//lib/redis_client/config.rb#65
  def username; end
...
class RedisClient::Pipeline < ::RedisClient::Multi
  ...
  # source://redis-client//lib/redis_client.rb#525
  def blocking_call(timeout, *command, **kwargs, &block); end

  # source://redis-client//lib/redis_client.rb#534
...
class RedisClient::PubSub
  ...
  #
  # source://redis-client//lib/redis_client.rb#404
  def initialize(raw_connection, command_builder); end

  # source://redis-client//lib/redis_client.rb#409
  def call(*command, **kwargs); end
