...
# This is an autogenerated file for dynamic methods in `Forum::ApplicationController`.
# Please instead update this file by running `bin/tapioca dsl Forum::ApplicationController`.


class Forum::ApplicationController
