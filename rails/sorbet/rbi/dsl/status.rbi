...
class Status
  ...
  module CommonRelationMethods
    ...
    sig { params(args: T.untyped).returns(T::Array[::Status]) }
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: T.any(Symbol, T::Array[Symbol])
      ).returns(T::Enumerator[T::Array[::Status]])
    end
  ...
  module GeneratedAssociationMethods
    # This method is created by ActiveRecord on the `Status` class because it declared `has_many :activities`.
    ...
    # This method is created by ActiveRecord on the `Status` class because it declared `has_many :likes`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
