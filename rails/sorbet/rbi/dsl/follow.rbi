...
# Please instead update this file by running `bin/tapioca dsl Follow`.
...
class Follow
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Follow).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.any(Integer, Float, BigDecimal)) }
    def average(column_name); end

    sig { params(block: T.nilable(T.proc.params(object: ::Follow).void)).returns(::Follow) }
    sig do
      params(
        attributes: T::Array[T.untyped],
        block: T.nilable(T.proc.params(object: ::Follow).void)
      ).returns(T::Array[::Follow])
    end
    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::Follow).void)).returns(::Follow) }
    ...
    sig { params(column_name: NilClass, block: T.proc.params(object: ::Follow).void).returns(Integer) }
    ...
    sig do
      params(
        records: T.any(::Follow, Integer, String, T::Enumerable[T.any(::Follow, Integer, String, T::Enumerable[::Follow])])
      ).returns(Integer)
    end
    ...
    sig { returns(T::Array[::Follow]) }
    def destroy_all; end

    sig { returns(T::Array[::Follow]) }
    def destroy_all; end

    sig { params(args: T.untyped).returns(T::Array[::Follow]) }
    ...
    sig do
      ...
      ).returns(T::Enumerable[::Follow])
    end
    sig { params(args: NilClass, block: T.proc.params(object: ::Follow).void).returns(T.nilable(::Follow)) }
    def find(args = nil, &block); end

    sig { params(args: T.untyped).returns(T.nilable(::Follow)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::Follow) }
    def find_by!(*args); end
    ...
    sig do
      params(
        ...
        block: T.proc.params(object: ::Follow).void
      ).void
    end
    sig do
      params(
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: T.any(Symbol, T::Array[Symbol]),
        block: T.proc.params(object: T::Array[::Follow]).void
      ).void
    end
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: T.any(Symbol, T::Array[Symbol])
      ).returns(T::Enumerator[T::Array[::Follow]])
    end
    ...
    sig do
      type_parameters(:U)
        .params(
          ...
          block: T.proc.params(object: ::Follow).returns(T.type_parameter(:U))
  ...
  module GeneratedAssociationRelationMethods
    ...
    sig { params(blk: T.proc.params(record: ::Follow).returns(BasicObject)).returns(T::Array[::Follow]) }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::Follow, T::Enumerable[T.any(::Follow, T::Enumerable[::Follow])])
    ...
    sig do
      params(
        other_array: T.any(::Follow, T::Enumerable[T.any(::Follow, T::Enumerable[::Follow])])
      ).returns(T::Array[::Follow])
    end
