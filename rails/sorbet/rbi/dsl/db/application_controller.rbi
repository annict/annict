...
# This is an autogenerated file for dynamic methods in `Db::ApplicationController`.
# Please instead update this file by running `bin/tapioca dsl Db::ApplicationController`.


class Db::ApplicationController
