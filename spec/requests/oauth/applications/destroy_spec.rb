...
RSpec.describe "DELETE /oauth/applications/:id", type: :request do
  ...
  it "管理者ユーザーが他のユーザーのアプリケーションを削除しようとしたとき、404エラーが返されること" do
  ...
  it "管理者ユーザーが削除済みアプリケーションを削除しようとしたとき、404エラーが返されること" do
    user = FactoryBot.create(:registered_user, :with_admin_role)
    application = FactoryBot.create(:oauth_application, owner: user)
  ...
  it "存在しないアプリケーションIDで削除しようとしたとき、404エラーが返されること" do
    user = FactoryBot.create(:registered_user, :with_admin_role)
    login_as(user, scope: :user)
  ...
  it "管理者でないユーザーが他のユーザーのアプリケーションを削除しようとしたとき、404エラーが返されること" do
