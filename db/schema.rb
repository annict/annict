...
ActiveRecord::Schema.define(version: 20170814131925) do
  ...
  create_table "program_details", force: :cascade do |t|
    ...
    t.index ["latest_program_id"], name: "index_program_details_on_latest_program_id"
  ...
  add_foreign_key "program_details", "programs", column: "latest_program_id"
