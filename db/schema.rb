...
ActiveRecord::Schema.define(version: 20170528054105) do
  ...
  create_table "character_images", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["aasm_state"], name: "index_character_images_on_aasm_state"
  ...
  create_table "characters", id: :serial, force: :cascade do |t|
    ...
    t.integer "series_id"
    t.index ["character_image_id"], name: "index_characters_on_character_image_id"
  ...
  create_table "dislikes", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["recipient_id", "recipient_type"], name: "index_dislikes_on_recipient_id_and_recipient_type"
    t.index ["recipient_type", "recipient_id"], name: "index_dislikes_on_recipient_type_and_recipient_id"
  ...
  create_table "draft_work_organizations", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["organization_id"], name: "index_draft_work_organizations_on_organization_id"
    t.index ["sort_number"], name: "index_draft_work_organizations_on_sort_number"
    t.index ["work_id"], name: "index_draft_work_organizations_on_work_id"
    t.index ["work_organization_id"], name: "index_draft_work_organizations_on_work_organization_id"
  end
  ...
  create_table "reports", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["resource_id", "resource_type"], name: "index_reports_on_resource_id_and_resource_type"
    t.index ["root_resource_id", "root_resource_type"], name: "index_reports_on_root_resource_id_and_root_resource_type"
  ...
  create_table "work_images", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["aasm_state"], name: "index_work_images_on_aasm_state"
    t.index ["user_id"], name: "index_work_images_on_user_id"
    t.index ["work_id"], name: "index_work_images_on_work_id"
  end

  create_table "work_organizations", id: :serial, force: :cascade do |t|
    t.integer "work_id", null: false
    t.integer "organization_id", null: false
    t.string "role", null: false
    t.string "role_other"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["aasm_state"], name: "index_work_organizations_on_aasm_state"
    t.index ["organization_id"], name: "index_work_organizations_on_organization_id"
    t.index ["sort_number"], name: "index_work_organizations_on_sort_number"
    t.index ["work_id", "organization_id"], name: "index_work_organizations_on_work_id_and_organization_id", unique: true
    t.index ["work_id"], name: "index_work_organizations_on_work_id"
  end
  ...
  create_table "works", id: :serial, force: :cascade do |t|
    ...
    t.index ["work_image_id"], name: "index_works_on_work_image_id"
  end
