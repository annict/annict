...
ActiveRecord::Schema.define(version: 20150530070916) do
  ...
  create_table "edit_request_images", force: :cascade do |t|
    t.integer  "edit_request_id",    null: false
  ...
  add_index "edit_request_images", ["edit_request_id"], name: "index_edit_request_images_on_edit_request_id", using: :btree
