...
--
-- Name: sign_in_codes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.sign_in_codes (
    id bigint NOT NULL,
    user_id bigint NOT NULL,
    code_digest character varying(255) NOT NULL,
    attempts integer DEFAULT 0 NOT NULL,
    expires_at timestamp with time zone NOT NULL,
    used_at timestamp with time zone,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
...
--
-- Name: sign_in_codes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.sign_in_codes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: sign_in_codes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.sign_in_codes_id_seq OWNED BY public.sign_in_codes.id;


--
-- Name: sign_up_codes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.sign_up_codes (
    id bigint NOT NULL,
...
--
-- Name: sign_up_codes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.sign_up_codes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: sign_up_codes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.sign_up_codes_id_seq OWNED BY public.sign_up_codes.id;
...
--
-- Name: sign_in_codes id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sign_in_codes ALTER COLUMN id SET DEFAULT nextval('public.sign_in_codes_id_seq'::regclass);


--
-- Name: sign_up_codes id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: sign_in_codes sign_in_codes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sign_in_codes
    ADD CONSTRAINT sign_in_codes_pkey PRIMARY KEY (id);


--
-- Name: sign_up_codes sign_up_codes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sign_up_codes
    ADD CONSTRAINT sign_up_codes_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.password_reset_tokens
    ADD CONSTRAINT unique_active_token_per_user UNIQUE (user_id, token_digest);
...
CREATE INDEX idx_password_reset_tokens_token_digest ON public.password_reset_tokens USING btree (token_digest);
...
--
-- Name: idx_sign_in_codes_expires_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sign_in_codes_expires_at ON public.sign_in_codes USING btree (expires_at);


--
-- Name: idx_sign_in_codes_used_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sign_in_codes_used_at ON public.sign_in_codes USING btree (used_at);


--
-- Name: idx_sign_in_codes_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sign_in_codes_user_id ON public.sign_in_codes USING btree (user_id);


--
-- Name: idx_sign_up_codes_email; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sign_up_codes_email ON public.sign_up_codes USING btree (email);


--
-- Name: idx_sign_up_codes_expires_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: sign_in_codes sign_in_codes_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sign_in_codes
    ADD CONSTRAINT sign_in_codes_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
