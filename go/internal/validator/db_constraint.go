// Package validatorはバリデーション機能を提供します
package validator
...
// ValidateNotNullTimeはsql.NullTimeフィールドがNULLでないことを検証します。
...
// ValidateNotNullStringはsql.NullStringフィールドがNULLでないことを検証します。
...
// ValidateNotNullInt32はsql.NullInt32フィールドがNULLでないことを検証します。
...
// ValidateNotNullInt64はsql.NullInt64フィールドがNULLでないことを検証します。
