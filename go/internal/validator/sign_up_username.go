...
// usernameRegexユーザー名の形式 (1～20文字の半角英数字とアンダースコア)
var usernameRegex = regexp.MustCompile(`^[a-zA-Z0-9_]{1,20}$`)

// SignUpUsernameCreateValidatorはユーザー登録 (ユーザー名設定) のバリデーションを行う
type SignUpUsernameCreateValidator struct{}

// NewSignUpUsernameCreateValidatorはSignUpUsernameCreateValidatorを生成する
func NewSignUpUsernameCreateValidator() *SignUpUsernameCreateValidator {
	return &SignUpUsernameCreateValidator{}
}

// SignUpUsernameCreateValidatorInputはバリデーションの入力パラメータ
