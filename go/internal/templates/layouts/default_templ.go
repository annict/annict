...
func Default(ctx context.Context, meta viewmodel.PageMeta, user *viewmodel.User, flash *session.Flash, assetVersion string, content templ.Component) templ.Component {
