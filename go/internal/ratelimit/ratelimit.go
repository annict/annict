// Package ratelimitはレート制限機能を提供します
package ratelimit
...
// LimiterはRate Limitingを実装する構造体
type Limiter struct {
	client *redis.Client
}

// NewLimiterは新しいLimiterを作成します
func NewLimiter(client *redis.Client) *Limiter {
	return &Limiter{client: client}
}

// CheckはRate Limitingをチェックします
...
// ResetはRate Limitingのカウンタをリセットします (主にテスト用)
