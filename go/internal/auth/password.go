...
// bcryptCostはbcryptのコスト値。テスト時はSetBcryptCostForTestで変更可能
var bcryptCost = bcrypt.DefaultCost

// SetBcryptCostForTestはテスト用にbcryptコストを変更する
...
// HashPassword平文パスワードをbcryptでハッシュ化する
// Deviseのencrypted_passwordカラムとの互換性を保つ
...
// パスワード強度の要件 (NIST SP 800-63B-4準拠)
const (
	MinPasswordLength = 8
...
// authパッケージはi18nに依存しないため、呼び出し元でエラー種別を判別して翻訳を解決する
var (
