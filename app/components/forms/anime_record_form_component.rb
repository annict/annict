...
module Forms
  class AnimeRecordFormComponent < ApplicationV6Component
    ...
    def render
      form_with(
        ...
        method: form_method,
        data: {
          controller: "forms--anime-record-form",
          action: "turbo:submit-start->forms--anime-record-form#handleSubmitStart turbo:submit-end->forms--anime-record-form#handleSubmitEnd",
          forms__anime_record_form_target: "form"
        }
      ) do |f|
        build_html do |h|
          ...
          h.tag :div, class: "mb-3" do
            h.html Textareas::RecordTextareaComponent.new(view_context, form: f, optional_textarea_classname: "form-control", textarea_name: "forms_anime_record_form[comment]").render
          end
            ...
            h.tag :div, class: "col" do
              h.tag :div, class: "text-center" do
                h.html f.submit((f.object.persisted? ? t("verb.update") : t("verb.track")), {
                  ...
                  data: {"forms--anime-record-form-target": "submitButton"}
                })
              end
            end
