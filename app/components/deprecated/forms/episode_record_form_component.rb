...
module Deprecated::Forms
  class EpisodeRecordFormComponent < Deprecated::ApplicationV6Component
    ...
    def render
      form_with(
        ...
        build_html do |h|
          h.html Deprecated::ErrorPanelV6Component.new(view_context, stimulus_controller: "forms--episode-record-form").render
