...
module Deprecated::Headers
  class ProfileHeaderComponent < Deprecated::ApplicationV6Component
        ...
        h.tag :div, class: "align-items-center row gx-3" do
          ...
          h.tag :div, class: "col-12 col-sm-auto text-center" do
            if current_user&.id == @user.id
              ...
              h.html Deprecated::ButtonGroups::UserButtonGroupComponent.new(view_context, user: @user).render
            end
          end
        end
      end
