...
module Deprecated::Headers
  class RecordHeaderComponent < Deprecated::ApplicationV6Component
        ...
        h.tag :div, class: "c-record-header row" do
          ...
          h.tag :div, class: "col" do
            h.tag :div do
              ...
              if @user.supporter? && !@user.hide_supporter_badge?
                h.html Deprecated::Badges::SupporterBadgeComponent.new(view_context, user: @user).render
              end
            end
          ...
          h.tag :div, class: "col-auto ps-0" do
            if @show_options && current_user && RecordPolicy.new(current_user, @record).update?
              h.html Deprecated::Dropdowns::RecordOptionsDropdownComponent.new(view_context, record: @record, show_box: @show_box, show_options: @show_options).render
            end
          end
        end
      end
