...
module Deprecated::Activities
  class StatusActivityComponent < Deprecated::ApplicationV6Component
        ...
        h.tag :div, class: "card u-card-flat" do
          h.tag :div, class: "card-body" do
            ...
            h.tag :turbo_frame, id: view_context.dom_id(@activity_group) do
              ...
              h.html Deprecated::Contents::StatusContentComponent.new(view_context, status: status).render
