...
module GraphQL
  class << self
    # source://graphql//lib/graphql.rb#172
    ...
    #
    # source://graphql//lib/graphql.rb#34
    ...
    # @return [GraphQL::Language::Nodes::Document]
    #
    # source://graphql//lib/graphql.rb#41
    def parse_file(filename); end

    # source://graphql//lib/graphql.rb#46
...
module GraphQL::Analysis
  ...
  # source://graphql//lib/graphql/analysis/analyze_query.rb#94
  def analysis_errors(results); end

  # @return [void]
  #
  # source://graphql//lib/graphql/analysis/analyze_query.rb#12
  ...
  #
  # source://graphql//lib/graphql/analysis/analyze_query.rb#45
  def analyze_query(query, analyzers, multiplex_states: T.unsafe(nil)); end

  # Enter the node, visit its children, then leave the node.
  #
  # source://graphql//lib/graphql/analysis/analyze_query.rb#74
  def reduce_node(irep_node, reducer_states); end

  # source://graphql//lib/graphql/analysis/analyze_query.rb#6
  def use(schema_class); end

  # source://graphql//lib/graphql/analysis/analyze_query.rb#86
...
module GraphQL::Analysis::AST
  ...
  # source://graphql//lib/graphql/analysis/ast.rb#86
  def analysis_errors(results); end
  ...
  #
  # source://graphql//lib/graphql/analysis/ast.rb#31
  def analyze_multiplex(multiplex, analyzers); end
  ...
  # @return [Array<Any>] Results from those analyzers
  #
  # source://graphql//lib/graphql/analysis/ast.rb#60
  def analyze_query(query, analyzers, multiplex_analyzers: T.unsafe(nil)); end

  # source://graphql//lib/graphql/analysis/ast.rb#15
  def use(schema_class); end
...
class GraphQL::Analysis::AST::FieldUsage < ::GraphQL::Analysis::AST::Analyzer
  ...
  # source://graphql//lib/graphql/analysis/ast/field_usage.rb#12
  def on_leave_field(node, parent, visitor); end

  # source://graphql//lib/graphql/analysis/ast/field_usage.rb#19
  def result; end
end
...
class GraphQL::Analysis::AST::MaxQueryComplexity < ::GraphQL::Analysis::AST::QueryComplexity
  # source://graphql//lib/graphql/analysis/ast/max_query_complexity.rb#9
  def result; end
end
...
class GraphQL::Analysis::AST::QueryComplexity < ::GraphQL::Analysis::AST::Analyzer
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/analysis/ast/query_complexity.rb#165
  ...
  #
  # source://graphql//lib/graphql/analysis/ast/query_complexity.rb#183
  def field_complexity(scoped_type_complexity, max_complexity:, child_complexity: T.unsafe(nil)); end

  # @return [Integer]
  #
  # source://graphql//lib/graphql/analysis/ast/query_complexity.rb#99
  ...
  #
  # source://graphql//lib/graphql/analysis/ast/query_complexity.rb#189
  ...
  # @return [Integer]
  #
  # source://graphql//lib/graphql/analysis/ast/query_complexity.rb#111
...
class GraphQL::Analysis::AST::QueryComplexity::ScopedTypeComplexity
  ...
  #
  # source://graphql//lib/graphql/analysis/ast/query_complexity.rb#48
...
class GraphQL::Analysis::AST::QueryDepth < ::GraphQL::Analysis::AST::Analyzer
  ...
  #
  # source://graphql//lib/graphql/analysis/ast/query_depth.rb#29
  def initialize(query); end

  # source://graphql//lib/graphql/analysis/ast/query_depth.rb#35
  def on_enter_field(node, parent, visitor); end

  # source://graphql//lib/graphql/analysis/ast/query_depth.rb#41
  def on_leave_field(node, parent, visitor); end

  # source://graphql//lib/graphql/analysis/ast/query_depth.rb#50
  def result; end
end
...
class GraphQL::Analysis::AST::Visitor < ::GraphQL::Language::Visitor
  ...
  #
  # source://graphql//lib/graphql/analysis/ast/visitor.rb#189
  def field_definition; end
  ...
  # source://graphql//lib/graphql/analysis/ast/visitor.rb#172
  def on_abstract_node(node, parent); end

  # source://graphql//lib/graphql/analysis/ast/visitor.rb#137
  def on_argument(node, parent); end

  # source://graphql//lib/graphql/analysis/ast/visitor.rb#128
  ...
  # source://graphql//lib/graphql/analysis/ast/visitor.rb#162
  ...
  #
  # source://graphql//lib/graphql/analysis/ast/visitor.rb#184
  ...
  #
  # source://graphql//lib/graphql/analysis/ast/visitor.rb#194
  ...
  #
  # source://graphql//lib/graphql/analysis/ast/visitor.rb#179
  ...
  # source://graphql//lib/graphql/analysis/ast/visitor.rb#244
  ...
  # by itself.
  #
  # source://graphql//lib/graphql/analysis/ast/visitor.rb#235
  def leave_fragment_spread_inline(_fragment_spread); end

  # @yield [node]
  #
  # source://graphql//lib/graphql/analysis/ast/visitor.rb#254
  def on_fragment_with_type(node); end

  # @return [Boolean]
  #
  # source://graphql//lib/graphql/analysis/ast/visitor.rb#239
...
#
# source://graphql//lib/graphql/analysis/field_usage.rb#15
class GraphQL::Analysis::FieldUsage
  # @return [FieldUsage] a new instance of FieldUsage
  #
  # source://graphql//lib/graphql/analysis/field_usage.rb#16
  def initialize(&block); end

  # source://graphql//lib/graphql/analysis/field_usage.rb#28
  def call(memo, visit_type, irep_node); end

  # source://graphql//lib/graphql/analysis/field_usage.rb#40
  def final_value(memo); end

  # source://graphql//lib/graphql/analysis/field_usage.rb#20
...
#
# source://graphql//lib/graphql/analysis/max_query_complexity.rb#13
class GraphQL::Analysis::MaxQueryComplexity < ::GraphQL::Analysis::QueryComplexity
  ...
  #
  # source://graphql//lib/graphql/analysis/max_query_complexity.rb#14
...
#   end
#
# source://graphql//lib/graphql/analysis/query_complexity.rb#11
class GraphQL::Analysis::QueryComplexity
  ...
  #
  # source://graphql//lib/graphql/analysis/query_complexity.rb#30
  def call(memo, visit_type, irep_node); end
  ...
  # - `complexities_on_type` holds complexity scores for each type in an IRep node
  #
  # source://graphql//lib/graphql/analysis/query_complexity.rb#22
  ...
  #
  # source://graphql//lib/graphql/analysis/query_complexity.rb#55
...
#
# source://graphql//lib/graphql/analysis/query_complexity.rb#70
class GraphQL::Analysis::QueryComplexity::TypeComplexity
  ...
  #
  # source://graphql//lib/graphql/analysis/query_complexity.rb#76
  def max_possible_complexity; end

  # Store the complexity for the branch on `type_defn`.
  # Later we will see if this is the max complexity among branches.
  #
  # source://graphql//lib/graphql/analysis/query_complexity.rb#82
...
#   # GraphQL query depth: 8
#
# source://graphql//lib/graphql/analysis/query_depth.rb#11
class GraphQL::Analysis::QueryDepth
  # @return [QueryDepth] a new instance of QueryDepth
  #
  # source://graphql//lib/graphql/analysis/query_depth.rb#12
  def initialize(&block); end

  # source://graphql//lib/graphql/analysis/query_depth.rb#24
  def call(memo, visit_type, irep_node); end

  # source://graphql//lib/graphql/analysis/query_depth.rb#38
  def final_value(memo); end

  # source://graphql//lib/graphql/analysis/query_depth.rb#16
  def initial_value(query); end
end

# source://graphql//lib/graphql/analysis/reducer_state.rb#4
class GraphQL::Analysis::ReducerState
  # @return [ReducerState] a new instance of ReducerState
  #
  # source://graphql//lib/graphql/analysis/reducer_state.rb#8
  def initialize(reducer, query); end

  # source://graphql//lib/graphql/analysis/reducer_state.rb#14
  def call(visit_type, irep_node); end

  # Returns the value of attribute errors.
  #
  # source://graphql//lib/graphql/analysis/reducer_state.rb#6
  def errors; end
  ...
  #
  # source://graphql//lib/graphql/analysis/reducer_state.rb#24
  ...
  #
  # source://graphql//lib/graphql/analysis/reducer_state.rb#5
  def reducer; end
  ...
  #
  # source://graphql//lib/graphql/analysis/reducer_state.rb#39
...
# @api deprecated
#
# source://graphql//lib/graphql/argument.rb#4
class GraphQL::Argument
  ...
  #
  # source://graphql//lib/graphql/argument.rb#20
  def initialize; end

  # @api deprecated
  #
  # source://graphql//lib/graphql/argument.rb#8
  def as; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/argument.rb#9
  def ast_node; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/argument.rb#7
  def default_value; end

  # @api deprecated
  #
  # source://graphql//lib/graphql/argument.rb#37
  def default_value=(new_default_value); end

  # @api deprecated
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/argument.rb#28
  def default_value?; end
  ...
  #
  # source://graphql//lib/graphql/argument.rb#62
  def expose_as; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/argument.rb#67
  def keyword; end

  # @api deprecated
  #
  # source://graphql//lib/graphql/argument.rb#10
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/argument.rb#32
  def method_access?; end
  ...
  #
  # source://graphql//lib/graphql/argument.rb#74
  ...
  #
  # source://graphql//lib/graphql/argument.rb#51
  def type=(new_input_type); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/argument.rb#84
  def type_class; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/argument.rb#24
  def initialize_copy(other); end

  class << self
    # @api private
    #
    # source://graphql//lib/graphql/argument.rb#116
    def deep_stringify(val); end

    # @api private
    #
    # source://graphql//lib/graphql/argument.rb#90
...
# @api private
#
# source://graphql//lib/graphql/argument.rb#16
module GraphQL::Argument::DefaultPrepare
  class << self
    # @api private
    #
    # source://graphql//lib/graphql/argument.rb#17
...
# @api deprecated
#
# source://graphql//lib/graphql/argument.rb#88
GraphQL::Argument::NO_DEFAULT_VALUE = T.let(T.unsafe(nil), Object)

# source://graphql//lib/graphql/authorization.rb#3
module GraphQL::Authorization; end

# @deprecated authorization at query runtime is generally a better idea.
#
# source://graphql//lib/graphql/authorization.rb#24
module GraphQL::Authorization::Analyzer
  private

  # source://graphql//lib/graphql/authorization.rb#34
  def call(memo, visit_type, irep_node); end

  # source://graphql//lib/graphql/authorization.rb#65
  def final_value(memo); end

  # source://graphql//lib/graphql/authorization.rb#26
  def initial_value(query); end
...
# source://graphql//lib/graphql/authorization.rb#5
class GraphQL::Authorization::InaccessibleFieldsError < ::GraphQL::AnalysisError
  ...
  #
  # source://graphql//lib/graphql/authorization.rb#13
  def irep_nodes; end
end
...
# source://graphql//lib/graphql/backtrace/legacy_tracer.rb#4
module GraphQL::Backtrace::LegacyTracer
  private

  # Implement the {GraphQL::Tracing} API.
  #
  # source://graphql//lib/graphql/backtrace/legacy_tracer.rb#8
...
class GraphQL::Backtrace::Table
  ...
  # source://graphql//lib/graphql/backtrace/table.rb#146
...
# @api private
#
# source://graphql//lib/graphql/backwards_compatibility.rb#6
module GraphQL::BackwardsCompatibility
  private

  # @api private
  #
  # source://graphql//lib/graphql/backwards_compatibility.rb#33
  ...
  # @api private
  #
  # source://graphql//lib/graphql/backwards_compatibility.rb#14
...
# @api private
#
# source://graphql//lib/graphql/backwards_compatibility.rb#42
class GraphQL::BackwardsCompatibility::FirstArgumentsWrapper
  ...
  #
  # source://graphql//lib/graphql/backwards_compatibility.rb#43
  def initialize(callable, old_arity); end

  # @api private
  #
  # source://graphql//lib/graphql/backwards_compatibility.rb#48
  def call(*args); end
end

# @api private
#
# source://graphql//lib/graphql/backwards_compatibility.rb#54
class GraphQL::BackwardsCompatibility::LastArgumentsWrapper < ::GraphQL::BackwardsCompatibility::FirstArgumentsWrapper
  # @api private
  #
  # source://graphql//lib/graphql/backwards_compatibility.rb#55
  def call(*args); end
end

# The parent for all type classes.
#
# source://graphql//lib/graphql/base_type.rb#6
class GraphQL::BaseType
  ...
  #
  # source://graphql//lib/graphql/base_type.rb#24
  def initialize; end
  ...
  #
  # source://graphql//lib/graphql/base_type.rb#79
  def ==(other); end

  # Returns the value of attribute ast_node.
  #
  # source://graphql//lib/graphql/base_type.rb#22
  def ast_node; end
  ...
  # source://graphql//lib/graphql/base_type.rb#161
  def coerce_input(value, ctx = T.unsafe(nil)); end

  # source://graphql//lib/graphql/base_type.rb#131
  def coerce_isolated_input(value); end

  # source://graphql//lib/graphql/base_type.rb#135
  def coerce_isolated_result(value); end

  # @raise [GraphQL::RequiredImplementationMissingError]
  #
  # source://graphql//lib/graphql/base_type.rb#173
  def coerce_result(value, ctx); end

  # @api private
  #
  # source://graphql//lib/graphql/base_type.rb#74
  def default_relay=(_arg0); end

  # @return [Boolean] Is this type a built-in Relay type? (`Node`, `PageInfo`)
  #
  # source://graphql//lib/graphql/base_type.rb#69
  ...
  #
  # source://graphql//lib/graphql/base_type.rb#64
  def default_scalar?; end

  # @return [String, nil] a description for this type
  #
  # source://graphql//lib/graphql/base_type.rb#56
  def description; end
  ...
  #
  # source://graphql//lib/graphql/base_type.rb#180
  ...
  # @see {GraphQL::SchemaMember}
  #
  # source://graphql//lib/graphql/base_type.rb#38
  def graphql_name; end

  # Print the human-readable name of this type using the query-string naming pattern
  #
  # source://graphql//lib/graphql/base_type.rb#116
  def inspect; end
  ...
  #
  # source://graphql//lib/graphql/base_type.rb#59
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/base_type.rb#220
  def list?; end
  ...
  # source://graphql//lib/graphql/base_type.rb#50
  def name=(name); end
  ...
  # source://graphql//lib/graphql/base_type.rb#46
  def type_class; end

  # If this type is modifying an underlying type,
  # return the underlying type. (Otherwise, return `self`.)
  #
  # source://graphql//lib/graphql/base_type.rb#85
  def unwrap; end

  # @return [Boolean]
  #
  # source://graphql//lib/graphql/base_type.rb#139
  def valid_input?(value, ctx = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://graphql//lib/graphql/base_type.rb#123
  def valid_isolated_input?(value); end

  # source://graphql//lib/graphql/base_type.rb#148
  def validate_input(value, ctx = T.unsafe(nil)); end

  # source://graphql//lib/graphql/base_type.rb#127
  def validate_isolated_input(value); end

  private

  # source://graphql//lib/graphql/base_type.rb#30
  def initialize_copy(other); end

  # source://graphql//lib/graphql/base_type.rb#226
  ...
  class << self
    ...
    #
    # source://graphql//lib/graphql/base_type.rb#187
    def resolve_related_type(type_arg); end
  end
end

# source://graphql//lib/graphql/base_type.rb#99
module GraphQL::BaseType::ModifiesAnotherType
  # source://graphql//lib/graphql/base_type.rb#104
  def ==(other); end

  # source://graphql//lib/graphql/base_type.rb#100
  def unwrap; end
end
...
# source://graphql//lib/graphql/compatibility/execution_specification/counter_schema.rb#3
...
# - Relay features
#
# source://graphql//lib/graphql/compatibility/execution_specification/counter_schema.rb#4
module GraphQL::Compatibility::ExecutionSpecification
  class << self
    ...
    #
    # source://graphql//lib/graphql/compatibility/execution_specification.rb#34
    def build_suite(execution_strategy); end
  end
end

# source://graphql//lib/graphql/compatibility/execution_specification/counter_schema.rb#5
module GraphQL::Compatibility::ExecutionSpecification::CounterSchema
  class << self
    # source://graphql//lib/graphql/compatibility/execution_specification/counter_schema.rb#6
    def build(execution_strategy); end
  end
end

# source://graphql//lib/graphql/compatibility/execution_specification/specification_schema.rb#5
module GraphQL::Compatibility::ExecutionSpecification::SpecificationSchema
  class << self
    # source://graphql//lib/graphql/compatibility/execution_specification/specification_schema.rb#58
    def build(execution_strategy); end
  end
end

# source://graphql//lib/graphql/compatibility/execution_specification/specification_schema.rb#6
...
#
# source://graphql//lib/graphql/compatibility/execution_specification/specification_schema.rb#41
class GraphQL::Compatibility::ExecutionSpecification::SpecificationSchema::CustomCollection
  ...
  #
  # source://graphql//lib/graphql/compatibility/execution_specification/specification_schema.rb#42
  def initialize(storage); end

  # source://graphql//lib/graphql/compatibility/execution_specification/specification_schema.rb#46
  def each(&block); end
end

# source://graphql//lib/graphql/compatibility/execution_specification/specification_schema.rb#8
GraphQL::Compatibility::ExecutionSpecification::SpecificationSchema::DATA = T.let(T.unsafe(nil), Hash)

# source://graphql//lib/graphql/compatibility/execution_specification/specification_schema.rb#51
module GraphQL::Compatibility::ExecutionSpecification::SpecificationSchema::TestMiddleware
  class << self
    # source://graphql//lib/graphql/compatibility/execution_specification/specification_schema.rb#52
    def call(parent_type, parent_object, field_definition, field_args, query_context, &next_middleware); end
  end
end

# source://graphql//lib/graphql/compatibility/lazy_execution_specification/lazy_schema.rb#4
module GraphQL::Compatibility::LazyExecutionSpecification
  class << self
    # @param execution_strategy [<#new, #execute>] An execution strategy class
    # @return [Class<Minitest::Test>] A test suite for this execution strategy
    #
    # source://graphql//lib/graphql/compatibility/lazy_execution_specification.rb#9
    def build_suite(execution_strategy); end
  end
end

# source://graphql//lib/graphql/compatibility/lazy_execution_specification/lazy_schema.rb#5
module GraphQL::Compatibility::LazyExecutionSpecification::LazySchema
  class << self
    # source://graphql//lib/graphql/compatibility/lazy_execution_specification/lazy_schema.rb#69
    def build(execution_strategy); end
  end
end

# source://graphql//lib/graphql/compatibility/lazy_execution_specification/lazy_schema.rb#56
module GraphQL::Compatibility::LazyExecutionSpecification::LazySchema::LazyInstrumentation
  class << self
    # source://graphql//lib/graphql/compatibility/lazy_execution_specification/lazy_schema.rb#57
    def instrument(type, field); end
  end
end

# source://graphql//lib/graphql/compatibility/lazy_execution_specification/lazy_schema.rb#6
class GraphQL::Compatibility::LazyExecutionSpecification::LazySchema::LazyPush
  # @return [LazyPush] a new instance of LazyPush
  #
  # source://graphql//lib/graphql/compatibility/lazy_execution_specification/lazy_schema.rb#8
  def initialize(ctx, value); end

  # source://graphql//lib/graphql/compatibility/lazy_execution_specification/lazy_schema.rb#26
  def push; end

  # Returns the value of attribute value.
  #
  # source://graphql//lib/graphql/compatibility/lazy_execution_specification/lazy_schema.rb#7
  def value; end
end

# source://graphql//lib/graphql/compatibility/lazy_execution_specification/lazy_schema.rb#41
class GraphQL::Compatibility::LazyExecutionSpecification::LazySchema::LazyPushCollection
  ...
  #
  # source://graphql//lib/graphql/compatibility/lazy_execution_specification/lazy_schema.rb#42
  def initialize(ctx, values); end

  # source://graphql//lib/graphql/compatibility/lazy_execution_specification/lazy_schema.rb#47
  def push; end

  # source://graphql//lib/graphql/compatibility/lazy_execution_specification/lazy_schema.rb#51
  def value; end
end
...
#
# source://graphql//lib/graphql/compatibility/query_parser_specification/query_assertions.rb#4
module GraphQL::Compatibility::QueryParserSpecification
  class << self
    ...
    #
    # source://graphql//lib/graphql/compatibility/query_parser_specification.rb#13
    def build_suite(&block); end
  end
end

# source://graphql//lib/graphql/compatibility/query_parser_specification/parse_error_specification.rb#5
module GraphQL::Compatibility::QueryParserSpecification::ParseErrorSpecification
  # source://graphql//lib/graphql/compatibility/query_parser_specification/parse_error_specification.rb#6
  def assert_raises_parse_error(query_string); end

  # source://graphql//lib/graphql/compatibility/query_parser_specification/parse_error_specification.rb#33
  def assert_rejects_character(char); end

  # source://graphql//lib/graphql/compatibility/query_parser_specification/parse_error_specification.rb#12
  def test_it_includes_line_and_column; end

  # source://graphql//lib/graphql/compatibility/query_parser_specification/parse_error_specification.rb#50
  def test_it_rejects_bad_unicode; end

  # source://graphql//lib/graphql/compatibility/query_parser_specification/parse_error_specification.rb#73
  def test_it_rejects_blank_queries; end

  # source://graphql//lib/graphql/compatibility/query_parser_specification/parse_error_specification.rb#59
  def test_it_rejects_empty_inline_fragments; end

  # source://graphql//lib/graphql/compatibility/query_parser_specification/parse_error_specification.rb#41
  def test_it_rejects_invalid_characters; end

  # source://graphql//lib/graphql/compatibility/query_parser_specification/parse_error_specification.rb#29
  def test_it_rejects_unexpected_ends; end

  # source://graphql//lib/graphql/compatibility/query_parser_specification/parse_error_specification.rb#24
  def test_it_rejects_unterminated_strings; end

  # source://graphql//lib/graphql/compatibility/query_parser_specification/parse_error_specification.rb#80
  def test_it_restricts_on; end
end

# source://graphql//lib/graphql/compatibility/query_parser_specification.rb#241
GraphQL::Compatibility::QueryParserSpecification::QUERY_STRING = T.let(T.unsafe(nil), String)

# source://graphql//lib/graphql/compatibility/query_parser_specification/query_assertions.rb#5
module GraphQL::Compatibility::QueryParserSpecification::QueryAssertions
  # source://graphql//lib/graphql/compatibility/query_parser_specification/query_assertions.rb#57
  def assert_valid_directive(directive); end

  # source://graphql//lib/graphql/compatibility/query_parser_specification/query_assertions.rb#32
  def assert_valid_field(field); end

  # source://graphql//lib/graphql/compatibility/query_parser_specification/query_assertions.rb#16
  def assert_valid_fragment(fragment_def); end

  # source://graphql//lib/graphql/compatibility/query_parser_specification/query_assertions.rb#51
  def assert_valid_fragment_spread(fragment_spread); end

  # source://graphql//lib/graphql/compatibility/query_parser_specification/query_assertions.rb#41
  def assert_valid_literal_argument(argument); end

  # source://graphql//lib/graphql/compatibility/query_parser_specification/query_assertions.rb#6
  def assert_valid_query(query); end

  # source://graphql//lib/graphql/compatibility/query_parser_specification/query_assertions.rb#64
  def assert_valid_typed_inline_fragment(inline_fragment); end

  # source://graphql//lib/graphql/compatibility/query_parser_specification/query_assertions.rb#71
  def assert_valid_typeless_inline_fragment(inline_fragment); end

  # source://graphql//lib/graphql/compatibility/query_parser_specification/query_assertions.rb#25
  def assert_valid_variable(variable); end

  # source://graphql//lib/graphql/compatibility/query_parser_specification/query_assertions.rb#46
...
# the proper tree of {{GraphQL::Language::Nodes}}.
#
# source://graphql//lib/graphql/compatibility/schema_parser_specification.rb#6
module GraphQL::Compatibility::SchemaParserSpecification
  class << self
    ...
    # @yieldreturn [GraphQL::Language::Nodes::Document]
    #
    # source://graphql//lib/graphql/compatibility/schema_parser_specification.rb#10
    def build_suite(&block); end
  end
end

# source://graphql//lib/graphql/compatibility/schema_parser_specification.rb#633
GraphQL::Compatibility::SchemaParserSpecification::SCHEMA_DEFINITION_STRING = T.let(T.unsafe(nil), String)

# source://graphql//lib/graphql.rb#163
GraphQL::DEPRECATED_BOOLEAN_TYPE = T.let(T.unsafe(nil), GraphQL::ScalarType)

# source://graphql//lib/graphql.rb#161
GraphQL::DEPRECATED_FLOAT_TYPE = T.let(T.unsafe(nil), GraphQL::ScalarType)

# source://graphql//lib/graphql.rb#164
...
#
# source://graphql//lib/graphql.rb#160
GraphQL::DEPRECATED_INT_TYPE = T.let(T.unsafe(nil), GraphQL::ScalarType)

# source://graphql//lib/graphql.rb#162
...
class GraphQL::Dataloader
  ...
  #
  # source://graphql//lib/graphql/dataloader.rb#96
  def run; end
  ...
  # source://graphql//lib/graphql/dataloader.rb#56
  ...
  # @return [void]
  #
  # source://graphql//lib/graphql/dataloader.rb#67
  def yield; end
  ...
  # @return [Fiber, nil]
  #
  # source://graphql//lib/graphql/dataloader.rb#199
  def create_source_fiber; end

  # source://graphql//lib/graphql/dataloader.rb#227
  ...
  #
  # source://graphql//lib/graphql/dataloader.rb#239
  def spawn_fiber; end

  class << self
    # source://graphql//lib/graphql/dataloader.rb#26
    def use(schema); end
  end
end
...
class GraphQL::Dataloader::Source
  ...
  #
  # source://graphql//lib/graphql/dataloader/source.rb#14
  def dataloader; end
  ...
  #
  # source://graphql//lib/graphql/dataloader/source.rb#58
  def fetch(keys); end
  ...
  #
  # source://graphql//lib/graphql/dataloader/source.rb#33
  def load(key); end
  ...
  # @return [void]
  #
  # source://graphql//lib/graphql/dataloader/source.rb#78
  ...
  # @return [void]
  #
  # source://graphql//lib/graphql/dataloader/source.rb#66
  def sync; end
...
# source://graphql//lib/graphql/define/assign_argument.rb#3
module GraphQL::Define
  class << self
    ...
    #
    # source://graphql//lib/graphql/define.rb#27
...
#
# source://graphql//lib/graphql/define/assign_argument.rb#5
module GraphQL::Define::AssignArgument
  class << self
    # source://graphql//lib/graphql/define/assign_argument.rb#6
    def call(target, *args, **kwargs, &block); end
  end
end

# source://graphql//lib/graphql/define/assign_connection.rb#4
module GraphQL::Define::AssignConnection
  class << self
    # source://graphql//lib/graphql/define/assign_connection.rb#5
...
# @api deprecated
#
# source://graphql//lib/graphql/define/assign_enum_value.rb#5
module GraphQL::Define::AssignEnumValue
  class << self
    # @api deprecated
    #
    # source://graphql//lib/graphql/define/assign_enum_value.rb#6
    def call(enum_type, name, desc = T.unsafe(nil), deprecation_reason: T.unsafe(nil), value: T.unsafe(nil), &block); end
  end
end

# source://graphql//lib/graphql/define/assign_global_id_field.rb#4
module GraphQL::Define::AssignGlobalIdField
  class << self
    # source://graphql//lib/graphql/define/assign_global_id_field.rb#5
    def call(type_defn, field_name, **field_kwargs); end
  end
end

# source://graphql//lib/graphql/define/assign_mutation_function.rb#4
module GraphQL::Define::AssignMutationFunction
  class << self
    # source://graphql//lib/graphql/define/assign_mutation_function.rb#5
    def call(target, function); end
  end
end

# source://graphql//lib/graphql/define/assign_mutation_function.rb#25
class GraphQL::Define::AssignMutationFunction::ResultProxy < ::SimpleDelegator
  # @return [ResultProxy] a new instance of ResultProxy
  #
  # source://graphql//lib/graphql/define/assign_mutation_function.rb#27
  def initialize(target, client_mutation_id); end

  # Returns the value of attribute client_mutation_id.
  #
  # source://graphql//lib/graphql/define/assign_mutation_function.rb#26
  def client_mutation_id; end
end

# @api deprecated
#
# source://graphql//lib/graphql/define/assign_object_field.rb#5
module GraphQL::Define::AssignObjectField
  class << self
    # @api deprecated
    #
    # source://graphql//lib/graphql/define/assign_object_field.rb#6
...
#
# source://graphql//lib/graphql/define/defined_object_proxy.rb#8
class GraphQL::Define::DefinedObjectProxy
  ...
  #
  # source://graphql//lib/graphql/define/defined_object_proxy.rb#13
  def initialize(target); end

  # Lookup a function from the dictionary and call it if it's found.
  #
  # source://graphql//lib/graphql/define/defined_object_proxy.rb#37
  def method_missing(name, *args, **_arg2, &block); end

  # The object which will be defined by definition functions
  #
  # source://graphql//lib/graphql/define/defined_object_proxy.rb#11
  def target; end

  # Provides shorthand access to GraphQL's built-in types
  #
  # source://graphql//lib/graphql/define/defined_object_proxy.rb#19
  def types; end
  ...
  #
  # source://graphql//lib/graphql/define/defined_object_proxy.rb#27
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/define/defined_object_proxy.rb#48
  def respond_to_missing?(name, include_private = T.unsafe(nil)); end
end

# @api deprecated
#
# source://graphql//lib/graphql/define/instance_definable.rb#5
module GraphQL::Define::InstanceDefinable
  mixes_in_class_methods ::GraphQL::Define::InstanceDefinable::ClassMethods

  # @api deprecated
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#43
  def define(**kwargs, &block); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#34
  def deprecated_define(**kwargs, &block); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#29
  def metadata; end

  # @api deprecated
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#48
  ...
  # @return [void]
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#67
  def ensure_defined; end

  # @api deprecated
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#55
  def initialize_copy(other); end
  ...
  # @return [void]
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#102
  ...
  # @return [void]
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#125
  ...
  class << self
    ...
    # @private
    #
    # source://graphql//lib/graphql/define/instance_definable.rb#23
...
# @api deprecated
#
# source://graphql//lib/graphql/define/instance_definable.rb#223
class GraphQL::Define::InstanceDefinable::AssignAttribute
  ...
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#226
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#233
  def call(defn, *value, **_arg2); end
end

# @api deprecated
#
# source://graphql//lib/graphql/define/instance_definable.rb#213
class GraphQL::Define::InstanceDefinable::AssignMetadataKey
  # @api deprecated
  # @return [AssignMetadataKey] a new instance of AssignMetadataKey
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#214
  def initialize(key); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#218
  def call(defn, value = T.unsafe(nil)); end
end

# @api deprecated
#
# source://graphql//lib/graphql/define/instance_definable.rb#147
module GraphQL::Define::InstanceDefinable::ClassMethods
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#169
  def accepts_definitions(*accepts); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#160
  def define(**kwargs, &block); end
  ...
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#153
  def deprecated_define(**kwargs, &block); end

  # @api deprecated
  # @return [Hash] combined definitions for self and ancestors
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#199
  def dictionary; end

  # @api deprecated
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#183
  def ensure_defined(*method_names); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#189
  def ensure_defined_method_names; end

  # @api deprecated
  # @return [Hash] definitions for this class only
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#208
  def own_dictionary; end
end

# @api deprecated
#
# source://graphql//lib/graphql/define/instance_definable.rb#139
class GraphQL::Define::InstanceDefinable::Definition
  # @api deprecated
  # @return [Definition] a new instance of Definition
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#141
  def initialize(define_keywords, define_proc); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#140
...
# @api deprecated
#
# source://graphql//lib/graphql/define/instance_definable.rb#6
module GraphQL::Define::InstanceDefinable::DeprecatedDefine
  # @api deprecated
  #
  # source://graphql//lib/graphql/define/instance_definable.rb#7
  def define(**kwargs, &block); end
end

# source://graphql//lib/graphql/define/no_definition_error.rb#4
...
#   !GraphQL::INT_TYPE
#
# source://graphql//lib/graphql/define/non_null_with_bang.rb#8
module GraphQL::Define::NonNullWithBang
  ...
  #
  # source://graphql//lib/graphql/define/non_null_with_bang.rb#11
  def !; end
end
...
#
# source://graphql//lib/graphql/define/type_definer.rb#7
class GraphQL::Define::TypeDefiner
  include ::Singleton
  extend ::Singleton::SingletonClassMethods

  # source://graphql//lib/graphql/define/type_definer.rb#13
  def Boolean; end

  # source://graphql//lib/graphql/define/type_definer.rb#12
  def Float; end

  # source://graphql//lib/graphql/define/type_definer.rb#14
  def ID; end

  # source://graphql//lib/graphql/define/type_definer.rb#10
  def Int; end

  # source://graphql//lib/graphql/define/type_definer.rb#11
  def String; end
  ...
  #
  # source://graphql//lib/graphql/define/type_definer.rb#26
  def [](type); end
...
#
# source://graphql//lib/graphql/deprecated_dsl.rb#15
module GraphQL::DeprecatedDSL
  class << self
    # source://graphql//lib/graphql/deprecated_dsl.rb#25
    def activate; end
  end
end

# source://graphql//lib/graphql/deprecated_dsl.rb#33
module GraphQL::DeprecatedDSL::Methods
  # source://graphql//lib/graphql/deprecated_dsl.rb#34
  def !; end
end

# source://graphql//lib/graphql/deprecated_dsl.rb#16
...
#
# source://graphql//lib/graphql/directive.rb#9
class GraphQL::Directive
  ...
  #
  # source://graphql//lib/graphql/directive.rb#69
  def initialize; end

  # Returns the value of attribute arguments.
  #
  # source://graphql//lib/graphql/directive.rb#13
  def arguments; end
  ...
  # Returns the value of attribute ast_node.
  #
  # source://graphql//lib/graphql/directive.rb#14
  def ast_node; end
  ...
  # source://graphql//lib/graphql/directive.rb#103
  ...
  # source://graphql//lib/graphql/directive.rb#95
  def inspect; end
...
class GraphQL::EnumType < ::GraphQL::BaseType
  ...
  #
  # source://graphql//lib/graphql/enum_type.rb#11
  def initialize; end

  # @api deprecated
  # @param enum_value [EnumValue] A value to add to this type's set of values
  #
  # source://graphql//lib/graphql/enum_type.rb#28
  def add_value(enum_value); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/enum_type.rb#9
  def ast_node; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/enum_type.rb#45
  def coerce_result(value, ctx = T.unsafe(nil)); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/enum_type.rb#41
  def kind; end

  # @api deprecated
  #
  # source://graphql//lib/graphql/enum_type.rb#61
  def to_s; end

  # @api deprecated
  # @return [Hash<String => EnumValue>] `{name => value}` pairs contained in this type
  #
  # source://graphql//lib/graphql/enum_type.rb#37
  def values; end

  # @api deprecated
  # @param new_values [Array<EnumValue>] The set of values contained in this type
  #
  # source://graphql//lib/graphql/enum_type.rb#22
  ...
  #
  # source://graphql//lib/graphql/enum_type.rb#105
  def coerce_non_null_input(value_name, ctx); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/enum_type.rb#16
  def initialize_copy(other); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/enum_type.rb#117
...
# @api deprecated
#
# source://graphql//lib/graphql/enum_type.rb#68
class GraphQL::EnumType::EnumValue
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/enum_type.rb#73
  def ast_node; end
  ...
  # source://graphql//lib/graphql/enum_type.rb#72
  def deprecation_reason; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/enum_type.rb#83
  def graphql_name; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/enum_type.rb#77
  def name=(new_name); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/enum_type.rb#87
  def type_class; end
...
# @api deprecated
#
# source://graphql//lib/graphql/enum_type.rb#70
GraphQL::EnumType::EnumValue::ATTRIBUTES = T.let(T.unsafe(nil), Array)

# @api deprecated
#
# source://graphql//lib/graphql/enum_type.rb#92
...
#   end
#
# source://graphql//lib/graphql/execution/errors.rb#19
class GraphQL::Execution::Errors
  # @return [Errors] a new instance of Errors
  #
  # source://graphql//lib/graphql/execution/errors.rb#33
  def initialize(schema); end

  # @api private
  #
  # source://graphql//lib/graphql/execution/errors.rb#43
  def each_rescue; end

  # @return [Proc, nil] The handler for `error_class`, if one was registered on this schema or inherited
  #
  # source://graphql//lib/graphql/execution/errors.rb#125
  ...
  # @return [void]
  #
  # source://graphql//lib/graphql/execution/errors.rb#57
  ...
  #
  # source://graphql//lib/graphql/execution/errors.rb#106
  def with_error_handling(ctx); end

  class << self
    # source://graphql//lib/graphql/execution/errors.rb#20
    def use(schema); end
  end
end

# source://graphql//lib/graphql/execution/errors.rb#25
...
# @api private
#
# source://graphql//lib/graphql/execution/execute.rb#6
class GraphQL::Execution::Execute
  include ::GraphQL::Execution::Execute::ExecutionFunctions

  # @api private
  #
  # source://graphql//lib/graphql/execution/execute.rb#27
  def execute(ast_operation, root_type, query); end

  class << self
    # @api private
    #
    # source://graphql//lib/graphql/execution/execute.rb#34
    def begin_multiplex(_multiplex); end

    # @api private
    #
    # source://graphql//lib/graphql/execution/execute.rb#37
    def begin_query(query, _multiplex); end

    # @api private
    #
    # source://graphql//lib/graphql/execution/execute.rb#41
    def finish_multiplex(results, multiplex); end

    # @api private
    #
    # source://graphql//lib/graphql/execution/execute.rb#45
    def finish_query(query, _multiplex); end

    # @api private
    #
    # source://graphql//lib/graphql/execution/execute.rb#21
    def use(schema_class); end
  end
end
...
# @api private
#
# source://graphql//lib/graphql/execution/execute.rb#52
module GraphQL::Execution::Execute::ExecutionFunctions
  ...
  # @api private
  #
  # source://graphql//lib/graphql/execution/execute.rb#175
  def continue_or_wait(raw_value, field_type, field_ctx); end

  # @api private
  #
  # source://graphql//lib/graphql/execution/execute.rb#195
  def continue_resolve_field(raw_value, field_type, field_ctx); end

  # @api private
  #
  # source://graphql//lib/graphql/execution/execute.rb#73
  def lazy_resolve_root_selection(result, query: T.unsafe(nil), multiplex: T.unsafe(nil)); end

  # @api private
  #
  # source://graphql//lib/graphql/execution/execute.rb#126
  def resolve_field(object, field_ctx); end

  # @api private
  #
  # source://graphql//lib/graphql/execution/execute.rb#55
  def resolve_root_selection(query); end

  # @api private
  #
  # source://graphql//lib/graphql/execution/execute.rb#84
  def resolve_selection(object, current_type, current_ctx, mutation: T.unsafe(nil)); end

  # @api private
  #
  # source://graphql//lib/graphql/execution/execute.rb#227
...
# @api private
#
# source://graphql//lib/graphql/execution/execute.rb#325
module GraphQL::Execution::Execute::FieldResolveStep
  class << self
    ...
    # @api private
    #
    # source://graphql//lib/graphql/execution/execute.rb#327
...
# @api private
#
# source://graphql//lib/graphql/execution/execute.rb#19
GraphQL::Execution::Execute::PROPAGATE_NULL = T.let(T.unsafe(nil), GraphQL::Execution::Execute::PropagateNull)

# @api private
#
# source://graphql//lib/graphql/execution/execute.rb#16
...
# @api private
#
# source://graphql//lib/graphql/execution/execute.rb#13
GraphQL::Execution::Execute::SKIP = T.let(T.unsafe(nil), GraphQL::Execution::Execute::Skip)

# @api private
#
# source://graphql//lib/graphql/execution/execute.rb#9
...
# @api private
#
# source://graphql//lib/graphql/execution/flatten.rb#7
module GraphQL::Execution::Flatten
  class << self
    # @api private
    #
    # source://graphql//lib/graphql/execution/flatten.rb#8
    def call(ctx); end
    ...
    # @api private
    #
    # source://graphql//lib/graphql/execution/flatten.rb#15
    def flatten(obj); end
  end
end
...
class GraphQL::Execution::Interpreter
  ...
  #
  # source://graphql//lib/graphql/execution/interpreter.rb#65
  def evaluate(query); end

  # Support `Executor` :S
  #
  # source://graphql//lib/graphql/execution/interpreter.rb#18
  ...
  # @return [void]
  #
  # source://graphql//lib/graphql/execution/interpreter.rb#81
  def sync_lazies(query: T.unsafe(nil), multiplex: T.unsafe(nil)); end

  class << self
    # source://graphql//lib/graphql/execution/interpreter.rb#36
    def begin_multiplex(multiplex); end

    # source://graphql//lib/graphql/execution/interpreter.rb#42
    def begin_query(query, multiplex); end

    # source://graphql//lib/graphql/execution/interpreter.rb#52
    def finish_multiplex(_results, multiplex); end

    # source://graphql//lib/graphql/execution/interpreter.rb#57
    def finish_query(query, _multiplex); end
...
class GraphQL::Execution::Interpreter::ArgumentsCache
  ...
  #
  # source://graphql//lib/graphql/execution/interpreter/arguments_cache.rb#47
...
# source://graphql//lib/graphql/execution/interpreter/arguments_cache.rb#56
...
# source://graphql//lib/graphql/execution/interpreter.rb#108
class GraphQL::Execution::Interpreter::ListResultFailedError < ::GraphQL::Error
  ...
  #
  # source://graphql//lib/graphql/execution/interpreter.rb#109
...
class GraphQL::Execution::Interpreter::Runtime
  ...
  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#882
  ...
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#140
  def context; end
  ...
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#658
  ...
  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#570
  def continue_value(path, value, parent_type, field, is_non_null, ast_node, result_name, selection_result); end

  # @api private
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#521
  ...
  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#898
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#815
  def directives_include?(node, graphql_object, parent_type); end

  # @api private
  # @return [void]
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#364
  ...
  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#423
  ...
  # @return [void]
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#341
  ...
  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#166
  def final_result; end

  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#265
  ...
  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#170
  def inspect; end
  ...
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#134
  def query; end
  ...
  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#778
  def resolve_with_directives(object, directives, &block); end

  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#783
  ...
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#137
  def schema; end
  ...
  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#174
...
module GraphQL::Execution::Interpreter::Runtime::GraphQLResult
  ...
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#18
...
# @api private
#
# source://graphql//lib/graphql/execution/interpreter/runtime.rb#86
class GraphQL::Execution::Interpreter::Runtime::GraphQLResultArray
  ...
  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#108
  def []=(idx, value); end

  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#96
...
class GraphQL::Execution::Interpreter::Runtime::GraphQLResultHash
  ...
  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#81
  def [](k); end
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#77
  def key?(k); end

  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#73
  def values; end
end

# @api private
#
# source://graphql//lib/graphql/execution/interpreter/runtime.rb#129
class GraphQL::Execution::Interpreter::Runtime::GraphQLSelectionSet < ::Hash
  # @api private
  #
  # source://graphql//lib/graphql/execution/interpreter/runtime.rb#130
...
# @api private
#
# source://graphql//lib/graphql/execution/interpreter/runtime.rb#569
GraphQL::Execution::Interpreter::Runtime::HALT = T.let(T.unsafe(nil), Object)

# @api private
#
# source://graphql//lib/graphql/execution/interpreter/runtime.rb#338
...
class GraphQL::Execution::Lazy
  ...
  # @api private
  #
  # source://graphql//lib/graphql/execution/lazy.rb#23
  def field; end
  ...
  #
  # source://graphql//lib/graphql/execution/lazy.rb#37
  def value; end
  ...
  class << self
    ...
    # @return void
    #
    # source://graphql//lib/graphql/execution/lazy.rb#19
    def resolve(val); end
  end
end
...
# @api private
#
# source://graphql//lib/graphql/execution/lazy.rb#79
...
# @api private
#
# source://graphql//lib/graphql/execution/lazy/resolve.rb#7
module GraphQL::Execution::Lazy::Resolve
  class << self
    ...
    # @return [void]
    #
    # source://graphql//lib/graphql/execution/lazy/resolve.rb#78
    ...
    # @return [void]
    #
    # source://graphql//lib/graphql/execution/lazy/resolve.rb#51
    def each_lazy(acc, value); end

    # @api private
    #
    # source://graphql//lib/graphql/execution/lazy/resolve.rb#27
    def resolve(value); end

    # @api private
    #
    # source://graphql//lib/graphql/execution/lazy/resolve.rb#32
...
# @api private
#
# source://graphql//lib/graphql/execution/lazy/resolve.rb#17
module GraphQL::Execution::Lazy::Resolve::NullAccumulator
  class << self
    # @api private
    #
    # source://graphql//lib/graphql/execution/lazy/resolve.rb#18
    def <<(item); end

    # @api private
    # @return [Boolean]
    #
    # source://graphql//lib/graphql/execution/lazy/resolve.rb#22
    def empty?; end
  end
end
...
class GraphQL::Execution::Lookahead
  ...
  #
  # source://graphql//lib/graphql/execution/lookahead.rb#275
...
class GraphQL::Execution::Multiplex
  ...
  class << self
    ...
    # @param query [GraphQL::Query]
    #
    # source://graphql//lib/graphql/execution/multiplex.rb#78
    def begin_query(results, idx, query, multiplex); end

    # @api private
    #
    # source://graphql//lib/graphql/execution/multiplex.rb#48
    ...
    #
    # source://graphql//lib/graphql/execution/multiplex.rb#58
    ...
    #
    # source://graphql//lib/graphql/execution/multiplex.rb#134
    ...
    # @api private
    #
    # source://graphql//lib/graphql/execution/multiplex.rb#186
    def instrument_and_analyze(multiplex); end

    # @api private
    #
    # source://graphql//lib/graphql/execution/multiplex.rb#97
    ...
    # @api private
    #
    # source://graphql//lib/graphql/execution/multiplex.rb#157
    ...
    #
    # source://graphql//lib/graphql/execution/multiplex.rb#177
...
# @api private
#
# source://graphql//lib/graphql/execution/typecast.rb#5
module GraphQL::Execution::Typecast
  class << self
    # @api private
    # @return [Boolean]
    #
    # source://graphql//lib/graphql/execution/typecast.rb#7
...
# @api deprecated
#
# source://graphql//lib/graphql/field/resolve.rb#3
class GraphQL::Field
  include ::GraphQL::Define::InstanceDefinable
  extend ::GraphQL::Define::InstanceDefinable::ClassMethods
  ...
  #
  # source://graphql//lib/graphql/field.rb#104
  def initialize; end

  # @api deprecated
  # @return [Hash<String => GraphQL::Argument>] Map String argument names to their {GraphQL::Argument} implementations
  #
  # source://graphql//lib/graphql/field.rb#53
  def arguments; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/field.rb#70
  def arguments_class; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/field.rb#81
  def ast_node; end
  ...
  #
  # source://graphql//lib/graphql/field.rb#59
  def complexity; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/field.rb#72
  def connection=(_arg0); end

  # @api deprecated
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/field.rb#88
  def connection?; end

  # @api deprecated
  # @return [nil, Integer]
  #
  # source://graphql//lib/graphql/field.rb#102
  ...
  #
  # source://graphql//lib/graphql/field.rb#50
  def deprecation_reason; end
  ...
  #
  # source://graphql//lib/graphql/field.rb#47
  def description; end
  ...
  # @return [nil, Class]
  #
  # source://graphql//lib/graphql/field.rb#94
  def edge_class; end
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/field.rb#97
  def edges?; end

  # @api deprecated
  # @return [Object, GraphQL::Function] The function used to derive this field
  #
  # source://graphql//lib/graphql/field.rb#68
  def function; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/field.rb#210
  def get_argument(argument_name); end
  ...
  #
  # source://graphql//lib/graphql/field.rb#189
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/field.rb#194
  ...
  #
  # source://graphql//lib/graphql/field.rb#40
  def lazy_resolve_proc; end

  # @api deprecated
  # @return [GraphQL::Relay::Mutation, nil] The mutation this field was derived from, if it was derived from a mutation
  #
  # source://graphql//lib/graphql/field.rb#56
  def mutation; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/field.rb#156
  def name=(new_name); end
  ...
  #
  # source://graphql//lib/graphql/field.rb#200
  ...
  #
  # source://graphql//lib/graphql/field.rb#34
  ...
  #
  # source://graphql//lib/graphql/field.rb#135
  ...
  #
  # source://graphql//lib/graphql/field.rb#142
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/field.rb#179
  def to_s; end
  ...
  #
  # source://graphql//lib/graphql/field.rb#79
  def trace; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/field.rb#152
  def type; end

  # @api deprecated
  #
  # source://graphql//lib/graphql/field.rb#146
  def type=(new_return_type); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/field.rb#206
  def type_class; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/field.rb#216
  def build_default_resolver; end

  # @api deprecated
  #
  # source://graphql//lib/graphql/field.rb#117
  def initialize_copy(other); end
end

# @api deprecated
#
# source://graphql//lib/graphql/field.rb#220
module GraphQL::Field::DefaultLazyResolve
  class << self
    # @api deprecated
    #
    # source://graphql//lib/graphql/field.rb#221
...
#
# source://graphql//lib/graphql/field/resolve.rb#5
module GraphQL::Field::Resolve
  ...
  #
  # source://graphql//lib/graphql/field/resolve.rb#10
...
#
# source://graphql//lib/graphql/field/resolve.rb#21
class GraphQL::Field::Resolve::BuiltInResolve; end

# Resolve the field by looking up `@hash_key` with `#[]`
#
# source://graphql//lib/graphql/field/resolve.rb#36
class GraphQL::Field::Resolve::HashKeyResolve < ::GraphQL::Field::Resolve::BuiltInResolve
  ...
  #
  # source://graphql//lib/graphql/field/resolve.rb#37
  def initialize(hash_key); end

  # source://graphql//lib/graphql/field/resolve.rb#41
  def call(obj, args, ctx); end
end

# Resolve the field by `public_send`ing `@method_name`
#
# source://graphql//lib/graphql/field/resolve.rb#25
class GraphQL::Field::Resolve::MethodResolve < ::GraphQL::Field::Resolve::BuiltInResolve
  ...
  #
  # source://graphql//lib/graphql/field/resolve.rb#26
  def initialize(field); end

  # source://graphql//lib/graphql/field/resolve.rb#30
  def call(obj, args, ctx); end
end
...
#
# source://graphql//lib/graphql/field/resolve.rb#48
class GraphQL::Field::Resolve::NameResolve < ::GraphQL::Field::Resolve::BuiltInResolve
  ...
  #
  # source://graphql//lib/graphql/field/resolve.rb#49
  def initialize(field); end

  # source://graphql//lib/graphql/field/resolve.rb#53
  def call(obj, args, ctx); end
end
...
# @api deprecated
#
# source://graphql//lib/graphql/function.rb#4
class GraphQL::Function
  # @api deprecated
  # @return [Hash<String => GraphQL::Argument>] Arguments, keyed by name
  #
  # source://graphql//lib/graphql/function.rb#10
  def arguments; end
  ...
  #
  # source://graphql//lib/graphql/function.rb#20
  def call(obj, args, ctx); end

  # @api deprecated
  # @return [Integer, Proc]
  #
  # source://graphql//lib/graphql/function.rb#35
  def complexity; end

  # @api deprecated
  # @return [String, nil]
  #
  # source://graphql//lib/graphql/function.rb#30
  def deprecation_reason; end

  # @api deprecated
  # @return [String, nil]
  #
  # source://graphql//lib/graphql/function.rb#25
  def description; end

  # @api deprecated
  # @return [GraphQL::BaseType] Return type
  #
  # source://graphql//lib/graphql/function.rb#15
  def type; end
  ...
  class << self
    ...
    #
    # source://graphql//lib/graphql/function.rb#43
    ...
    #
    # source://graphql//lib/graphql/function.rb#50
    def arguments; end

    # @api deprecated
    #
    # source://graphql//lib/graphql/function.rb#77
    ...
    # @private
    #
    # source://graphql//lib/graphql/function.rb#5
    ...
    # @return [GraphQL::BaseType]
    #
    # source://graphql//lib/graphql/function.rb#65
    ...
    # @api deprecated
    #
    # source://graphql//lib/graphql/function.rb#59
    def types; end
    ...
    # @api deprecated
    #
    # source://graphql//lib/graphql/function.rb#123
    ...
    # @return [Boolean]
    #
    # source://graphql//lib/graphql/function.rb#118
...
# @api deprecated
#
# source://graphql//lib/graphql/input_object_type.rb#4
class GraphQL::InputObjectType < ::GraphQL::BaseType
  ...
  #
  # source://graphql//lib/graphql/input_object_type.rb#24
  def initialize; end

  # @return [Hash<String => GraphQL::Argument>] Map String argument names to their {GraphQL::Argument} implementations
  #
  # source://graphql//lib/graphql/input_object_type.rb#13
  def arguments; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/input_object_type.rb#38
  def coerce_result(value, ctx = T.unsafe(nil)); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/input_object_type.rb#63
  def get_argument(argument_name); end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/input_object_type.rb#34
  def kind; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/input_object_type.rb#69
  def coerce_non_null_input(value, ctx); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/input_object_type.rb#29
  def initialize_copy(other); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/input_object_type.rb#93
  def validate_non_null_input(input, ctx); end
end

# @api private
#
# source://graphql//lib/graphql/input_object_type.rb#91
...
class GraphQL::IntegerEncodingError < ::GraphQL::RuntimeTypeError
  ...
  #
  # source://graphql//lib/graphql/integer_encoding_error.rb#15
  def initialize(value); end
...
# @api deprecated
#
# source://graphql//lib/graphql/interface_type.rb#4
class GraphQL::InterfaceType < ::GraphQL::BaseType
  ...
  #
  # source://graphql//lib/graphql/interface_type.rb#13
  def initialize; end
  ...
  #
  # source://graphql//lib/graphql/interface_type.rb#46
  def all_fields; end

  # @api deprecated
  #
  # source://graphql//lib/graphql/interface_type.rb#9
  def fields; end
  ...
  #
  # source://graphql//lib/graphql/interface_type.rb#39
  ...
  #
  # source://graphql//lib/graphql/interface_type.rb#54
  def get_possible_type(type_name, ctx); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/interface_type.rb#26
  def kind; end
  ...
  #
  # source://graphql//lib/graphql/interface_type.rb#63
  def possible_type?(type, ctx); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/interface_type.rb#30
  def resolve_type(value, ctx); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/interface_type.rb#34
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/interface_type.rb#68
  def type_membership_class; end

  # @api deprecated
  #
  # source://graphql//lib/graphql/interface_type.rb#10
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/interface_type.rb#20
  def initialize_copy(other); end
end

# source://graphql//lib/graphql/internal_representation/document.rb#3
module GraphQL::InternalRepresentation; end

# source://graphql//lib/graphql/internal_representation/document.rb#4
class GraphQL::InternalRepresentation::Document
  # @return [Document] a new instance of Document
  #
  # source://graphql//lib/graphql/internal_representation/document.rb#11
  def initialize; end

  # source://graphql//lib/graphql/internal_representation/document.rb#16
  def [](key); end

  # source://graphql//lib/graphql/internal_representation/document.rb#21
  def each(&block); end

  # @return [Hash<String, Node>] Fragment definition Nodes of this query
  #
  # source://graphql//lib/graphql/internal_representation/document.rb#9
  def fragment_definitions; end

  # @return [Hash<String, Node>] Operation Nodes of this query
  #
  # source://graphql//lib/graphql/internal_representation/document.rb#6
  def operation_definitions; end
end

# source://graphql//lib/graphql/internal_representation/node.rb#4
class GraphQL::InternalRepresentation::Node
  # @return [Node] a new instance of Node
  #
  # source://graphql//lib/graphql/internal_representation/node.rb#65
  def initialize(name:, owner_type:, query:, return_type:, parent:, ast_nodes: T.unsafe(nil), definitions: T.unsafe(nil)); end

  # source://graphql//lib/graphql/internal_representation/node.rb#94
  def ==(other); end

  # source://graphql//lib/graphql/internal_representation/node.rb#109
  def arguments; end

  # source://graphql//lib/graphql/internal_representation/node.rb#120
  def ast_node; end

  # @return [Array<Language::Nodes::AbstractNode>] AST nodes which are represented by this node
  #
  # source://graphql//lib/graphql/internal_representation/node.rb#54
  def ast_nodes; end

  # Merge selections from `new_parent` into `self`.
  # Selections are merged in place, not copied.
  #
  # source://graphql//lib/graphql/internal_representation/node.rb#132
  def deep_merge_node(new_parent, scope: T.unsafe(nil), merge_self: T.unsafe(nil)); end

  # source://graphql//lib/graphql/internal_representation/node.rb#113
  def definition; end

  # source://graphql//lib/graphql/internal_representation/node.rb#105
  def definition_name; end

  # @return [Array<GraphQL::Field>] Field definitions for this node (there should only be one!)
  #
  # source://graphql//lib/graphql/internal_representation/node.rb#57
  def definitions; end

  # source://graphql//lib/graphql/internal_representation/node.rb#124
  def inspect; end

  # @return [String] the name this node has in the response
  #
  # source://graphql//lib/graphql/internal_representation/node.rb#14
  def name; end

  # @return [GraphQL::ObjectType]
  #
  # source://graphql//lib/graphql/internal_representation/node.rb#17
  def owner_type; end

  # @return [InternalRepresentation::Node, nil]
  #
  # source://graphql//lib/graphql/internal_representation/node.rb#63
  def parent; end

  # @return [GraphQL::Query]
  #
  # source://graphql//lib/graphql/internal_representation/node.rb#158
  def query; end

  # @return [GraphQL::BaseType] The expected wrapped type this node must return.
  #
  # source://graphql//lib/graphql/internal_representation/node.rb#60
  def return_type; end
  ...
  #
  # source://graphql//lib/graphql/internal_representation/node.rb#51
  def scoped_children; end

  # source://graphql//lib/graphql/internal_representation/node.rb#160
  ...
  #
  # source://graphql//lib/graphql/internal_representation/node.rb#24
  ...
  #
  # source://graphql//lib/graphql/internal_representation/node.rb#178
  ...
  #
  # source://graphql//lib/graphql/internal_representation/node.rb#185
  def get_typed_children(obj_type); end

  # source://graphql//lib/graphql/internal_representation/node.rb#81
  def initialize_copy(other_node); end
end

# @api private
#
# source://graphql//lib/graphql/internal_representation/node.rb#6
...
#
# source://graphql//lib/graphql/internal_representation/node.rb#9
GraphQL::InternalRepresentation::Node::NO_TYPED_CHILDREN = T.let(T.unsafe(nil), Hash)

# source://graphql//lib/graphql/internal_representation/print.rb#4
module GraphQL::InternalRepresentation::Print
  private

  # source://graphql//lib/graphql/internal_representation/print.rb#7
  def print(schema, query_string); end

  # source://graphql//lib/graphql/internal_representation/print.rb#12
...
#
# source://graphql//lib/graphql/internal_representation/rewrite.rb#16
module GraphQL::InternalRepresentation::Rewrite
  include ::GraphQL::Language

  # source://graphql//lib/graphql/internal_representation/rewrite.rb#24
  def initialize(*_arg0); end

  # source://graphql//lib/graphql/internal_representation/rewrite.rb#120
  def on_field(ast_node, ast_parent); end

  # source://graphql//lib/graphql/internal_representation/rewrite.rb#71
  def on_fragment_definition(ast_node, parent); end

  # source://graphql//lib/graphql/internal_representation/rewrite.rb#169
  def on_fragment_spread(ast_node, ast_parent); end

  # source://graphql//lib/graphql/internal_representation/rewrite.rb#97
  def on_inline_fragment(node, parent); end

  # source://graphql//lib/graphql/internal_representation/rewrite.rb#67
  def on_operation_definition(ast_node, parent); end

  # @return [Hash<String, Node>] Roots of this query
  #
  # source://graphql//lib/graphql/internal_representation/rewrite.rb#62
  def operations; end

  # source://graphql//lib/graphql/internal_representation/rewrite.rb#75
  def push_root_node(ast_node, definitions); end

  # @return InternalRepresentation::Document
  #
  # source://graphql//lib/graphql/internal_representation/rewrite.rb#22
  def rewrite_document; end

  # @return [Boolean]
  #
  # source://graphql//lib/graphql/internal_representation/rewrite.rb#178
  def skip?(ast_node); end
end

# source://graphql//lib/graphql/internal_representation/rewrite.rb#19
...
#
# source://graphql//lib/graphql/internal_representation/scope.rb#15
class GraphQL::InternalRepresentation::Scope
  ...
  #
  # source://graphql//lib/graphql/internal_representation/scope.rb#20
  ...
  #
  # source://graphql//lib/graphql/internal_representation/scope.rb#69
  def each(&block); end
  ...
  # @return [Scope]
  #
  # source://graphql//lib/graphql/internal_representation/scope.rb#40
  def enter(other_type_defn); end

  private

  # source://graphql//lib/graphql/internal_representation/scope.rb#79
  def concrete_types; end
end

# source://graphql//lib/graphql/internal_representation/scope.rb#16
...
#
# source://graphql//lib/graphql/internal_representation/visit.rb#5
module GraphQL::InternalRepresentation::Visit
  ...
  #
  # source://graphql//lib/graphql/internal_representation/visit.rb#26
  def each_node(node, &block); end

  # source://graphql//lib/graphql/internal_representation/visit.rb#7
...
# source://graphql//lib/graphql/introspection/base_object.rb#0
...
class GraphQL::Introspection::DirectiveType < ::GraphQL::Introspection::BaseObject
  # source://graphql//lib/graphql/introspection/directive_type.rb#22
  def args(include_deprecated:); end
end

# source://graphql//lib/graphql/introspection/directive_type.rb#0
...
class GraphQL::Introspection::DynamicFields < ::GraphQL::Introspection::BaseObject
  ...
  #
  # source://graphql//lib/graphql/introspection/dynamic_fields.rb#8
  def __typename(irep_node: T.unsafe(nil)); end
end

# source://graphql//lib/graphql/introspection/dynamic_fields.rb#0
...
# source://graphql//lib/graphql/introspection/entry_points.rb#0
...
# source://graphql//lib/graphql/introspection/enum_value_type.rb#0
...
# source://graphql//lib/graphql/introspection/field_type.rb#0
...
class GraphQL::Introspection::InputValueType < ::GraphQL::Introspection::BaseObject
  ...
  #
  # source://graphql//lib/graphql/introspection/input_value_type.rb#38
  def serialize_default_value(value, type); end
end

# source://graphql//lib/graphql/introspection/input_value_type.rb#0
...
class GraphQL::Introspection::SchemaType < ::GraphQL::Introspection::BaseObject
  ...
  # source://graphql//lib/graphql/introspection/schema_type.rb#25
  def mutation_type; end

  # source://graphql//lib/graphql/introspection/schema_type.rb#21
  def query_type; end

  # source://graphql//lib/graphql/introspection/schema_type.rb#29
  def subscription_type; end

  # source://graphql//lib/graphql/introspection/schema_type.rb#17
  def types; end

  private

  # source://graphql//lib/graphql/introspection/schema_type.rb#39
  def permitted_root_type(op_type); end
end

# source://graphql//lib/graphql/introspection/schema_type.rb#0
...
class GraphQL::Introspection::TypeType < ::GraphQL::Introspection::BaseObject
  # source://graphql//lib/graphql/introspection/type_type.rb#38
  def enum_values(include_deprecated:); end

  # source://graphql//lib/graphql/introspection/type_type.rb#78
  def fields(include_deprecated:); end

  # source://graphql//lib/graphql/introspection/type_type.rb#60
  def input_fields(include_deprecated:); end

  # source://graphql//lib/graphql/introspection/type_type.rb#52
  def interfaces; end

  # source://graphql//lib/graphql/introspection/type_type.rb#34
  def kind; end

  # source://graphql//lib/graphql/introspection/type_type.rb#30
  def name; end

  # source://graphql//lib/graphql/introspection/type_type.rb#90
  def of_type; end

  # source://graphql//lib/graphql/introspection/type_type.rb#70
  def possible_types; end
end

# source://graphql//lib/graphql/introspection/type_type.rb#0
...
module GraphQL::Language::BlockString
  class << self
    # source://graphql//lib/graphql/language/block_string.rb#86
    def break_line(line, length); end

    # source://graphql//lib/graphql/language/block_string.rb#65
    ...
    #
    # source://graphql//lib/graphql/language/block_string.rb#11
...
class GraphQL::Language::DocumentFromSchemaDefinition
  ...
  # @api private
  #
  # source://graphql//lib/graphql/language/document_from_schema_definition.rb#232
  def build_argument_nodes(arguments); end

  # @api private
  #
  # source://graphql//lib/graphql/language/document_from_schema_definition.rb#184
  ...
  # @api private
  #
  # source://graphql//lib/graphql/language/document_from_schema_definition.rb#163
  ...
  # @api private
  #
  # source://graphql//lib/graphql/language/document_from_schema_definition.rb#238
  def build_directive_nodes(directives); end

  # @api private
  #
  # source://graphql//lib/graphql/language/document_from_schema_definition.rb#96
  def build_enum_type_node(enum_type); end

  # @api private
  #
  # source://graphql//lib/graphql/language/document_from_schema_definition.rb#107
  ...
  # @api private
  #
  # source://graphql//lib/graphql/language/document_from_schema_definition.rb#270
  def build_field_nodes(fields); end

  # @api private
  #
  # source://graphql//lib/graphql/language/document_from_schema_definition.rb#141
  ...
  # @api private
  #
  # source://graphql//lib/graphql/language/document_from_schema_definition.rb#58
  ...
  # @api private
  #
  # source://graphql//lib/graphql/language/document_from_schema_definition.rb#213
  ...
  # @api private
  #
  # source://graphql//lib/graphql/language/document_from_schema_definition.rb#39
  def document; end
  ...
  # @api private
  #
  # source://graphql//lib/graphql/language/document_from_schema_definition.rb#341
  def always_include_schema; end

  # @api private
  #
  # source://graphql//lib/graphql/language/document_from_schema_definition.rb#337
  def ast_directives(member); end

  # @api private
  #
  # source://graphql//lib/graphql/language/document_from_schema_definition.rb#292
  def definition_directives(member); end

  # @api private
  #
  # source://graphql//lib/graphql/language/document_from_schema_definition.rb#288
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/language/document_from_schema_definition.rb#278
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/language/document_from_schema_definition.rb#282
...
module GraphQL::Language::Lexer
  class << self
    # source://graphql//lib/graphql/language/lexer.rb#1390
    def emit(token_name, ts, te, meta, token_value = T.unsafe(nil)); end

    # source://graphql//lib/graphql/language/lexer.rb#1424
    ...
    # source://graphql//lib/graphql/language/lexer.rb#1376
    ...
    #
    # source://graphql//lib/graphql/language/lexer.rb#81
    ...
    #
    # source://graphql//lib/graphql/language/lexer.rb#73
    ...
    #
    # source://graphql//lib/graphql/language/lexer.rb#121
    ...
    #
    # source://graphql//lib/graphql/language/lexer.rb#113
    ...
    #
    # source://graphql//lib/graphql/language/lexer.rb#89
    ...
    #
    # source://graphql//lib/graphql/language/lexer.rb#65
...
# source://graphql//lib/graphql/language/lexer.rb#1404
GraphQL::Language::Lexer::ESCAPES = T.let(T.unsafe(nil), Regexp)

# source://graphql//lib/graphql/language/lexer.rb#1405
GraphQL::Language::Lexer::ESCAPES_REPLACE = T.let(T.unsafe(nil), Hash)

# source://graphql//lib/graphql/language/lexer.rb#1421
...
# source://graphql//lib/graphql/language/lexer.rb#1422
GraphQL::Language::Lexer::UTF_8_ENCODING = T.let(T.unsafe(nil), String)

# source://graphql//lib/graphql/language/lexer.rb#1417
GraphQL::Language::Lexer::UTF_8_REPLACE = T.let(T.unsafe(nil), Proc)

# source://graphql//lib/graphql/language/lexer.rb#1419
...
#
# source://graphql//lib/graphql/language/nodes.rb#286
class GraphQL::Language::Nodes::Argument < ::GraphQL::Language::Nodes::AbstractNode
  ...
  #
  # source://graphql//lib/graphql/language/nodes.rb#232
  def name; end

  # source://graphql//lib/graphql/language/nodes.rb#234
  def scalars; end
...
# source://graphql//lib/graphql/language/nodes.rb#301
...
class GraphQL::Language::Nodes::DirectiveDefinition < ::GraphQL::Language::Nodes::AbstractNode
  ...
  # Returns the value of attribute description.
  #
  # source://graphql//lib/graphql/language/nodes.rb#311
  def description; end
...
# source://graphql//lib/graphql/language/nodes.rb#676
...
class GraphQL::Language::Nodes::Field < ::GraphQL::Language::Nodes::AbstractNode
  ...
  # source://graphql//lib/graphql/language/nodes.rb#370
...
class GraphQL::Language::Nodes::FieldDefinition < ::GraphQL::Language::Nodes::AbstractNode
  ...
  # Returns the value of attribute description.
  #
  # source://graphql//lib/graphql/language/nodes.rb#577
  def description; end
...
class GraphQL::Language::Nodes::FragmentDefinition < ::GraphQL::Language::Nodes::AbstractNode
  ...
  # source://graphql//lib/graphql/language/nodes.rb#390
...
#
# source://graphql//lib/graphql/language/nodes.rb#418
...
#
# source://graphql//lib/graphql/language/nodes.rb#432
...
class GraphQL::Language::Nodes::InputObjectTypeDefinition < ::GraphQL::Language::Nodes::AbstractNode
  ...
  # Returns the value of attribute description.
  #
  # source://graphql//lib/graphql/language/nodes.rb#687
  def description; end
...
#
# source://graphql//lib/graphql/language/nodes.rb#472
...
#
# source://graphql//lib/graphql/language/nodes.rb#476
...
class GraphQL::Language::Nodes::ObjectTypeDefinition < ::GraphQL::Language::Nodes::AbstractNode
  ...
  # Returns the value of attribute description.
  #
  # source://graphql//lib/graphql/language/nodes.rb#598
  def description; end
...
#
# source://graphql//lib/graphql/language/nodes.rb#498
...
# source://graphql//lib/graphql/language/nodes.rb#539
...
#
# source://graphql//lib/graphql/language/nodes.rb#522
...
#
# source://graphql//lib/graphql/language/nodes.rb#274
...
class GraphQL::Language::Parser < ::Racc::Parser
  ...
  # source://graphql//lib/graphql/language/parser.rb#1960
...
# source://graphql//lib/graphql/language/parser.rb#974
...
class GraphQL::Language::Printer
  ...
  # source://graphql//lib/graphql/language/printer.rb#178
  ...
  # source://graphql//lib/graphql/language/printer.rb#242
  ...
  # source://graphql//lib/graphql/language/printer.rb#214
  def print_enum_type_definition(enum_type); end

  # source://graphql//lib/graphql/language/printer.rb#224
  ...
  # source://graphql//lib/graphql/language/printer.rb#230
  ...
  # source://graphql//lib/graphql/language/printer.rb#200
  ...
  # source://graphql//lib/graphql/language/printer.rb#289
  def print_node(node, indent: T.unsafe(nil)); end
  ...
  # source://graphql//lib/graphql/language/printer.rb#277
  ...
  # source://graphql//lib/graphql/language/printer.rb#207
...
class GraphQL::Language::Token
  ...
  #
  # source://graphql//lib/graphql/language/token.rb#17
  def initialize(name, value, line, col, prev_token); end

  # Returns the value of attribute col.
  #
  # source://graphql//lib/graphql/language/token.rb#15
  def col; end

  # source://graphql//lib/graphql/language/token.rb#33
  def inspect; end
  ...
  #
  # source://graphql//lib/graphql/language/token.rb#12
  def name; end
  ...
  # source://graphql//lib/graphql/language/token.rb#27
  def to_f; end

  # source://graphql//lib/graphql/language/token.rb#26
  def to_i; end

  # @return [String] The text of this token
  #
  # source://graphql//lib/graphql/language/token.rb#14
  def to_s; end
...
#   end
#
# source://graphql//lib/graphql/list_type.rb#27
class GraphQL::ListType < ::GraphQL::BaseType
  include ::GraphQL::BaseType::ModifiesAnotherType

  # @return [ListType] a new instance of ListType
  #
  # source://graphql//lib/graphql/list_type.rb#30
  def initialize(of_type:); end

  # source://graphql//lib/graphql/list_type.rb#45
  def coerce_result(value, ctx = T.unsafe(nil)); end

  # source://graphql//lib/graphql/list_type.rb#39
  def inspect; end

  # source://graphql//lib/graphql/list_type.rb#35
  def kind; end

  # @return [Boolean]
  #
  # source://graphql//lib/graphql/list_type.rb#53
  def list?; end

  # Returns the value of attribute of_type.
  #
  # source://graphql//lib/graphql/list_type.rb#29
  def of_type; end
  ...
  # source://graphql//lib/graphql/list_type.rb#59
  def coerce_non_null_input(value, ctx); end

  # source://graphql//lib/graphql/list_type.rb#76
  def ensure_array(value); end

  # source://graphql//lib/graphql/list_type.rb#63
...
class GraphQL::NameValidator
  class << self
    ...
    #
    # source://graphql//lib/graphql/name_validator.rb#10
    def validate!(name); end
  end
end

# source://graphql//lib/graphql/name_validator.rb#8
...
#   end
#
# source://graphql//lib/graphql/non_null_type.rb#31
class GraphQL::NonNullType < ::GraphQL::BaseType
  ...
  #
  # source://graphql//lib/graphql/non_null_type.rb#36
  def initialize(of_type:); end
  ...
  # source://graphql//lib/graphql/non_null_type.rb#61
  def inspect; end

  # source://graphql//lib/graphql/non_null_type.rb#57
  def kind; end
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/non_null_type.rb#67
  def non_null?; end

  # Returns the value of attribute of_type.
  #
  # source://graphql//lib/graphql/non_null_type.rb#35
  def of_type; end
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/non_null_type.rb#41
  def valid_input?(value, ctx); end

  # source://graphql//lib/graphql/non_null_type.rb#45
  def validate_input(value, ctx); end
end

# @api deprecated
#
# source://graphql//lib/graphql/object_type.rb#4
class GraphQL::ObjectType < ::GraphQL::BaseType
  ...
  #
  # source://graphql//lib/graphql/object_type.rb#19
  def initialize; end
  ...
  # @see [Schema#get_fields] Get fields with instrumentation
  #
  # source://graphql//lib/graphql/object_type.rb#75
  def all_fields; end

  # @return [Hash<String => GraphQL::Field>] Map String fieldnames to their {GraphQL::Field} implementations
  #
  # source://graphql//lib/graphql/object_type.rb#10
  def fields; end
  ...
  #
  # source://graphql//lib/graphql/object_type.rb#68
  def get_field(field_name); end
  ...
  #
  # source://graphql//lib/graphql/object_type.rb#83
  def implements(interfaces, inherit: T.unsafe(nil), **options); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/object_type.rb#44
  ...
  #
  # source://graphql//lib/graphql/object_type.rb#37
  def interfaces=(new_interfaces); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/object_type.rb#61
  def kind; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/object_type.rb#98
  def resolve_type_proc; end

  # @api deprecated
  #
  # source://graphql//lib/graphql/object_type.rb#102
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/object_type.rb#106
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/object_type.rb#27
  def initialize_copy(other); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/object_type.rb#114
  def interface_fields; end

  # @api deprecated
  #
  # source://graphql//lib/graphql/object_type.rb#110
...
class GraphQL::Pagination::ActiveRecordRelationConnection < ::GraphQL::Pagination::RelationConnection
  ...
  # source://graphql//lib/graphql/pagination/active_record_relation_connection.rb#38
  def null_relation(relation); end

  # source://graphql//lib/graphql/pagination/active_record_relation_connection.rb#15
  ...
  # source://graphql//lib/graphql/pagination/active_record_relation_connection.rb#30
  def relation_limit(relation); end

  # source://graphql//lib/graphql/pagination/active_record_relation_connection.rb#34
...
class GraphQL::Pagination::Connections
  ...
  #
  # source://graphql//lib/graphql/pagination/connections.rb#31
  def initialize(schema:); end

  # source://graphql//lib/graphql/pagination/connections.rb#37
  def add(nodes_class, implementation); end

  # source://graphql//lib/graphql/pagination/connections.rb#45
  def all_wrappers; end

  # source://graphql//lib/graphql/pagination/connections.rb#41
  ...
  # @api private
  #
  # source://graphql//lib/graphql/pagination/connections.rb#94
  ...
  # @api Private
  #
  # source://graphql//lib/graphql/pagination/connections.rb#68
  def wrap(field, parent, items, arguments, context); end

  # source://graphql//lib/graphql/pagination/connections.rb#55
  ...
  #
  # source://graphql//lib/graphql/pagination/connections.rb#105
  def wrappers; end

  private

  # source://graphql//lib/graphql/pagination/connections.rb#109
  def add_default; end
...
class GraphQL::Pagination::RelationConnection < ::GraphQL::Pagination::Connection
  ...
  # @return [Integer, nil]
  #
  # source://graphql//lib/graphql/pagination/relation_connection.rb#150
  ...
  #
  # source://graphql//lib/graphql/pagination/relation_connection.rb#156
  def limited_nodes; end

  # Load nodes after applying first/last/before/after,
  # returns an array of nodes
  #
  # source://graphql//lib/graphql/pagination/relation_connection.rb#190
  def load_nodes; end

  # @param relation [Object] A database query object
  # @return [Object] A modified query object which will return no records
  #
  # source://graphql//lib/graphql/pagination/relation_connection.rb#83
  def null_relation(relation); end

  # @return [Integer]
  #
  # source://graphql//lib/graphql/pagination/relation_connection.rb#88
  ...
  #
  # source://graphql//lib/graphql/pagination/relation_connection.rb#77
  def relation_count(relation); end
  ...
  #
  # source://graphql//lib/graphql/pagination/relation_connection.rb#59
  def relation_larger_than(relation, size); end

  # @param relation [Object] A database query object
  # @return [Integer, nil] The limit value, or nil if there isn't one
  #
  # source://graphql//lib/graphql/pagination/relation_connection.rb#71
  def relation_limit(relation); end

  # @param relation [Object] A database query object
  # @return [Integer, nil] The offset value, or nil if there isn't one
  #
  # source://graphql//lib/graphql/pagination/relation_connection.rb#65
  def relation_offset(relation); end

  # Abstract this operation so we can always ignore inputs less than zero.
  # (Sequel doesn't like it, understandably.)
  #
  # source://graphql//lib/graphql/pagination/relation_connection.rb#104
  def set_limit(relation, limit_value); end

  # Abstract this operation so we can always ignore inputs less than zero.
  # (Sequel doesn't like it, understandably.)
  #
  # source://graphql//lib/graphql/pagination/relation_connection.rb#94
  def set_offset(relation, offset_value); end

  # Apply `before` and `after` to the underlying `items`,
  # returning a new relation.
  #
  # source://graphql//lib/graphql/pagination/relation_connection.rb#116
...
class GraphQL::Query
  ...
  #
  # source://graphql//lib/graphql/query.rb#82
  ...
  # @return [GraphQL::Language::Nodes::Document]
  #
  # source://graphql//lib/graphql/query.rb#47
  def document; end
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/query.rb#152
  def interpreter?; end
  ...
  # @return [GraphQL::Execution::Lookahead]
  #
  # source://graphql//lib/graphql/query.rb#164
  def lookahead; end
  ...
  #
  # source://graphql//lib/graphql/query.rb#156
  def multiplex; end
  ...
  #
  # source://graphql//lib/graphql/query.rb#148
  ...
  #
  # source://graphql//lib/graphql/query.rb#44
  ...
  #
  # source://graphql//lib/graphql/query.rb#61
  ...
  #
  # source://graphql//lib/graphql/query.rb#69
  def tracers; end
  ...
  #
  # source://graphql//lib/graphql/query.rb#443
...
#
# source://graphql//lib/graphql/query/arguments.rb#7
class GraphQL::Query::Arguments
  ...
  # @return [Arguments] a new instance of Arguments
  #
  # source://graphql//lib/graphql/query/arguments.rb#43
  ...
  #
  # source://graphql//lib/graphql/query/arguments.rb#57
  def [](key); end
  ...
  #
  # source://graphql//lib/graphql/query/arguments.rb#41
  def argument_values; end
  ...
  #
  # source://graphql//lib/graphql/query/arguments.rb#71
  ...
  #
  # source://graphql//lib/graphql/query/arguments.rb#99
  def each_value; end

  # @param key [String, Symbol] name of value to access
  # @return [Boolean] true if the argument was present in this field
  #
  # source://graphql//lib/graphql/query/arguments.rb#64
  def key?(key); end

  # source://forwardable/1.3.2/forwardable.rb#229
  def keys(*args, **_arg1, &block); end

  # source://graphql//lib/graphql/query/arguments.rb#92
  def prepare; end
  ...
  #
  # source://graphql//lib/graphql/query/arguments.rb#78
  def to_h; end
  ...
  #
  # source://graphql//lib/graphql/query/arguments.rb#117
  def to_hash; end
  ...
  # source://graphql//lib/graphql/query/arguments.rb#172
  def unwrap_value(value); end

  # source://graphql//lib/graphql/query/arguments.rb#150
  def wrap_value(value, arg_defn_type, context); end

  class << self
    # Returns the value of attribute argument_definitions.
    #
    # source://graphql//lib/graphql/query/arguments.rb#106
    ...
    # source://graphql//lib/graphql/query/arguments.rb#11
    def construct_arguments_class(argument_owner); end
  end
end

# source://graphql//lib/graphql/query/arguments.rb#131
class GraphQL::Query::Arguments::ArgumentValue
  # @return [ArgumentValue] a new instance of ArgumentValue
  #
  # source://graphql//lib/graphql/query/arguments.rb#135
  ...
  #
  # source://graphql//lib/graphql/query/arguments.rb#133
  def default_used=(_arg0); end

  # @return [Boolean] true if the argument default was passed as the argument value to the resolver
  #
  # source://graphql//lib/graphql/query/arguments.rb#143
  def default_used?; end

  # Returns the value of attribute definition.
  #
  # source://graphql//lib/graphql/query/arguments.rb#132
  def definition; end
...
module GraphQL::Query::ArgumentsCache
  class << self
    ...
    #
    # source://graphql//lib/graphql/query/arguments_cache.rb#6
    def build(query); end
  end
end
...
class GraphQL::Query::Context
  ...
  #
  # source://graphql//lib/graphql/query/context.rb#172
  def []=(key, value); end
  ...
  # source://graphql//lib/graphql/query/context.rb#211
  def dig(key, *other_keys); end

  # @return [Array<GraphQL::ExecutionError>] errors returned during execution
  #
  # source://graphql//lib/graphql/query/context.rb#130
  def errors; end
  ...
  # source://graphql//lib/graphql/query/context.rb#112
  ...
  #
  # source://graphql//lib/graphql/query/context.rb#232
  ...
  #
  # source://graphql//lib/graphql/query/context.rb#133
  def query; end
...
# source://graphql//lib/graphql/query/context.rb#83
class GraphQL::Query::Context::ExecutionErrors
  # @return [ExecutionErrors] a new instance of ExecutionErrors
  #
  # source://graphql//lib/graphql/query/context.rb#84
...
class GraphQL::Query::Context::FieldResolutionContext
  ...
  # @return [void]
  #
  # source://graphql//lib/graphql/query/context.rb#301
  def add_error(error); end

  # @return [GraphQL::Language::Nodes::Field] The AST node for the currently-executing field
  #
  # source://graphql//lib/graphql/query/context.rb#294
  def ast_node; end
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/query/context.rb#354
...
module GraphQL::Query::Context::SharedMethods
  ...
  #
  # source://graphql//lib/graphql/query/context.rb#23
  def skip; end
...
# source://graphql//lib/graphql/query/executor.rb#4
class GraphQL::Query::Executor
  # @return [Executor] a new instance of Executor
  #
  # source://graphql//lib/graphql/query/executor.rb#10
  def initialize(query); end

  # @return [GraphQL::Query] the query being executed
  #
  # source://graphql//lib/graphql/query/executor.rb#8
  def query; end
  ...
  #
  # source://graphql//lib/graphql/query/executor.rb#17
  def result; end

  private

  # source://graphql//lib/graphql/query/executor.rb#26
  def execute; end
end

# source://graphql//lib/graphql/query/executor.rb#5
...
class GraphQL::Query::InputValidationResult
  ...
  # source://graphql//lib/graphql/query/input_validation_result.rb#16
  def add_problem(explanation, path = T.unsafe(nil), extensions: T.unsafe(nil), message: T.unsafe(nil)); end

  # source://graphql//lib/graphql/query/input_validation_result.rb#29
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/query/input_validation_result.rb#12
  def valid?; end
end

# Turn query string values into something useful for query execution
#
# source://graphql//lib/graphql/query/literal_input.rb#5
class GraphQL::Query::LiteralInput
  class << self
    # source://graphql//lib/graphql/query/literal_input.rb#6
    def coerce(type, ast_node, variables); end

    # source://graphql//lib/graphql/query/literal_input.rb#51
...
class GraphQL::Query::NullContext
  ...
  # source://graphql//lib/graphql/query/null_context.rb#31
  def [](key); end
  ...
  class << self
    # source://graphql//lib/graphql/query/null_context.rb#40
    def [](key); end
...
class GraphQL::Query::NullContext::NullQuery
  # source://graphql//lib/graphql/query/null_context.rb#13
  def with_error_handling; end
end
...
class GraphQL::Query::OperationNameMissingError < ::GraphQL::ExecutionError
  ...
  #
  # source://graphql//lib/graphql/query.rb#23
...
# source://graphql//lib/graphql/query/serial_execution/value_resolution.rb#4
class GraphQL::Query::SerialExecution
  ...
  #
  # source://graphql//lib/graphql/query/serial_execution.rb#18
  def execute(ast_operation, root_type, query_object); end

  # source://graphql//lib/graphql/query/serial_execution.rb#27
  def field_resolution; end

  # source://graphql//lib/graphql/query/serial_execution.rb#31
  def operation_resolution; end

  # source://graphql//lib/graphql/query/serial_execution.rb#35
  def selection_resolution; end
end

# source://graphql//lib/graphql/query/serial_execution/field_resolution.rb#5
class GraphQL::Query::SerialExecution::FieldResolution
  # @return [FieldResolution] a new instance of FieldResolution
  #
  # source://graphql//lib/graphql/query/serial_execution/field_resolution.rb#8
  def initialize(selection, parent_type, target, query_ctx); end

  # Returns the value of attribute arguments.
  #
  # source://graphql//lib/graphql/query/serial_execution/field_resolution.rb#6
  def arguments; end

  # GraphQL::Batch depends on this
  #
  # source://graphql//lib/graphql/query/serial_execution/field_resolution.rb#34
  ...
  # source://graphql//lib/graphql/query/serial_execution/field_resolution.rb#23
  def result; end
  ...
  #
  # source://graphql//lib/graphql/query/serial_execution/field_resolution.rb#42
  ...
  #
  # source://graphql//lib/graphql/query/serial_execution/field_resolution.rb#82
  def get_raw_value; end
end

# source://graphql//lib/graphql/query/serial_execution/operation_resolution.rb#5
module GraphQL::Query::SerialExecution::OperationResolution
  class << self
    # source://graphql//lib/graphql/query/serial_execution/operation_resolution.rb#6
    def resolve(selection, target, query); end
  end
end

# source://graphql//lib/graphql/query/serial_execution/selection_resolution.rb#5
module GraphQL::Query::SerialExecution::SelectionResolution
  class << self
    # source://graphql//lib/graphql/query/serial_execution/selection_resolution.rb#6
    def resolve(target, current_type, selection, query_ctx); end
  end
end

# source://graphql//lib/graphql/query/serial_execution/value_resolution.rb#5
module GraphQL::Query::SerialExecution::ValueResolution
  class << self
    # source://graphql//lib/graphql/query/serial_execution/value_resolution.rb#6
...
class GraphQL::Query::ValidationPipeline
  ...
  # @api private
  #
  # source://graphql//lib/graphql/query/validation_pipeline.rb#51
  def analyzers; end

  # @api private
  # @return [Hash<String, nil => GraphQL::InternalRepresentation::Node] Operation name -] Irep node pairs
  #
  # source://graphql//lib/graphql/query/validation_pipeline.rb#46
  ...
  #
  # source://graphql//lib/graphql/query/validation_pipeline.rb#34
  def valid?; end
  ...
  #
  # source://graphql//lib/graphql/query/validation_pipeline.rb#40
  ...
  # @api private
  #
  # source://graphql//lib/graphql/query/validation_pipeline.rb#100
  ...
  # @api private
  #
  # source://graphql//lib/graphql/query/validation_pipeline.rb#60
...
# source://graphql//lib/graphql/relay/type_extensions.rb#3
module GraphQL::Relay; end

# source://graphql//lib/graphql/relay/array_connection.rb#4
class GraphQL::Relay::ArrayConnection < ::GraphQL::Relay::BaseConnection
  # source://graphql//lib/graphql/relay/array_connection.rb#5
  def cursor_from_node(item); end

  # source://graphql//lib/graphql/relay/array_connection.rb#34
  def first; end

  # source://graphql//lib/graphql/relay/array_connection.rb#10
  def has_next_page; end

  # source://graphql//lib/graphql/relay/array_connection.rb#22
  def has_previous_page; end

  # source://graphql//lib/graphql/relay/array_connection.rb#44
  def last; end

  private

  # source://graphql//lib/graphql/relay/array_connection.rb#76
  def index_from_cursor(cursor); end

  # apply first / last limit results
  #
  # source://graphql//lib/graphql/relay/array_connection.rb#51
  def paged_nodes; end

  # Apply cursors to edges
  #
  # source://graphql//lib/graphql/relay/array_connection.rb#64
  def sliced_nodes; end
end
...
#
# source://graphql//lib/graphql/relay/base_connection.rb#14
class GraphQL::Relay::BaseConnection
  ...
  #
  # source://graphql//lib/graphql/relay/base_connection.rb#61
  ...
  # @return [String, nil]
  #
  # source://graphql//lib/graphql/relay/base_connection.rb#100
  def after; end

  # Returns the value of attribute arguments.
  #
  # source://graphql//lib/graphql/relay/base_connection.rb#52
  def arguments; end
  ...
  # @return [String, nil]
  #
  # source://graphql//lib/graphql/relay/base_connection.rb#112
  def before; end
  ...
  # @raise [GraphQL::RequiredImplementationMissingError]
  #
  # source://graphql//lib/graphql/relay/base_connection.rb#156
  def cursor_from_node(object); end

  # source://graphql//lib/graphql/relay/base_connection.rb#82
  def decode(data); end

  # These are the nodes to render for this connection,
  # probably wrapped by {GraphQL::Relay::Edge}
  #
  # source://graphql//lib/graphql/relay/base_connection.rb#118
  def edge_nodes; end

  # source://graphql//lib/graphql/relay/base_connection.rb#78
  def encode(data); end

  # Used by `pageInfo`
  #
  # source://graphql//lib/graphql/relay/base_connection.rb#147
  def end_cursor; end
  ...
  # @return [Integer, nil]
  #
  # source://graphql//lib/graphql/relay/base_connection.rb#88
  def first; end

  # Used by `pageInfo`
  #
  # source://graphql//lib/graphql/relay/base_connection.rb#128
  def has_next_page; end

  # Used by `pageInfo`
  #
  # source://graphql//lib/graphql/relay/base_connection.rb#133
  def has_previous_page; end

  # source://graphql//lib/graphql/relay/base_connection.rb#160
  def inspect; end
  ...
  # @return [Integer, nil]
  #
  # source://graphql//lib/graphql/relay/base_connection.rb#106
  def last; end
  ...
  #
  # source://graphql//lib/graphql/relay/base_connection.rb#123
  def page_info; end
  ...
  # Used by `pageInfo`
  #
  # source://graphql//lib/graphql/relay/base_connection.rb#138
  def start_cursor; end
  ...
  # @return [nil, Integer] `nil` if the input was `nil`, otherwise a value between `0` and `max_page_size`
  #
  # source://graphql//lib/graphql/relay/base_connection.rb#169
  def limit_pagination_argument(argument, max_page_size); end

  # @raise [GraphQL::RequiredImplementationMissingError]
  #
  # source://graphql//lib/graphql/relay/base_connection.rb#180
  def paged_nodes; end

  # @raise [GraphQL::RequiredImplementationMissingError]
  #
  # source://graphql//lib/graphql/relay/base_connection.rb#184
  def sliced_nodes; end
  ...
  class << self
    ...
    #
    # source://graphql//lib/graphql/relay/base_connection.rb#27
    ...
    #
    # source://graphql//lib/graphql/relay/base_connection.rb#47
...
#
# source://graphql//lib/graphql/relay/base_connection.rb#20
GraphQL::Relay::BaseConnection::CONNECTION_IMPLEMENTATIONS = T.let(T.unsafe(nil), Hash)

# Just to encode data in the cursor, use something that won't conflict
#
# source://graphql//lib/graphql/relay/base_connection.rb#16
...
#
# source://graphql//lib/graphql/relay/connection_instrumentation.rb#9
module GraphQL::Relay::ConnectionInstrumentation
  class << self
    # source://graphql//lib/graphql/relay/connection_instrumentation.rb#10
    ...
    #
    # source://graphql//lib/graphql/relay/connection_instrumentation.rb#34
    def instrument(type, field); end
  end
end

# source://graphql//lib/graphql/relay/connection_resolve.rb#4
class GraphQL::Relay::ConnectionResolve
  # @return [ConnectionResolve] a new instance of ConnectionResolve
  #
  # source://graphql//lib/graphql/relay/connection_resolve.rb#5
  def initialize(field, underlying_resolve); end

  # source://graphql//lib/graphql/relay/connection_resolve.rb#11
  def call(obj, args, ctx); end

  private

  # source://graphql//lib/graphql/relay/connection_resolve.rb#29
  def build_connection(nodes, args, parent, ctx); end
end

# @api deprecated
#
# source://graphql//lib/graphql/relay/connection_type.rb#5
module GraphQL::Relay::ConnectionType
  class << self
    # @api deprecated
    # @return [Boolean] If true, connections check for reverse-direction `has*Page` values
    #
    # source://graphql//lib/graphql/relay/connection_type.rb#10
    ...
    # @api deprecated
    #
    # source://graphql//lib/graphql/relay/connection_type.rb#17
    ...
    #
    # source://graphql//lib/graphql/relay/connection_type.rb#8
...
#
# source://graphql//lib/graphql/relay/edge.rb#7
class GraphQL::Relay::Edge
  # @return [Edge] a new instance of Edge
  #
  # source://graphql//lib/graphql/relay/edge.rb#9
  def initialize(node, connection); end

  # Returns the value of attribute connection.
  #
  # source://graphql//lib/graphql/relay/edge.rb#8
  def connection; end

  # source://graphql//lib/graphql/relay/edge.rb#14
  def cursor; end

  # source://graphql//lib/graphql/relay/edge.rb#22
  def inspect; end
  ...
  # source://graphql//lib/graphql/relay/edge.rb#18
  def parent; end
end

# source://graphql//lib/graphql/relay/edge_type.rb#4
module GraphQL::Relay::EdgeType
  class << self
    # @api deprecated
    #
    # source://graphql//lib/graphql/relay/edge_type.rb#6
    def create_type(wrapped_type, name: T.unsafe(nil), &block); end
  end
end

# source://graphql//lib/graphql/relay/edges_instrumentation.rb#4
module GraphQL::Relay::EdgesInstrumentation
  class << self
    # source://graphql//lib/graphql/relay/edges_instrumentation.rb#5
    def instrument(type, field); end
  end
end

# source://graphql//lib/graphql/relay/edges_instrumentation.rb#20
class GraphQL::Relay::EdgesInstrumentation::EdgesResolve
  # @return [EdgesResolve] a new instance of EdgesResolve
  #
  # source://graphql//lib/graphql/relay/edges_instrumentation.rb#21
  def initialize(edge_class:, resolve:); end

  # A user's custom Connection may return a lazy object,
  # if so, handle it later.
  #
  # source://graphql//lib/graphql/relay/edges_instrumentation.rb#28
  def call(obj, args, ctx); end
end

# source://graphql//lib/graphql/relay/global_id_resolve.rb#4
class GraphQL::Relay::GlobalIdResolve
  # @return [GlobalIdResolve] a new instance of GlobalIdResolve
  #
  # source://graphql//lib/graphql/relay/global_id_resolve.rb#5
  def initialize(type:); end

  # source://graphql//lib/graphql/relay/global_id_resolve.rb#9
  def call(obj, args, ctx); end
end
...
# - `Mongoid::Criteria`
#
# source://graphql//lib/graphql/relay/mongo_relation_connection.rb#7
class GraphQL::Relay::MongoRelationConnection < ::GraphQL::Relay::RelationConnection
  private

  # source://graphql//lib/graphql/relay/mongo_relation_connection.rb#23
  def limit_nodes(sliced_nodes, limit); end

  # source://graphql//lib/graphql/relay/mongo_relation_connection.rb#18
  def relation_count(relation); end

  # source://graphql//lib/graphql/relay/mongo_relation_connection.rb#14
  def relation_limit(relation); end

  # source://graphql//lib/graphql/relay/mongo_relation_connection.rb#10
  def relation_offset(relation); end
end

# @api deprecated
#
# source://graphql//lib/graphql/relay/mutation/instrumentation.rb#4
class GraphQL::Relay::Mutation
  ...
  #
  # source://graphql//lib/graphql/relay/mutation.rb#32
  def initialize; end

  # @api deprecated
  #
  # source://graphql//lib/graphql/relay/mutation.rb#19
  def arguments; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/relay/mutation.rb#49
  def field; end
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/relay/mutation.rb#39
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/relay/mutation.rb#84
  def input_type; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/relay/mutation.rb#45
  def resolve=(new_resolve_proc); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/relay/mutation.rb#101
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/relay/mutation.rb#63
  def return_interfaces; end

  # @api deprecated
  #
  # source://graphql//lib/graphql/relay/mutation.rb#20
  def return_interfaces=(_arg0); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/relay/mutation.rb#67
  def return_type; end
...
# @api private
#
# source://graphql//lib/graphql/relay/mutation/instrumentation.rb#6
module GraphQL::Relay::Mutation::Instrumentation
  class << self
    ...
    # @api private
    #
    # source://graphql//lib/graphql/relay/mutation/instrumentation.rb#12
    def instrument(type, field); end
  end
end
...
# @api private
#
# source://graphql//lib/graphql/relay/mutation/resolve.rb#9
class GraphQL::Relay::Mutation::Resolve
  # @api private
  # @return [Resolve] a new instance of Resolve
  #
  # source://graphql//lib/graphql/relay/mutation/resolve.rb#10
  def initialize(mutation, resolve); end

  # @api private
  #
  # source://graphql//lib/graphql/relay/mutation/resolve.rb#17
  def call(obj, args, ctx); end
  ...
  # @api private
  #
  # source://graphql//lib/graphql/relay/mutation/resolve.rb#31
...
# @api private
#
# source://graphql//lib/graphql/relay/mutation/result.rb#8
class GraphQL::Relay::Mutation::Result
  # @api private
  # @return [Result] a new instance of Result
  #
  # source://graphql//lib/graphql/relay/mutation/result.rb#10
  def initialize(client_mutation_id:, result:); end

  # @api private
  #
  # source://graphql//lib/graphql/relay/mutation/result.rb#9
  def client_mutation_id; end
  ...
  class << self
    ...
    # @return [Class]
    #
    # source://graphql//lib/graphql/relay/mutation/result.rb#25
    def define_subclass(mutation_defn); end

    # @api private
    #
    # source://graphql//lib/graphql/relay/mutation/result.rb#18
    def mutation; end
...
#
# source://graphql//lib/graphql/relay/node.rb#5
module GraphQL::Relay::Node
  class << self
    # @return [GraphQL::Field] a field for finding objects by their global ID.
    #
    # source://graphql//lib/graphql/relay/node.rb#7
    def field(**kwargs, &block); end

    # @return [GraphQL::InterfaceType] The interface which all Relay types must implement
    #
    # source://graphql//lib/graphql/relay/node.rb#33
    def interface; end

    # source://graphql//lib/graphql/relay/node.rb#21
...
#
# source://graphql//lib/graphql/relay/page_info.rb#5
...
# - `Sequel::Dataset`
#
# source://graphql//lib/graphql/relay/relation_connection.rb#8
class GraphQL::Relay::RelationConnection < ::GraphQL::Relay::BaseConnection
  # source://graphql//lib/graphql/relay/relation_connection.rb#9
  def cursor_from_node(item); end

  # source://graphql//lib/graphql/relay/relation_connection.rb#52
  def first; end

  # source://graphql//lib/graphql/relay/relation_connection.rb#26
  def has_next_page; end

  # source://graphql//lib/graphql/relay/relation_connection.rb#40
  def has_previous_page; end

  # source://graphql//lib/graphql/relay/relation_connection.rb#62
  def last; end

  private

  # source://graphql//lib/graphql/relay/relation_connection.rb#161
  def limit_nodes(sliced_nodes, limit); end

  # source://graphql//lib/graphql/relay/relation_connection.rb#176
  def offset_from_cursor(cursor); end
  ...
  # @return [Array]
  #
  # source://graphql//lib/graphql/relay/relation_connection.rb#70
  def paged_nodes; end

  # source://graphql//lib/graphql/relay/relation_connection.rb#106
  def paged_nodes_offset; end

  # If a relation contains a `.group` clause, a `.count` will return a Hash.
  #
  # source://graphql//lib/graphql/relay/relation_connection.rb#127
  def relation_count(relation); end

  # source://graphql//lib/graphql/relay/relation_connection.rb#118
  def relation_limit(relation); end

  # source://graphql//lib/graphql/relay/relation_connection.rb#110
  def relation_offset(relation); end

  # Apply cursors to edges
  #
  # source://graphql//lib/graphql/relay/relation_connection.rb#137
  def sliced_nodes; end

  # source://graphql//lib/graphql/relay/relation_connection.rb#169
...
module GraphQL::Relay::TypeExtensions
  ...
  # @return [GraphQL::ObjectType]
  #
  # source://graphql//lib/graphql/relay/type_extensions.rb#14
  ...
  # @return [GraphQL::ObjectType]
  #
  # source://graphql//lib/graphql/relay/type_extensions.rb#26
  def define_edge(**kwargs, &block); end

  # @return [GraphQL::ObjectType] The default edge type for this object type
  #
  # source://graphql//lib/graphql/relay/type_extensions.rb#20
  def edge_type; end
end

# source://graphql//lib/graphql.rb#20
...
# @api deprecated
#
# source://graphql//lib/graphql/scalar_type.rb#4
class GraphQL::ScalarType < ::GraphQL::BaseType
  ...
  #
  # source://graphql//lib/graphql/scalar_type.rb#16
  def initialize; end

  # @api deprecated
  #
  # source://graphql//lib/graphql/scalar_type.rb#21
  def coerce=(proc); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/scalar_type.rb#26
  def coerce_input=(coerce_input_fn); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/scalar_type.rb#32
  def coerce_result(value, ctx = T.unsafe(nil)); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/scalar_type.rb#40
  def coerce_result=(coerce_result_fn); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/scalar_type.rb#46
  def kind; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/scalar_type.rb#56
  def coerce_non_null_input(value, ctx); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/scalar_type.rb#52
  def ensure_two_arg(callable, method_name); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/scalar_type.rb#60
  def raw_coercion_input(value); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/scalar_type.rb#70
  def validate_non_null_input(value, ctx); end
end

# @api deprecated
#
# source://graphql//lib/graphql/scalar_type.rb#10
module GraphQL::ScalarType::NoOpCoerce
  class << self
    # @api deprecated
    #
    # source://graphql//lib/graphql/scalar_type.rb#11
...
class GraphQL::Schema
  ...
  #
  # source://graphql//lib/graphql/schema.rb#267
  def initialize; end
  ...
  # source://graphql//lib/graphql/schema.rb#1809
  ...
  #
  # source://graphql//lib/graphql/schema.rb#224
  ...
  #
  # source://graphql//lib/graphql/schema.rb#231
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/schema.rb#247
  def disable_type_introspection_entry_point?; end
  ...
  # @return [void]
  #
  # source://graphql//lib/graphql/schema.rb#383
  ...
  #
  # source://graphql//lib/graphql/schema.rb#306
  def interpreter?; end
  ...
  #
  # source://graphql//lib/graphql/schema.rb#220
  def middleware; end
  ...
  # @see [GraphQL::Schema::Warden] Restricted access to members of a schema
  #
  # source://graphql//lib/graphql/schema.rb#541
  ...
  # source://graphql//lib/graphql/schema.rb#344
  ...
  #
  # source://graphql//lib/graphql/schema.rb#814
  ...
  #
  # source://graphql//lib/graphql/schema.rb#434
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/schema.rb#724
  ...
  #
  # source://graphql//lib/graphql/schema.rb#1824
  def rescue_middleware; end

  # @return [Boolean]
  #
  # source://graphql//lib/graphql/schema.rb#1818
  def rescues?; end
  ...
  # source://graphql//lib/graphql/schema.rb#1830
  def rebuild_artifacts; end

  # source://graphql//lib/graphql/schema.rb#1852
  def with_definition_error_check; end

  class << self
    # @return [Boolean]
    #
    # source://graphql//lib/graphql/schema.rb#1484
    ...
    # @param value the value to set the attribute analysis_engine to.
    #
    # source://graphql//lib/graphql/schema.rb#1309
    def analysis_engine=(_arg0); end
    ...
    #
    # source://graphql//lib/graphql/schema.rb#1014
    def connections; end
    ...
    #
    # source://graphql//lib/graphql/schema.rb#252
    ...
    # source://graphql//lib/graphql/schema.rb#1236
    ...
    # @return void
    #
    # source://graphql//lib/graphql/schema.rb#1585
    ...
    # @return [Boolean]
    #
    # source://graphql//lib/graphql/schema.rb#1383
    def disable_type_introspection_entry_point?; end
    ...
    #
    # source://graphql//lib/graphql/schema.rb#1335
    def error_bubbling=(_arg0); end
    ...
    # @see {Query#initialize} for arguments.
    #
    # source://graphql//lib/graphql/schema.rb#1645
    def execute(query_str = T.unsafe(nil), **kwargs); end
    ...
    #
    # source://graphql//lib/graphql/schema.rb#1496
    def inaccessible_fields(error); end

    # source://graphql//lib/graphql/schema.rb#1464
    def inherited(child_class); end

    # source://graphql//lib/graphql/schema.rb#1558
    ...
    # source://graphql//lib/graphql/schema.rb#1554
    ...
    # @param value the value to set the attribute max_complexity to.
    #
    # source://graphql//lib/graphql/schema.rb#1297
    def max_complexity=(_arg0); end

    # source://graphql//lib/graphql/schema.rb#1339
    ...
    # source://graphql//lib/graphql/schema.rb#1616
    ...
    # @see {Execution::Multiplex#run_queries} for multiplex keyword arguments
    #
    # source://graphql//lib/graphql/schema.rb#1682
    def multiplex(queries, **kwargs); end

    # source://graphql//lib/graphql/schema.rb#1626
    ...
    # @return void
    #
    # source://graphql//lib/graphql/schema.rb#1545
    ...
    # source://graphql//lib/graphql/schema.rb#1605
    ...
    # source://graphql//lib/graphql/schema.rb#1455
    ...
    # source://graphql//lib/graphql/schema/member/accepts_definition.rb#119
    def to_graphql; end
    ...
    # source://graphql//lib/graphql/schema.rb#1535
    ...
    #
    # source://graphql//lib/graphql/schema.rb#1515
    ...
    # @return [Boolean]
    #
    # source://graphql//lib/graphql/schema.rb#1480
...
class GraphQL::Schema::Addition
  ...
  # source://graphql//lib/graphql/schema/addition.rb#36
  def add_directives_from(owner); end

  # source://graphql//lib/graphql/schema/addition.rb#133
  ...
  #
  # source://graphql//lib/graphql/schema/addition.rb#32
  ...
  # source://graphql//lib/graphql/schema/addition.rb#78
...
class GraphQL::Schema::Argument
  ...
  # @return [Argument] a new instance of Argument
  #
  # source://graphql//lib/graphql/schema/member/accepts_definition.rb#132
  ...
  #
  # source://graphql//lib/graphql/schema/argument.rb#90
  def default_value; end

  # @return [Boolean] True if this argument has a default value
  #
  # source://graphql//lib/graphql/schema/argument.rb#93
  def default_value?; end

  # @return [String] Deprecation reason for this argument
  #
  # source://graphql//lib/graphql/schema/argument.rb#109
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/argument.rb#213
  ...
  # source://graphql//lib/graphql/schema/argument.rb#192
  def type; end

  # source://graphql//lib/graphql/schema/argument.rb#182
  def type=(new_type); end

  # @api private
  #
  # source://graphql//lib/graphql/schema/argument.rb#299
  ...
  # source://graphql//lib/graphql/schema/argument.rb#333
  def validate_deprecated_or_optional(null:, deprecation_reason:); end

  # source://graphql//lib/graphql/schema/argument.rb#321
  def validate_input_type(input_type); end
end

# source://graphql//lib/graphql/schema/argument.rb#312
...
module GraphQL::Schema::BuildFromDefinition
  class << self
    ...
    #
    # source://graphql//lib/graphql/schema/build_from_definition.rb#14
    def from_definition(definition_string, parser: T.unsafe(nil), **kwargs); end

    # source://graphql//lib/graphql/schema/build_from_definition.rb#18
    def from_definition_path(definition_path, parser: T.unsafe(nil), **kwargs); end

    # source://graphql//lib/graphql/schema/build_from_definition.rb#22
...
# @api private
#
# source://graphql//lib/graphql/schema/build_from_definition.rb#28
module GraphQL::Schema::BuildFromDefinition::Builder
  extend ::GraphQL::Schema::BuildFromDefinition::Builder

  # @api private
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#228
  def args_to_kwargs(arg_owner, node); end

  # @api private
  # @raise [InvalidDocumentError]
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#31
  def build(document, default_resolve:, relay:, using: T.unsafe(nil)); end

  # @api private
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#355
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#172
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#246
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#327
  def build_input_object_type(input_object_type_definition, type_resolver); end

  # @api private
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#391
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#275
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/build_from_definition.rb#210
...
# @api private
#
# source://graphql//lib/graphql/schema/build_from_definition.rb#168
...
#
# source://graphql//lib/graphql/schema/catchall_middleware.rb#23
module GraphQL::Schema::CatchallMiddleware
  class << self
    ...
    #
    # source://graphql//lib/graphql/schema/catchall_middleware.rb#28
    def call(parent_type, parent_object, field_definition, field_args, query_context); end
  end
end

# source://graphql//lib/graphql/schema/catchall_middleware.rb#24
GraphQL::Schema::CatchallMiddleware::MESSAGE = T.let(T.unsafe(nil), String)

# source://graphql//lib/graphql/schema.rb#1849
...
# source://graphql//lib/graphql/schema/default_parse_error.rb#4
module GraphQL::Schema::DefaultParseError
  class << self
    # source://graphql//lib/graphql/schema/default_parse_error.rb#5
    def call(parse_error, ctx); end
  end
end

# source://graphql//lib/graphql/schema/default_type_error.rb#4
module GraphQL::Schema::DefaultTypeError
  class << self
    # source://graphql//lib/graphql/schema/default_type_error.rb#5
...
class GraphQL::Schema::Directive < ::GraphQL::Schema::Member
  ...
  # @return [Directive] a new instance of Directive
  #
  # source://graphql//lib/graphql/schema/directive.rb#108
  def initialize(owner, **arguments); end

  # @return [GraphQL::Interpreter::Arguments]
  #
  # source://graphql//lib/graphql/schema/directive.rb#106
  def arguments; end
  ...
  class << self
    # source://graphql//lib/graphql/schema/directive.rb#42
    def default_directive(new_default_directive = T.unsafe(nil)); end

    # @return [Boolean]
    #
    # source://graphql//lib/graphql/schema/directive.rb#52
    def default_directive?; end

    # Return a name based on the class name,
    # but downcase the first letter.
    #
    # source://graphql//lib/graphql/schema/directive.rb#21
    ...
    # source://graphql//lib/graphql/schema/directive.rb#29
    ...
    # @return [Boolean]
    #
    # source://graphql//lib/graphql/schema/directive.rb#97
    def on_operation?; end

    # source://graphql//lib/graphql/schema/directive.rb#15
    def path; end
    ...
    # @return [Boolean]
    #
    # source://graphql//lib/graphql/schema/directive.rb#80
    def static_include?(_arguments, _context); end

    # source://graphql//lib/graphql/schema/directive.rb#56
    def to_graphql; end
  end
end
...
class GraphQL::Schema::Enum < ::GraphQL::Schema::Member
  ...
  class << self
    # source://graphql//lib/graphql/schema/enum.rb#116
    def coerce_input(value_name, ctx); end

    # source://graphql//lib/graphql/schema/enum.rb#105
    def coerce_result(value, ctx); end

    # @return [Class] for handling `value(...)` inputs and building `GraphQL::Enum::EnumValue`s out of them
    #
    # source://graphql//lib/graphql/schema/enum.rb#78
    ...
    # source://graphql//lib/graphql/schema/enum.rb#88
    def kind; end
    ...
    # source://graphql//lib/graphql/schema/enum.rb#92
    def validate_non_null_input(value_name, ctx); end
    ...
    #
    # source://graphql//lib/graphql/schema/enum.rb#46
    def value(*args, **kwargs, &block); end

    # @return [Hash<String => GraphQL::Schema::Enum::Value>] Possible values of this enum, keyed by name
    #
    # source://graphql//lib/graphql/schema/enum.rb#57
    def values; end

    private

    # source://graphql//lib/graphql/schema/enum.rb#137
    def own_values; end
  end
end
...
class GraphQL::Schema::Enum::UnresolvedValueError < ::GraphQL::EnumType::UnresolvedValueError
  ...
  #
  # source://graphql//lib/graphql/schema/enum.rb#27
...
class GraphQL::Schema::EnumValue < ::GraphQL::Schema::Member
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/schema/enum_value.rb#89
  def accessible?(_ctx); end

  # @return [Boolean]
  #
  # source://graphql//lib/graphql/schema/enum_value.rb#90
  ...
  #
  # source://graphql//lib/graphql/schema/enum_value.rb#39
  def owner; end
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/schema/enum_value.rb#88
...
class GraphQL::Schema::Field
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/schema/field.rb#538
  def accessible?(context); end
  ...
  #
  # source://graphql//lib/graphql/schema/field.rb#329
  ...
  #
  # source://graphql//lib/graphql/schema/field.rb#131
  def connection?; end

  # @param text [String]
  # @return [String]
  #
  # source://graphql//lib/graphql/schema/field.rb#335
  def description(text = T.unsafe(nil)); end
  ...
  #
  # source://graphql//lib/graphql/schema/field.rb#389
  ...
  #
  # source://graphql//lib/graphql/schema/field.rb#358
  ...
  #
  # source://graphql//lib/graphql/schema/field.rb#432
  def has_max_page_size?; end

  # source://graphql//lib/graphql/schema/field.rb#63
  def inspect; end
  ...
  #
  # source://graphql//lib/graphql/schema/field.rb#54
  def mutation; end
  ...
  #
  # source://graphql//lib/graphql/schema/field.rb#51
  def original_name; end

  # @return [Class] The thing this field was defined on (type, mutation, resolver)
  #
  # source://graphql//lib/graphql/schema/field.rb#39
  def owner; end
  ...
  #
  # source://graphql//lib/graphql/schema/field.rb#42
  def owner_type; end
  ...
  # @param ctx [GraphQL::Query::Context]
  #
  # source://graphql//lib/graphql/schema/field.rb#597
  ...
  #
  # source://graphql//lib/graphql/schema/field.rb#149
  def scoped?; end

  # @return [String, nil]
  #
  # source://graphql//lib/graphql/schema/field.rb#73
  def subscription_scope; end
  ...
  # source://graphql//lib/graphql/schema/field.rb#515
  def type; end
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/schema/field.rb#530
  def visible?(context); end
  ...
  # source://graphql//lib/graphql/schema/field.rb#777
  ...
  #
  # source://graphql//lib/graphql/schema/field.rb#748
  ...
  class << self
    ...
    #
    # source://graphql//lib/graphql/schema/field.rb#166
...
class GraphQL::Schema::FieldExtension
  ...
  #
  # source://graphql//lib/graphql/schema/field_extension.rb#22
  ...
  #
  # source://graphql//lib/graphql/schema/field_extension.rb#64
  def after_resolve(object:, arguments:, context:, value:, memo:); end
  ...
  # @return [void]
  #
  # source://graphql//lib/graphql/schema/field_extension.rb#32
  def apply; end
  ...
  #
  # source://graphql//lib/graphql/schema/field_extension.rb#49
  def resolve(object:, arguments:, context:); end
end

# source://graphql//lib/graphql/schema/find_inherited_value.rb#3
module GraphQL::Schema::FindInheritedValue
  include ::GraphQL::Schema::FindInheritedValue::EmptyObjects

  private

  # source://graphql//lib/graphql/schema/find_inherited_value.rb#19
  ...
  class << self
    ...
    # @private
    #
    # source://graphql//lib/graphql/schema/find_inherited_value.rb#13
...
class GraphQL::Schema::InputObject < ::GraphQL::Schema::Member
  ...
  #
  # source://graphql//lib/graphql/schema/input_object.rb#17
  def arguments; end
  ...
  # source://graphql//lib/graphql/schema/input_object.rb#65
  def to_h; end

  # source://graphql//lib/graphql/schema/input_object.rb#69
  def to_hash; end
  ...
  class << self
    # source://graphql//lib/graphql/schema/input_object.rb#127
    def argument(*args, **kwargs, &block); end

    # @return [Class<GraphQL::Arguments>]
    #
    # source://graphql//lib/graphql/schema/input_object.rb#125
    def arguments_class; end
    ...
    # source://graphql//lib/graphql/schema/input_object.rb#155
    def kind; end

    # source://graphql//lib/graphql/schema/member/accepts_definition.rb#119
    def to_graphql; end

    # source://graphql//lib/graphql/schema/input_object.rb#162
    def validate_non_null_input(input, ctx); end
  end
end
...
module GraphQL::Schema::Interface
  ...
  # source://graphql//lib/graphql/schema/interface.rb#142
  def unwrap; end
end
...
module GraphQL::Schema::Interface::DefinitionMethods
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/schema/interface.rb#33
  def accessible?(context); end
  ...
  #
  # source://graphql//lib/graphql/schema/interface.rb#51
  def included(child_class); end

  # source://graphql//lib/graphql/schema/interface.rb#122
  def kind; end

  # source://graphql//lib/graphql/schema/interface.rb#94
  def orphan_types(*types); end

  # source://graphql//lib/graphql/schema/member/accepts_definition.rb#119
  def to_graphql; end

  # source://graphql//lib/graphql/schema/interface.rb#42
  def type_membership_class(membership_class = T.unsafe(nil)); end

  # @return [Boolean]
  # @see {Schema::Warden} hides interfaces without visible implementations
  #
  # source://graphql//lib/graphql/schema/interface.rb#28
  def visible?(context); end

  protected

  # source://graphql//lib/graphql/schema/interface.rb#132
  def interfaces; end

  # source://graphql//lib/graphql/schema/interface.rb#128
...
class GraphQL::Schema::IntrospectionSystem
  ...
  #
  # source://graphql//lib/graphql/schema/introspection_system.rb#135
...
# source://graphql//lib/graphql/schema/introspection_system.rb#151
class GraphQL::Schema::IntrospectionSystem::PerFieldProxyResolve
  ...
  # source://graphql//lib/graphql/schema/introspection_system.rb#157
  def call(obj, args, ctx); end
end
...
module GraphQL::Schema::LazyHandlingMethods
  ...
  #
  # source://graphql//lib/graphql/schema.rb#148
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema.rb#108
  ...
  #
  # source://graphql//lib/graphql/schema.rb#124
...
class GraphQL::Schema::List < ::GraphQL::Schema::Wrapper
  ...
  #
  # source://graphql//lib/graphql/schema/list.rb#16
  def kind; end
  ...
  # source://graphql//lib/graphql/schema/list.rb#11
  def to_graphql; end
  ...
  # source://graphql//lib/graphql/schema/list.rb#65
  def ensure_array(value); end
end
...
module GraphQL::Schema::Loader
  ...
  class << self
    # source://graphql//lib/graphql/schema/loader.rb#195
    def build_arguments(arg_owner, args, type_resolver); end

    # source://graphql//lib/graphql/schema/loader.rb#169
    def build_fields(type_defn, fields, type_resolver); end

    private

    # source://graphql//lib/graphql/schema/loader.rb#157
    def define_directive(directive, type_resolver); end

    # source://graphql//lib/graphql/schema/loader.rb#97
    def define_type(type, type_resolver); end

    # source://graphql//lib/graphql/schema/loader.rb#76
    def extract_default_value(default_value_str, input_value_ast); end

    # source://graphql//lib/graphql/schema/loader.rb#57
    def resolve_type(types, type); end
  end
end

# source://graphql//lib/graphql/schema/loader.rb#52
...
# @api private
#
# source://graphql//lib/graphql/schema/member/accepts_definition.rb#5
...
#
# source://graphql//lib/graphql/schema/member/accepts_definition.rb#38
module GraphQL::Schema::Member::AcceptsDefinition
  ...
  class << self
    # @private
    #
    # source://graphql//lib/graphql/schema/member/accepts_definition.rb#45
    def extended(child); end

    # @private
    #
    # source://graphql//lib/graphql/schema/member/accepts_definition.rb#39
    def included(child); end
  end
end

# source://graphql//lib/graphql/schema/member/accepts_definition.rb#62
module GraphQL::Schema::Member::AcceptsDefinition::AcceptsDefinitionDefinitionMethods
  # source://graphql//lib/graphql/schema/member/accepts_definition.rb#63
  def accepts_definition(name); end

  # source://graphql//lib/graphql/schema/member/accepts_definition.rb#95
  def accepts_definition_methods; end

  # source://graphql//lib/graphql/schema/member/accepts_definition.rb#113
  def own_accepts_definition_methods; end
end

# source://graphql//lib/graphql/schema/member/accepts_definition.rb#131
module GraphQL::Schema::Member::AcceptsDefinition::InitializeExtension
  # source://graphql//lib/graphql/schema/member/accepts_definition.rb#132
  def initialize(*args, **kwargs, &block); end

  # source://graphql//lib/graphql/schema/member/accepts_definition.rb#145
  def accepts_definition_methods; end
end

# source://graphql//lib/graphql/schema/member/accepts_definition.rb#118
...
module GraphQL::Schema::Member::BuildType
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/member/build_type.rb#126
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/member/build_type.rb#138
  ...
  # @return [GraphQL::BaseType]
  #
  # source://graphql//lib/graphql/schema/member/build_type.rb#16
  def parse_type(type_expr, null:); end

  # @api private
  #
  # source://graphql//lib/graphql/schema/member/build_type.rb#105
  def to_type_name(something); end

  # @api private
  #
  # source://graphql//lib/graphql/schema/member/build_type.rb#169
...
# @api private
#
# source://graphql//lib/graphql/schema/member/build_type.rb#11
...
#
# source://graphql//lib/graphql/schema/member/cached_graphql_definition.rb#10
module GraphQL::Schema::Member::CachedGraphQLDefinition
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/member/cached_graphql_definition.rb#14
  def graphql_definition; end
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/member/cached_graphql_definition.rb#19
  def type_class; end
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/member/cached_graphql_definition.rb#24
...
module GraphQL::Schema::Member::HasArguments
  ...
  #
  # source://graphql//lib/graphql/schema/member/has_arguments.rb#45
  ...
  #
  # source://graphql//lib/graphql/schema/member/has_arguments.rb#52
  def arguments; end
  ...
  # source://graphql//lib/graphql/schema/member/has_arguments.rb#238
  def own_arguments; end
...
# source://graphql//lib/graphql/schema/member/has_arguments.rb#165
module GraphQL::Schema::Member::HasArguments::ArgumentClassAccessor
  # source://graphql//lib/graphql/schema/member/has_arguments.rb#166
  def argument_class(new_arg_class = T.unsafe(nil)); end
end

# source://graphql//lib/graphql/schema/member/has_arguments.rb#177
module GraphQL::Schema::Member::HasArguments::ArgumentObjectLoader
  # source://graphql//lib/graphql/schema/member/has_arguments.rb#189
  ...
  #
  # source://graphql//lib/graphql/schema/member/has_arguments.rb#185
  def object_from_id(type, id, context); end
end

# source://graphql//lib/graphql/schema/member/has_arguments.rb#237
...
module GraphQL::Schema::Member::HasFields
  ...
  # source://graphql//lib/graphql/schema/member/has_fields.rb#29
  def get_field(field_name); end

  # source://graphql//lib/graphql/schema/member/has_fields.rb#82
  ...
  #
  # source://graphql//lib/graphql/schema/member/has_fields.rb#91
  def own_fields; end
...
# @api private
#
# source://graphql//lib/graphql/schema/member/has_fields.rb#50
...
# @api private
#
# source://graphql//lib/graphql/schema/member/has_fields.rb#45
...
# source://graphql//lib/graphql/schema/member/instrumentation.rb#6
module GraphQL::Schema::Member::Instrumentation
  private

  # source://graphql//lib/graphql/schema/member/instrumentation.rb#41
  def after_query(_query); end

  # source://graphql//lib/graphql/schema/member/instrumentation.rb#48
  def apply_proxy(field); end

  # source://graphql//lib/graphql/schema/member/instrumentation.rb#19
  def before_query(query); end

  # source://graphql//lib/graphql/schema/member/instrumentation.rb#8
  def instrument(type, field); end

  # source://graphql//lib/graphql/schema/member/instrumentation.rb#60
...
# source://graphql//lib/graphql/schema/member/instrumentation.rb#71
class GraphQL::Schema::Member::Instrumentation::ProxiedResolve
  # @return [ProxiedResolve] a new instance of ProxiedResolve
  #
  # source://graphql//lib/graphql/schema/member/instrumentation.rb#72
  def initialize(inner_resolve:, list_depth:, inner_return_type:); end

  # source://graphql//lib/graphql/schema/member/instrumentation.rb#78
  def call(obj, args, ctx); end
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/schema/member/instrumentation.rb#90
  def execution_errors?(result); end

  # source://graphql//lib/graphql/schema/member/instrumentation.rb#95
...
module GraphQL::Schema::Member::RelayShortcuts
  # source://graphql//lib/graphql/schema/member/relay_shortcuts.rb#34
  def connection_type; end

  # source://graphql//lib/graphql/schema/member/relay_shortcuts.rb#15
...
#
# source://graphql//lib/graphql/schema/middleware_chain.rb#7
class GraphQL::Schema::MiddlewareChain
  extend ::Forwardable

  # @return [MiddlewareChain] a new instance of MiddlewareChain
  #
  # source://graphql//lib/graphql/schema/middleware_chain.rb#13
  def initialize(steps: T.unsafe(nil), final_step: T.unsafe(nil)); end

  # source://graphql//lib/graphql/schema/middleware_chain.rb#25
  def <<(callable); end

  # source://graphql//lib/graphql/schema/middleware_chain.rb#33
  def ==(other); end

  # source://forwardable/1.3.2/forwardable.rb#229
  def [](*args, **_arg1, &block); end

  # source://graphql//lib/graphql/schema/middleware_chain.rb#41
  ...
  #
  # source://graphql//lib/graphql/schema/middleware_chain.rb#11
  def final_step; end
  ...
  # source://graphql//lib/graphql/schema/middleware_chain.rb#37
  def invoke(arguments); end

  # source://graphql//lib/graphql/schema/middleware_chain.rb#29
  ...
  # source://graphql//lib/graphql/schema/middleware_chain.rb#55
  def add_middleware(callable); end

  # source://graphql//lib/graphql/schema/middleware_chain.rb#18
  def initialize_copy(other); end

  # source://graphql//lib/graphql/schema/middleware_chain.rb#47
  def invoke_core(index, arguments); end

  # source://graphql//lib/graphql/schema/middleware_chain.rb#72
  def wrap(callable); end
end

# TODO: Remove this code once deprecated middleware becomes unsupported
#
# source://graphql//lib/graphql/schema/middleware_chain.rb#61
class GraphQL::Schema::MiddlewareChain::MiddlewareWrapper
  # @return [MiddlewareWrapper] a new instance of MiddlewareWrapper
  #
  # source://graphql//lib/graphql/schema/middleware_chain.rb#63
  def initialize(callable); end

  # source://graphql//lib/graphql/schema/middleware_chain.rb#67
  def call(*args, &next_middleware); end

  # Returns the value of attribute callable.
  #
  # source://graphql//lib/graphql/schema/middleware_chain.rb#62
  def callable; end
end
...
class GraphQL::Schema::Mutation < ::GraphQL::Schema::Resolver
  ...
  class << self
    ...
    #
    # source://graphql//lib/graphql/schema/mutation.rb#67
    def field(*args, **kwargs, &block); end

    # @return [Boolean]
    #
    # source://graphql//lib/graphql/schema/mutation.rb#75
    def visible?(context); end

    private

    # source://graphql//lib/graphql/schema/mutation.rb#81
    def conflict_field_name_warning(field_defn); end

    # Override this to attach self as `mutation`
    #
    # source://graphql//lib/graphql/schema/mutation.rb#86
...
class GraphQL::Schema::NonNull < ::GraphQL::Schema::Wrapper
  ...
  # source://graphql//lib/graphql/schema/non_null.rb#53
  def coerce_input(value, ctx); end
  ...
  #
  # source://graphql//lib/graphql/schema/non_null.rb#16
  def kind; end
  ...
  # @return [true]
  #
  # source://graphql//lib/graphql/schema/non_null.rb#21
  def non_null?; end

  # source://graphql//lib/graphql/schema/non_null.rb#11
  def to_graphql; end

  # source://graphql//lib/graphql/schema/non_null.rb#30
  def to_type_signature; end

  # source://graphql//lib/graphql/schema/non_null.rb#38
  def validate_input(value, ctx); end
end
...
class GraphQL::Schema::Object < ::GraphQL::Schema::Member
  ...
  class << self
    ...
    #
    # source://graphql//lib/graphql/schema/object.rb#177
    def fields; end

    # source://graphql//lib/graphql/schema/object.rb#106
    ...
    # source://graphql//lib/graphql/schema/object.rb#151
    def interface_type_memberships; end

    # param context [Query::Context] If omitted, skip filtering.
    #
    # source://graphql//lib/graphql/schema/object.rb#156
    def interfaces(context = T.unsafe(nil)); end

    # source://graphql//lib/graphql/schema/object.rb#211
    def kind; end

    # source://graphql//lib/graphql/schema/object.rb#147
...
#
# source://graphql//lib/graphql/schema/possible_types.rb#14
class GraphQL::Schema::PossibleTypes
  # @return [PossibleTypes] a new instance of PossibleTypes
  #
  # source://graphql//lib/graphql/schema/possible_types.rb#15
  def initialize(schema); end

  # source://graphql//lib/graphql/schema/possible_types.rb#39
  def interface_implementers(ctx, type_defn); end

  # source://graphql//lib/graphql/schema/possible_types.rb#24
...
class GraphQL::Schema::RelayClassicMutation < ::GraphQL::Schema::Mutation
  ...
  class << self
    ...
    #
    # source://graphql//lib/graphql/schema/relay_classic_mutation.rb#104
    ...
    #
    # source://graphql//lib/graphql/schema/relay_classic_mutation.rb#96
    ...
    #
    # source://graphql//lib/graphql/schema/relay_classic_mutation.rb#117
...
#
# source://graphql//lib/graphql/schema/rescue_middleware.rb#8
class GraphQL::Schema::RescueMiddleware
  # @return [RescueMiddleware] a new instance of RescueMiddleware
  #
  # source://graphql//lib/graphql/schema/rescue_middleware.rb#11
  def initialize; end

  # Implement the requirement for {GraphQL::Schema::MiddlewareChain}
  #
  # source://graphql//lib/graphql/schema/rescue_middleware.rb#33
  def call(*args); end
  ...
  #
  # source://graphql//lib/graphql/schema/rescue_middleware.rb#28
  ...
  #
  # source://graphql//lib/graphql/schema/rescue_middleware.rb#22
  def rescue_from(*error_classes, &block); end

  # @return [Hash] `{class => proc}` pairs for handling errors
  #
  # source://graphql//lib/graphql/schema/rescue_middleware.rb#10
  def rescue_table; end

  private

  # source://graphql//lib/graphql/schema/rescue_middleware.rb#43
...
class GraphQL::Schema::Resolver
  ...
  # source://graphql//lib/graphql/schema/resolver.rb#61
  def arguments; end
  ...
  #
  # source://graphql//lib/graphql/schema/resolver.rb#148
  ...
  # @return [Boolean, early_return_data] If `false`, execution will stop (and `early_return_data` will be returned instead, if present.)
  #
  # source://graphql//lib/graphql/schema/resolver.rb#137
  def ready?(**args); end
  ...
  #
  # source://graphql//lib/graphql/schema/resolver.rb#123
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/resolver.rb#69
  ...
  class << self
    ...
    #
    # source://graphql//lib/graphql/schema/resolver.rb#334
    def argument(*args, **kwargs, &block); end
    ...
    # source://graphql//lib/graphql/schema/resolver.rb#266
    ...
    #
    # source://graphql//lib/graphql/schema/resolver.rb#239
    ...
    # source://graphql//lib/graphql/schema/resolver.rb#408
...
module GraphQL::Schema::Resolver::HasPayloadType
  # source://graphql//lib/graphql/schema/resolver/has_payload_type.rb#26
  ...
  # @return [Class]
  #
  # source://graphql//lib/graphql/schema/resolver/has_payload_type.rb#39
  ...
  #
  # source://graphql//lib/graphql/schema/resolver/has_payload_type.rb#54
  def generate_payload_type; end
end

# source://graphql//lib/graphql/schema/resolver/has_payload_type.rb#47
...
class GraphQL::Schema::Scalar < ::GraphQL::Schema::Member
  ...
  class << self
    # source://graphql//lib/graphql/schema/scalar.rb#9
    def coerce_input(val, ctx); end

    # source://graphql//lib/graphql/schema/scalar.rb#13
    def coerce_result(val, ctx); end

    # source://graphql//lib/graphql/schema/scalar.rb#33
    def default_scalar(is_default = T.unsafe(nil)); end

    # @return [Boolean]
    #
    # source://graphql//lib/graphql/schema/scalar.rb#40
    def default_scalar?; end

    # source://graphql//lib/graphql/schema/scalar.rb#29
    def kind; end

    # source://graphql//lib/graphql/schema/member/accepts_definition.rb#119
    def to_graphql; end

    # source://graphql//lib/graphql/schema/scalar.rb#44
    def validate_non_null_input(value, ctx); end
  end
end
...
class GraphQL::Schema::Subscription < ::GraphQL::Schema::Resolver
  ...
  #
  # source://graphql//lib/graphql/schema/subscription.rb#91
  def load_application_object_failed(err); end
  ...
  #
  # source://graphql//lib/graphql/schema/subscription.rb#71
  ...
  #
  # source://graphql//lib/graphql/schema/subscription.rb#66
  def subscribe(args = T.unsafe(nil)); end

  # Call this to halt execution and remove this subscription from the system
  #
  # source://graphql//lib/graphql/schema/subscription.rb#99
  def unsubscribe; end
  ...
  #
  # source://graphql//lib/graphql/schema/subscription.rb#84
  def update(args = T.unsafe(nil)); end

  class << self
    # Overriding Resolver#field_options to include subscription_scope
    #
    # source://graphql//lib/graphql/schema/subscription.rb#120
    def field_options; end
...
# @see Schema::Timeout
#
# source://graphql//lib/graphql/schema/timeout_middleware.rb#28
class GraphQL::Schema::TimeoutMiddleware
  # @api deprecated
  # @param max_seconds [Numeric] how many seconds the query should be allowed to resolve new fields
  # @return [TimeoutMiddleware] a new instance of TimeoutMiddleware
  #
  # source://graphql//lib/graphql/schema/timeout_middleware.rb#30
  def initialize(max_seconds:, context_key: T.unsafe(nil), &block); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/schema/timeout_middleware.rb#38
  def call(parent_type, parent_object, field_definition, field_args, query_context); end
  ...
  #
  # source://graphql//lib/graphql/schema/timeout_middleware.rb#52
...
# @api deprecated
#
# source://graphql//lib/graphql/schema/timeout_middleware.rb#81
class GraphQL::Schema::TimeoutMiddleware::TimeoutError < ::GraphQL::ExecutionError
  # @api deprecated
  # @return [TimeoutError] a new instance of TimeoutError
  #
  # source://graphql//lib/graphql/schema/timeout_middleware.rb#82
...
# @api deprecated
#
# source://graphql//lib/graphql/schema/timeout_middleware.rb#65
class GraphQL::Schema::TimeoutMiddleware::TimeoutQueryProxy < ::SimpleDelegator
  ...
  #
  # source://graphql//lib/graphql/schema/timeout_middleware.rb#66
  def initialize(query, ctx); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/schema/timeout_middleware.rb#71
  def context; end
end
...
class GraphQL::Schema::Traversal
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/traversal.rb#57
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/traversal.rb#96
  def rewrap_resolved_type(late_bound_type, resolved_inner_type); end

  # @api private
  #
  # source://graphql//lib/graphql/schema/traversal.rb#220
  def validate_type(member, context_description); end

  # @api private
  #
  # source://graphql//lib/graphql/schema/traversal.rb#109
  def visit(schema, member, context_description); end

  # @api private
  #
  # source://graphql//lib/graphql/schema/traversal.rb#193
  def visit_field_on_type(schema, type_defn, field_defn, dynamic_field: T.unsafe(nil)); end

  # @api private
  #
  # source://graphql//lib/graphql/schema/traversal.rb#187
...
class GraphQL::Schema::TypeMembership
  ...
  #
  # source://graphql//lib/graphql/schema/type_membership.rb#29
  def visible?(_ctx); end
end
...
class GraphQL::Schema::Union < ::GraphQL::Schema::Member
  ...
  class << self
    ...
    # @api private
    #
    # source://graphql//lib/graphql/schema/union.rb#64
    def assign_type_membership_object_type(object_type); end

    # @private
    #
    # source://graphql//lib/graphql/schema/union.rb#9
    def inherited(child_class); end

    # source://graphql//lib/graphql/schema/union.rb#52
    def kind; end

    # source://graphql//lib/graphql/schema/union.rb#14
    def possible_types(*types, context: T.unsafe(nil), **options); end

    # source://graphql//lib/graphql/schema/member/accepts_definition.rb#119
    def to_graphql; end

    # source://graphql//lib/graphql/schema/union.rb#44
    def type_membership_class(membership_class = T.unsafe(nil)); end

    # source://graphql//lib/graphql/schema/union.rb#56
    def type_memberships; end

    private

    # source://graphql//lib/graphql/schema/union.rb#81
...
#
# source://graphql//lib/graphql/schema/validation.rb#11
class GraphQL::Schema::Validation
  class << self
    ...
    #
    # source://graphql//lib/graphql/schema/validation.rb#16
...
#
# source://graphql//lib/graphql/schema/validation.rb#261
GraphQL::Schema::Validation::RULES = T.let(T.unsafe(nil), Hash)

# source://graphql//lib/graphql/schema/validation.rb#29
module GraphQL::Schema::Validation::Rules
  class << self
    # source://graphql//lib/graphql/schema/validation.rb#94
    ...
    #
    # source://graphql//lib/graphql/schema/validation.rb#33
    ...
    #
    # source://graphql//lib/graphql/schema/validation.rb#66
...
class GraphQL::Schema::Validator
  ...
  #
  # source://graphql//lib/graphql/schema/validator.rb#14
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/validator.rb#30
  ...
  #
  # source://graphql//lib/graphql/schema/validator.rb#50
  ...
  #
  # source://graphql//lib/graphql/schema/validator.rb#24
  ...
  class << self
    ...
    #
    # source://graphql//lib/graphql/schema/validator.rb#96
    ...
    #
    # source://graphql//lib/graphql/schema/validator.rb#61
    ...
    # @return [void]
    #
    # source://graphql//lib/graphql/schema/validator.rb#82
    ...
    # @return [void]
    #
    # source://graphql//lib/graphql/schema/validator.rb#90
    ...
    # @return [void]
    #
    # source://graphql//lib/graphql/schema/validator.rb#118
...
class GraphQL::Schema::Validator::FormatValidator < ::GraphQL::Schema::Validator
  ...
  #
  # source://graphql//lib/graphql/schema/validator/format_validator.rb#28
  def initialize(with: T.unsafe(nil), without: T.unsafe(nil), message: T.unsafe(nil), **default_options); end

  # source://graphql//lib/graphql/schema/validator/format_validator.rb#40
  def validate(_object, _context, value); end
end
...
#
# source://graphql//lib/graphql/schema/validator/numericality_validator.rb#27
class GraphQL::Schema::Validator::NumericalityValidator < ::GraphQL::Schema::Validator
  ...
  #
  # source://graphql//lib/graphql/schema/validator/numericality_validator.rb#28
  ...
  # source://graphql//lib/graphql/schema/validator/numericality_validator.rb#49
  def validate(object, context, value); end
end
...
#   end
#
# source://graphql//lib/graphql/schema/validator/required_validator.rb#33
class GraphQL::Schema::Validator::RequiredValidator < ::GraphQL::Schema::Validator
  ...
  #
  # source://graphql//lib/graphql/schema/validator/required_validator.rb#34
...
class GraphQL::Schema::Validator::ValidationFailedError < ::GraphQL::ExecutionError
  ...
  #
  # source://graphql//lib/graphql/schema/validator.rb#106
  def initialize(errors:); end

  # Returns the value of attribute errors.
  #
  # source://graphql//lib/graphql/schema/validator.rb#104
  def errors; end
end
...
class GraphQL::Schema::Warden
  ...
  #
  # source://graphql//lib/graphql/schema/warden.rb#43
  ...
  #
  # source://graphql//lib/graphql/schema/warden.rb#131
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/warden.rb#269
  def read_through; end

  # @api private
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/schema/warden.rb#241
  def referenced?(type_defn); end

  # @api private
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/schema/warden.rb#235
  ...
  # @api private
  #
  # source://graphql//lib/graphql/schema/warden.rb#184
...
# @api private
#
# source://graphql//lib/graphql/schema/warden.rb#248
...
class GraphQL::Schema::Wrapper
  ...
  #
  # source://graphql//lib/graphql/schema/wrapper.rb#12
  def initialize(of_type); end

  # source://graphql//lib/graphql/schema/wrapper.rb#24
  def ==(other); end

  # @return [Class, Module] The inner type of this wrapping type, the type of which one or more objects may be present.
  #
  # source://graphql//lib/graphql/schema/wrapper.rb#10
  def of_type; end

  # @raise [GraphQL::RequiredImplementationMissingError]
  #
  # source://graphql//lib/graphql/schema/wrapper.rb#16
  def to_graphql; end

  # source://graphql//lib/graphql/schema/wrapper.rb#20
  def unwrap; end
end
...
class GraphQL::StaticValidation::BaseVisitor < ::GraphQL::Language::Visitor
  ...
  #
  # source://graphql//lib/graphql/static_validation/base_visitor.rb#28
  def path; end
  ...
  # source://graphql//lib/graphql/static_validation/base_visitor.rb#207
  ...
  class << self
    ...
    #
    # source://graphql//lib/graphql/static_validation/base_visitor.rb#37
...
module GraphQL::StaticValidation::BaseVisitor::ContextMethods
  # @return [GraphQL::Argument, nil] The most-recently-entered GraphQL::Argument, if currently inside one
  #
  # source://graphql//lib/graphql/static_validation/base_visitor.rb#180
  def argument_definition; end

  # @return [GraphQL::Directive, nil] The most-recently-entered GraphQL::Directive, if currently inside one
  #
  # source://graphql//lib/graphql/static_validation/base_visitor.rb#175
  def directive_definition; end

  # @return [GraphQL::Field, nil] The most-recently-entered GraphQL::Field, if currently inside one
  #
  # source://graphql//lib/graphql/static_validation/base_visitor.rb#170
  def field_definition; end

  # source://graphql//lib/graphql/static_validation/base_visitor.rb#119
  def on_argument(node, parent); end

  # source://graphql//lib/graphql/static_validation/base_visitor.rb#112
  def on_directive(node, parent); end

  # source://graphql//lib/graphql/static_validation/base_visitor.rb#95
  def on_field(node, parent); end

  # source://graphql//lib/graphql/static_validation/base_visitor.rb#81
  def on_fragment_definition(node, parent); end

  # source://graphql//lib/graphql/static_validation/base_visitor.rb#142
  def on_fragment_spread(node, parent); end

  # source://graphql//lib/graphql/static_validation/base_visitor.rb#88
  def on_inline_fragment(node, parent); end
  ...
  # @return [GraphQL::BaseType] The type which the current type came from
  #
  # source://graphql//lib/graphql/static_validation/base_visitor.rb#165
  def parent_type_definition; end

  # @return [GraphQL::BaseType] The current object type
  #
  # source://graphql//lib/graphql/static_validation/base_visitor.rb#160
  def type_definition; end
  ...
  # @yield [node]
  #
  # source://graphql//lib/graphql/static_validation/base_visitor.rb#188
  def on_fragment_with_type(node); end

  # source://graphql//lib/graphql/static_validation/base_visitor.rb#200
  def push_type(t); end
end

# source://graphql//lib/graphql/static_validation/default_visitor.rb#4
...
module GraphQL::StaticValidation::DefinitionDependencies
  ...
  #
  # source://graphql//lib/graphql/static_validation/definition_dependencies.rb#115
...
#
# source://graphql//lib/graphql/static_validation/definition_dependencies.rb#76
class GraphQL::StaticValidation::DefinitionDependencies::DependencyMap
  # @return [DependencyMap] a new instance of DependencyMap
  #
  # source://graphql//lib/graphql/static_validation/definition_dependencies.rb#86
  def initialize; end

  # @return [Array<GraphQL::Language::Nodes::AbstractNode>] dependencies for `definition_node`
  #
  # source://graphql//lib/graphql/static_validation/definition_dependencies.rb#94
  def [](definition_node); end

  # @return [Array<GraphQL::Language::Nodes::FragmentDefinition>]
  #
  # source://graphql//lib/graphql/static_validation/definition_dependencies.rb#78
  def cyclical_definitions; end

  # @return [Hash<Node, Array<GraphQL::Language::Nodes::FragmentSpread>>]
  #
  # source://graphql//lib/graphql/static_validation/definition_dependencies.rb#81
  def unmet_dependencies; end

  # @return [Array<GraphQL::Language::Nodes::FragmentDefinition>]
  #
  # source://graphql//lib/graphql/static_validation/definition_dependencies.rb#84
  def unused_dependencies; end
end

# source://graphql//lib/graphql/static_validation/definition_dependencies.rb#99
class GraphQL::StaticValidation::DefinitionDependencies::NodeWithPath
  extend ::Forwardable

  # @return [NodeWithPath] a new instance of NodeWithPath
  #
  # source://graphql//lib/graphql/static_validation/definition_dependencies.rb#102
...
module GraphQL::StaticValidation::FieldsWillMerge
  # source://graphql//lib/graphql/static_validation/rules/fields_will_merge.rb#16
  def initialize(*_arg0); end

  # source://graphql//lib/graphql/static_validation/rules/fields_will_merge.rb#27
  ...
  # source://graphql//lib/graphql/static_validation/rules/fields_will_merge.rb#364
  def compared_fragments_key(frag1, frag2, exclusive); end

  # source://graphql//lib/graphql/static_validation/rules/fields_will_merge.rb#34
  ...
  # source://graphql//lib/graphql/static_validation/rules/fields_will_merge.rb#185
  def find_conflict(response_key, field1, field2, mutually_exclusive: T.unsafe(nil)); end

  # source://graphql//lib/graphql/static_validation/rules/fields_will_merge.rb#283
  def find_conflicts_between(response_keys, response_keys2, mutually_exclusive:); end

  # source://graphql//lib/graphql/static_validation/rules/fields_will_merge.rb#141
  def find_conflicts_between_fields_and_fragment(fragment_spread, fields, mutually_exclusive:); end

  # source://graphql//lib/graphql/static_validation/rules/fields_will_merge.rb#75
  def find_conflicts_between_fragments(fragment_spread1, fragment_spread2, mutually_exclusive:); end

  # source://graphql//lib/graphql/static_validation/rules/fields_will_merge.rb#226
  def find_conflicts_between_sub_selection_sets(field1, field2, mutually_exclusive:); end

  # source://graphql//lib/graphql/static_validation/rules/fields_will_merge.rb#173
  def find_conflicts_within(response_keys); end

  # source://graphql//lib/graphql/static_validation/rules/fields_will_merge.rb#313
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/static_validation/rules/fields_will_merge.rb#375
  def mutually_exclusive?(parents1, parents2); end

  # @return [Boolean]
  #
  # source://graphql//lib/graphql/static_validation/rules/fields_will_merge.rb#330
  def same_arguments?(field1, field2); end

  # source://graphql//lib/graphql/static_validation/rules/fields_will_merge.rb#345
...
# source://graphql//lib/graphql/static_validation/rules/fields_will_merge.rb#13
...
# source://graphql//lib/graphql/static_validation/rules/fields_will_merge.rb#301
...
class GraphQL::StaticValidation::FieldsWillMergeError < ::GraphQL::StaticValidation::Error
  ...
  # source://graphql//lib/graphql/static_validation/rules/fields_will_merge_error.rb#27
  def code; end
  ...
  # A hash representation of this Message
  #
  # source://graphql//lib/graphql/static_validation/rules/fields_will_merge_error.rb#15
  def to_h; end
end
...
# source://graphql//lib/graphql/static_validation/no_validate_visitor.rb#4
...
class GraphQL::StaticValidation::ValidationContext
  ...
  #
  # source://graphql//lib/graphql/static_validation/validation_context.rb#22
  ...
  # source://graphql//lib/graphql/static_validation/validation_context.rb#34
  ...
  # source://graphql//lib/graphql/static_validation/validation_context.rb#38
...
class GraphQL::StaticValidation::Validator
  ...
  #
  # source://graphql//lib/graphql/static_validation/validator.rb#86
  ...
  # @return [Array<Hash>]
  #
  # source://graphql//lib/graphql/static_validation/validator.rb#28
...
module GraphQL::StaticValidation::VariableUsagesAreAllowed
  ...
  # source://graphql//lib/graphql/static_validation/rules/variable_usages_are_allowed.rb#85
  ...
  #
  # source://graphql//lib/graphql/static_validation/rules/variable_usages_are_allowed.rb#111
  def depth_of_array(array); end

  # source://graphql//lib/graphql/static_validation/rules/variable_usages_are_allowed.rb#127
  def list_dimension(type); end

  # source://graphql//lib/graphql/static_validation/rules/variable_usages_are_allowed.rb#137
  ...
  # source://graphql//lib/graphql/static_validation/rules/variable_usages_are_allowed.rb#96
...
class GraphQL::Subscriptions
  ...
  #
  # source://graphql//lib/graphql/subscriptions.rb#39
  ...
  #
  # source://graphql//lib/graphql/subscriptions.rb#202
  def build_id; end

  # @return [Boolean] Used when fields don't have `broadcastable:` explicitly set
  #
  # source://graphql//lib/graphql/subscriptions.rb#51
  ...
  # @see {#deliver}
  #
  # source://graphql//lib/graphql/subscriptions.rb#141
  ...
  #
  # source://graphql//lib/graphql/subscriptions.rb#99
  ...
  #
  # source://graphql//lib/graphql/subscriptions.rb#171
  ...
  # @return [void]
  #
  # source://graphql//lib/graphql/subscriptions.rb#189
  ...
  class << self
    ...
    #
    # source://graphql//lib/graphql/subscriptions.rb#20
...
class GraphQL::Subscriptions::ActionCableSubscriptions < ::GraphQL::Subscriptions
  ...
  #
  # source://graphql//lib/graphql/subscriptions/action_cable_subscriptions.rb#189
  def delete_subscription(subscription_id); end
  ...
  #
  # source://graphql//lib/graphql/subscriptions/action_cable_subscriptions.rb#104
  def execute_all(event, object); end

  # Return the query from "storage" (in memory)
  #
  # source://graphql//lib/graphql/subscriptions/action_cable_subscriptions.rb#171
  def read_subscription(subscription_id); end
  ...
  #
  # source://graphql//lib/graphql/subscriptions/action_cable_subscriptions.rb#146
  ...
  #
  # source://graphql//lib/graphql/subscriptions/action_cable_subscriptions.rb#121
  def write_subscription(query, events); end

  private

  # source://graphql//lib/graphql/subscriptions/action_cable_subscriptions.rb#212
...
class GraphQL::Subscriptions::Event
  ...
  #
  # source://graphql//lib/graphql/subscriptions/event.rb#55
  def fingerprint; end
  ...
  class << self
    ...
    #
    # source://graphql//lib/graphql/subscriptions/event.rb#32
    def serialize(name, arguments, field, scope:); end

    private

    # source://graphql//lib/graphql/subscriptions/event.rb#101
    def get_arg_definition(arg_owner, arg_name); end

    # source://graphql//lib/graphql/subscriptions/event.rb#72
...
class GraphQL::Subscriptions::Instrumentation
  ...
  #
  # source://graphql//lib/graphql/subscriptions/instrumentation.rb#30
  def after_query(query); end

  # If needed, prepare to gather events which this query subscribes to
  #
  # source://graphql//lib/graphql/subscriptions/instrumentation.rb#23
  def before_query(query); end

  # source://graphql//lib/graphql/subscriptions/instrumentation.rb#12
  def instrument(type, field); end
end

# source://graphql//lib/graphql/subscriptions/instrumentation.rb#39
class GraphQL::Subscriptions::Instrumentation::SubscriptionRegistrationResolve
  ...
  #
  # source://graphql//lib/graphql/subscriptions/instrumentation.rb#40
  def initialize(inner_proc); end

  # Wrap the proc with subscription registration logic
  #
  # source://graphql//lib/graphql/subscriptions/instrumentation.rb#45
  def call(obj, args, ctx); end
end
...
#
# source://graphql//lib/graphql/subscriptions.rb#16
...
module GraphQL::Subscriptions::Serialize
  ...
  class << self
    ...
    #
    # source://graphql//lib/graphql/subscriptions/serialize.rb#105
...
#
# source://graphql//lib/graphql/subscriptions/subscription_root.rb#7
module GraphQL::Subscriptions::SubscriptionRoot
  # @api private
  #
  # source://graphql//lib/graphql/subscriptions/subscription_root.rb#26
  ...
  class << self
    ...
    # @private
    #
    # source://graphql//lib/graphql/subscriptions/subscription_root.rb#8
    def extended(child_cls); end
  end
end
...
# @api private
#
# source://graphql//lib/graphql/subscriptions/subscription_root.rb#36
class GraphQL::Subscriptions::SubscriptionRoot::Extension < ::GraphQL::Schema::FieldExtension
  # @api private
  #
  # source://graphql//lib/graphql/subscriptions/subscription_root.rb#37
  ...
  # @api private
  #
  # source://graphql//lib/graphql/subscriptions/subscription_root.rb#68
...
# @api private
#
# source://graphql//lib/graphql/subscriptions/subscription_root.rb#16
module GraphQL::Subscriptions::SubscriptionRoot::InstanceMethods
  # @api private
  #
  # source://graphql//lib/graphql/subscriptions/subscription_root.rb#17
...
#
# source://graphql//lib/graphql/tracing/active_support_notifications_tracing.rb#4
...
#
# source://graphql//lib/graphql/tracing/active_support_notifications_tracing.rb#9
module GraphQL::Tracing::ActiveSupportNotificationsTracing
  class << self
    # source://graphql//lib/graphql/tracing/active_support_notifications_tracing.rb#27
    def trace(key, metadata); end
  end
end
...
class GraphQL::Tracing::AppsignalTracing < ::GraphQL::Tracing::PlatformTracing
  ...
  # source://graphql//lib/graphql/tracing/appsignal_tracing.rb#23
  def platform_field_key(type, field); end

  # source://graphql//lib/graphql/tracing/appsignal_tracing.rb#31
  def platform_resolve_type_key(type); end

  # source://graphql//lib/graphql/tracing/appsignal_tracing.rb#17
...
class GraphQL::Tracing::DataDogTracing < ::GraphQL::Tracing::PlatformTracing
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/tracing/data_dog_tracing.rb#49
  ...
  # source://graphql//lib/graphql/tracing/data_dog_tracing.rb#59
  def analytics_sample_rate; end

  # source://graphql//lib/graphql/tracing/data_dog_tracing.rb#67
  def platform_authorized_key(type); end
  ...
  # source://graphql//lib/graphql/tracing/data_dog_tracing.rb#41
  def service_name; end

  # source://graphql//lib/graphql/tracing/data_dog_tracing.rb#45
  def tracer; end
end
...
# source://graphql//lib/graphql/tracing.rb#88
module GraphQL::Tracing::NullTracer
  private

  # source://graphql//lib/graphql/tracing.rb#90
  def trace(k, v); end
...
class GraphQL::Tracing::PlatformTracing
  ...
  # @api private
  #
  # source://graphql//lib/graphql/tracing/platform_tracing.rb#91
  ...
  # @return [String]
  #
  # source://graphql//lib/graphql/tracing/platform_tracing.rb#133
  def cached_platform_key(ctx, key); end

  # @api private
  #
  # source://graphql//lib/graphql/tracing/platform_tracing.rb#120
  def options; end
  ...
  class << self
    ...
    # @api private
    #
    # source://graphql//lib/graphql/tracing/platform_tracing.rb#97
...
# source://graphql//lib/graphql/tracing/skylight_tracing.rb#5
class GraphQL::Tracing::SkylightTracing < ::GraphQL::Tracing::PlatformTracing
  ...
  #
  # source://graphql//lib/graphql/tracing/skylight_tracing.rb#20
  def initialize(options = T.unsafe(nil)); end

  # source://graphql//lib/graphql/tracing/skylight_tracing.rb#61
  def platform_authorized_key(type); end

  # source://graphql//lib/graphql/tracing/skylight_tracing.rb#57
  def platform_field_key(type, field); end

  # source://graphql//lib/graphql/tracing/skylight_tracing.rb#65
  def platform_resolve_type_key(type); end

  # source://graphql//lib/graphql/tracing/skylight_tracing.rb#26
  def platform_trace(platform_key, key, data); end
end
...
module GraphQL::Tracing::Traceable
  ...
  #
  # source://graphql//lib/graphql/tracing.rb#79
...
class GraphQL::Types::ISO8601Date < ::GraphQL::Schema::Scalar
  class << self
    ...
    # @return [Date]
    #
    # source://graphql//lib/graphql/types/iso_8601_date.rb#26
    def coerce_input(str_value, _ctx); end

    # @param value [Date, Time, DateTime, String]
    # @return [String]
    #
    # source://graphql//lib/graphql/types/iso_8601_date.rb#20
    def coerce_result(value, _ctx); end
  end
end
...
class GraphQL::Types::ISO8601DateTime < ::GraphQL::Schema::Scalar
  class << self
    ...
    # @return [Time]
    #
    # source://graphql//lib/graphql/types/iso_8601_date_time.rb#53
    def coerce_input(str_value, _ctx); end

    # @param value [Time, Date, DateTime, String]
    # @return [String]
    #
    # source://graphql//lib/graphql/types/iso_8601_date_time.rb#37
    def coerce_result(value, _ctx); end

    # @return [Integer]
    #
    # source://graphql//lib/graphql/types/iso_8601_date_time.rb#26
    def time_precision; end

    # @param value [Integer]
    #
    # source://graphql//lib/graphql/types/iso_8601_date_time.rb#31
...
#
# source://graphql//lib/graphql/types/iso_8601_date_time.rb#23
...
#
# source://graphql//lib/graphql/types/relay/base_connection.rb#34
...
# source://graphql//lib/graphql/types/relay/base_connection.rb#0
...
# source://graphql//lib/graphql/types/relay/base_edge.rb#0
...
module GraphQL::Types::Relay::ConnectionBehaviors
  ...
  # source://graphql//lib/graphql/types/relay/connection_behaviors.rb#141
  def edges; end
  ...
  class << self
    # source://graphql//lib/graphql/types/relay/connection_behaviors.rb#130
...
module GraphQL::Types::Relay::ConnectionBehaviors::ClassMethods
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/types/relay/connection_behaviors.rb#71
  ...
  #
  # source://graphql//lib/graphql/types/relay/connection_behaviors.rb#81
  ...
  #
  # source://graphql//lib/graphql/types/relay/connection_behaviors.rb#63
  def nodes_field(node_nullable: T.unsafe(nil)); end

  # Filter this list according to the way its node type would scope them
  #
  # source://graphql//lib/graphql/types/relay/connection_behaviors.rb#58
  def scope_items(items, context); end

  # @return [Boolean]
  #
  # source://graphql//lib/graphql/types/relay/connection_behaviors.rb#75
  def visible?(ctx); end
...
module GraphQL::Types::Relay::DefaultRelay
  ...
  # source://graphql//lib/graphql/types/relay/default_relay.rb#19
  def to_graphql; end
...
module GraphQL::Types::Relay::EdgeBehaviors::ClassMethods
  ...
  # @return [Boolean]
  #
  # source://graphql//lib/graphql/types/relay/edge_behaviors.rb#28
  def authorized?(obj, ctx); end

  # Set the default `node_nullable` for this class and its child classes. (Defaults to `true`.)
  # Use `node_nullable(false)` in your base class to make non-null `node` field.
  #
  # source://graphql//lib/graphql/types/relay/edge_behaviors.rb#42
  def node_nullable(new_value = T.unsafe(nil)); end
  ...
  # @param null [Boolean]
  #
  # source://graphql//lib/graphql/types/relay/edge_behaviors.rb#19
...
#   end
#
# source://graphql//lib/graphql/types/relay/node_field.rb#22
...
#   end
#
# source://graphql//lib/graphql/types/relay/nodes_field.rb#24
...
# source://graphql//lib/graphql/types/relay/page_info.rb#0
...
# @api deprecated
#
# source://graphql//lib/graphql/union_type.rb#4
class GraphQL::UnionType < ::GraphQL::BaseType
  ...
  #
  # source://graphql//lib/graphql/union_type.rb#22
  def initialize; end

  # @api deprecated
  #
  # source://graphql//lib/graphql/union_type.rb#65
  ...
  #
  # source://graphql//lib/graphql/union_type.rb#77
  def get_possible_type(type_name, ctx); end

  # @api deprecated
  # @return [Boolean] True if `child_type_defn` is a member of this {UnionType}
  #
  # source://graphql//lib/graphql/union_type.rb#42
  def include?(child_type_defn, ctx = T.unsafe(nil)); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/union_type.rb#37
  def kind; end
  ...
  #
  # source://graphql//lib/graphql/union_type.rb#86
  def possible_type?(type, ctx); end

  # @api deprecated
  # @return [Array<GraphQL::ObjectType>] Types which may be found in this union
  #
  # source://graphql//lib/graphql/union_type.rb#47
  def possible_types(ctx = T.unsafe(nil)); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/union_type.rb#58
  def possible_types=(types); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/union_type.rb#91
  def resolve_type(value, ctx); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/union_type.rb#95
  def resolve_type=(new_resolve_type_proc); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/union_type.rb#18
  def resolve_type_proc; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/union_type.rb#20
  def type_membership_class; end
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/union_type.rb#19
  def type_memberships; end

  # @api deprecated
  #
  # source://graphql//lib/graphql/union_type.rb#99
  ...
  # @api deprecated
  #
  # source://graphql//lib/graphql/union_type.rb#30
  def initialize_copy(other); end

  # @api deprecated
  #
  # source://graphql//lib/graphql/union_type.rb#105
...
# @api deprecated
#
# source://graphql//lib/graphql/union_type.rb#8
class GraphQL::UnionType::AcceptPossibleTypesDefinition
  class << self
    # @api deprecated
    #
    # source://graphql//lib/graphql/union_type.rb#9
