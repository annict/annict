...
module GraphQL::Tracing::AppsignalTrace
  ...
  # source://graphql//lib/graphql/tracing/monitor_trace.rb#187
  def begin_analyze_multiplex(multiplex, analyzers); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#235
  def begin_authorized(type, object, context); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#255
  def begin_dataloader_source(source); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#203
  def begin_execute_field(field, object, arguments, query); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#245
  def begin_resolve_type(type, value, context); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#227
  def dataloader_fiber_resume(source); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#222
  def dataloader_fiber_yield(source); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#192
  def end_analyze_multiplex(multiplex, analyzers); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#240
  def end_authorized(type, object, context, result); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#260
  def end_dataloader_source(source); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#217
  def end_execute_field(field, object, arguments, query, result); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#250
  def end_resolve_type(type, value, context, resolved_type); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#197
  def execute_multiplex(multiplex:); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#175
  def lex(query_string:); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#169
  def parse(query_string:); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#161
  ...
  # source://graphql//lib/graphql/tracing/monitor_trace.rb#181
  def validate(query:, validate:); end

  private

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#270
  def begin_appsignal_event(keyword, object); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#274
...
# source://graphql//lib/graphql/tracing/monitor_trace.rb#265
GraphQL::Tracing::AppsignalTrace::CURRENT_EV_KEY = T.let(T.unsafe(nil), Symbol)

# source://graphql//lib/graphql/tracing/monitor_trace.rb#266
...
module GraphQL::Tracing::DataDogTrace
  # source://graphql//lib/graphql/tracing/monitor_trace.rb#156
  def initialize(*_arg0, **_arg1, &_arg2); end
...
module GraphQL::Tracing::MonitorTrace
  class << self
    # source://graphql//lib/graphql/tracing/monitor_trace.rb#137
    def create_module(monitor_name); end
  end
end

# source://graphql//lib/graphql/tracing/monitor_trace.rb#151
...
module GraphQL::Tracing::MonitorTrace::Monitor::GraphQLPrefixNames
  # source://graphql//lib/graphql/tracing/monitor_trace.rb#123
  def platform_authorized_key(type); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#119
  def platform_field_key(field); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#127
  def platform_resolve_type_key(type); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#131
...
# source://graphql//lib/graphql/tracing/monitor_trace.rb#116
...
module GraphQL::Tracing::MonitorTrace::Monitor::GraphQLSuffixNames
  ...
  # source://graphql//lib/graphql/tracing/monitor_trace.rb#99
  def platform_authorized_key(type); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#95
  def platform_field_key(field); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#103
  def platform_resolve_type_key(type); end

  # source://graphql//lib/graphql/tracing/monitor_trace.rb#107
  def platform_source_key(source_class); end
end
