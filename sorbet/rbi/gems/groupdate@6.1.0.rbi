...
class Groupdate::Magic::Relation < ::Groupdate::Magic
  ...
  # source://groupdate//lib/groupdate/magic.rb#141
  def cast_method; end

  # source://groupdate//lib/groupdate/magic.rb#165
  def cast_result(result, multiple_groups); end

  # source://groupdate//lib/groupdate/magic.rb#188
  ...
  # @return [Boolean]
  #
  # source://groupdate//lib/groupdate/magic.rb#178
  def time_zone_support?(relation); end

  class << self
    # @raise [Groupdate::Error]
    #
    # source://groupdate//lib/groupdate/magic.rb#199
    def generate_relation(relation, field:, **options); end

    # allow any options to keep flexible for future
    #
    # source://groupdate//lib/groupdate/magic.rb#255
    def process_result(relation, result, **options); end
    ...
    #
    # source://groupdate//lib/groupdate/magic.rb#247
    ...
    #
    # source://groupdate//lib/groupdate/magic.rb#234
