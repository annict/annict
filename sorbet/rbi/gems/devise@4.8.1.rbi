...
class ActionDispatch::Routing::Mapper
  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/mapper.rb#2302
  ...
  class << self
    # source://actionpack/7.0.8.1/lib/action_dispatch/routing/mapper.rb#381
    def normalize_name(name); end

    # source://actionpack/7.0.8.1/lib/action_dispatch/routing/mapper.rb#364
...
class ActionDispatch::Routing::RouteSet
  ...
  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#366
  def initialize(config = T.unsafe(nil)); end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#615
  def add_polymorphic_mapping(klass, options, &block); end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#584
  def add_route(mapping, name); end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#619
  def add_url_helper(name, options, &block); end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#395
  def api_only?; end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#415
  def append(&block); end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#849
  def call(env); end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#439
  def clear!; end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#336
  def default_scope; end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#336
  def default_scope=(_arg0); end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#338
  def default_url_options; end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#338
  def default_url_options=(_arg0); end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#461
  def define_mounted_helper(name, script_namer = T.unsafe(nil)); end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#337
  def disable_clear_and_finalize; end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#337
  def disable_clear_and_finalize=(_arg0); end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#408
  def draw(&block); end
  ...
  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#385
  def eager_load!; end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#580
  def empty?; end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#339
  def env_key; end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#760
  def extra_keys(options, recall = T.unsafe(nil)); end

  # source://devise//lib/devise/rails/routes.rb#8
  def finalize!; end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#792
  def find_relative_url_root(options); end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#788
  ...
  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#764
  def generate_extras(options, recall = T.unsafe(nil)); end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#488
  def generate_url_helpers(supports_path); end

  def inspect; end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#457
  ...
  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#784
  def optimize_routes_generation?; end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#796
  def path_for(options, route_name = T.unsafe(nil), reserved = T.unsafe(nil)); end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#339
  def polymorphic_mappings; end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#419
  def prepend(&block); end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#855
  def recognize_path(path, environment = T.unsafe(nil)); end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#870
  def recognize_path_with_request(req, path, extras, raise_on_missing: T.unsafe(nil)); end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#391
  def relative_url_root; end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#399
  ...
  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#801
  def url_for(options, route_name = T.unsafe(nil), url_strategy = T.unsafe(nil), method_name = T.unsafe(nil), reserved = T.unsafe(nil)); end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#480
  def url_helpers(supports_path = T.unsafe(nil)); end

  private

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#423
  def eval_block(block); end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#775
  def generate(route_name, options, recall = T.unsafe(nil), method_name = T.unsafe(nil)); end

  # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#403
  def make_request(env); end

  class << self
    # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#343
    def default_resources_path_names; end

    # source://actionpack/7.0.8.1/lib/action_dispatch/routing/route_set.rb#347
