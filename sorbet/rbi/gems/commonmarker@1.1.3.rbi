...
module Commonmarker::Config
  ...
  class << self
    # source://commonmarker//lib/commonmarker/config.rb#51
    def merged_with_defaults(options); end

    # source://commonmarker//lib/commonmarker/config.rb#71
    ...
    # source://commonmarker//lib/commonmarker/config.rb#63
    def process_plugins(plugins); end

    # source://commonmarker//lib/commonmarker/config.rb#71
    def process_render_options(option); end

    # source://commonmarker//lib/commonmarker/config.rb#87
...
# source://commonmarker//lib/commonmarker/config.rb#41
