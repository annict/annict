...
module Commonmarker::Config
  ...
  class << self
    # source://commonmarker//lib/commonmarker/config.rb#80
    def process_extension_options(options); end

    # source://commonmarker//lib/commonmarker/config.rb#64
    def process_options(options); end

    # source://commonmarker//lib/commonmarker/config.rb#80
    def process_parse_options(options); end

    # source://commonmarker//lib/commonmarker/config.rb#72
    def process_plugins(plugins); end

    # source://commonmarker//lib/commonmarker/config.rb#80
    def process_render_options(options); end

    # source://commonmarker//lib/commonmarker/config.rb#97
...
# source://commonmarker//lib/commonmarker/config.rb#54
