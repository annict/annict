...
# source://ruby-next-core//lib/ruby-next/core/data.rb#14
class Data
  # @return [Data] a new instance of Data
  #
  # source://ruby-next-core//lib/ruby-next/core/data.rb#77
  def initialize(**kwargs); end

  # source://ruby-next-core//lib/ruby-next/core/data.rb#125
  def ==(other); end

  # source://ruby-next-core//lib/ruby-next/core/data.rb#102
  def deconstruct; end

  # @raise [TypeError]
  #
  # source://ruby-next-core//lib/ruby-next/core/data.rb#106
  def deconstruct_keys(array); end

  # @return [Boolean]
  #
  # source://ruby-next-core//lib/ruby-next/core/data.rb#121
  def eql?(other); end

  # source://ruby-next-core//lib/ruby-next/core/data.rb#117
  def hash; end

  # source://ruby-next-core//lib/ruby-next/core/data.rb#129
  def inspect; end

  # source://ruby-next-core//lib/ruby-next/core/data.rb#73
  def members; end

  # source://ruby-next-core//lib/ruby-next/core/data.rb#113
  def to_h(&block); end

  # source://ruby-next-core//lib/ruby-next/core/data.rb#129
  def to_s; end

  # source://ruby-next-core//lib/ruby-next/core/data.rb#141
  def with(**kwargs); end

  private

  # source://ruby-next-core//lib/ruby-next/core/data.rb#158
  def initialize_copy(source); end

  # source://ruby-next-core//lib/ruby-next/core/data.rb#149
  def marshal_dump; end

  # source://ruby-next-core//lib/ruby-next/core/data.rb#153
  def marshal_load(attributes); end

  class << self
    # @raise [ArgumentError]
    #
    # source://ruby-next-core//lib/ruby-next/core/data.rb#22
    def define(*args, &block); end

    # @private
    #
    # source://ruby-next-core//lib/ruby-next/core/data.rb#69
    def inherited(subclass); end

    # Returns the value of attribute members.
    #
    # source://ruby-next-core//lib/ruby-next/core/data.rb#19
    def members; end
  end
end
