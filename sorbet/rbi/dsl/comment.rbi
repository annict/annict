...
class Comment
  ...
  module GeneratedAssociationMethods
    ...
    def episode_record_changed?; end

    sig { returns(T::Boolean) }
    def episode_record_previously_changed?; end
    ...
    # This method is created by ActiveRecord on the `Comment` class because it declared `has_many :notifications`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(::Integer) }
    def episode_record_id; end

    sig { params(value: ::Integer).returns(::Integer) }
    def episode_record_id=(value); end

    sig { returns(T::Boolean) }
    def episode_record_id?; end

    sig { returns(T.nilable(::Integer)) }
    def episode_record_id_before_last_save; end

    sig { returns(T.untyped) }
    def episode_record_id_before_type_cast; end

    sig { returns(T::Boolean) }
    def episode_record_id_came_from_user?; end

    sig { returns(T.nilable([::Integer, ::Integer])) }
    def episode_record_id_change; end

    sig { returns(T.nilable([::Integer, ::Integer])) }
    def episode_record_id_change_to_be_saved; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def episode_record_id_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::Integer)) }
    def episode_record_id_in_database; end

    sig { returns(T.nilable([::Integer, ::Integer])) }
    def episode_record_id_previous_change; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def episode_record_id_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::Integer)) }
    def episode_record_id_previously_was; end

    sig { returns(T.nilable(::Integer)) }
    def episode_record_id_was; end

    sig { void }
    def episode_record_id_will_change!; end
    ...
    sig { void }
    def restore_episode_record_id!; end
    ...
    sig { returns(T.nilable([::Integer, ::Integer])) }
    def saved_change_to_episode_record_id; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def saved_change_to_episode_record_id?(from: T.unsafe(nil), to: T.unsafe(nil)); end
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def will_save_change_to_episode_record_id?(from: T.unsafe(nil), to: T.unsafe(nil)); end
