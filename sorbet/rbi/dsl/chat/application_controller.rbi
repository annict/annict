...
# This is an autogenerated file for dynamic methods in `Chat::ApplicationController`.
# Please instead update this file by running `bin/tapioca dsl Chat::ApplicationController`.
...
class Chat::ApplicationController
  ...
  module HelperMethods
    ...
    def local_url(*args, **kwargs, &blk); end
