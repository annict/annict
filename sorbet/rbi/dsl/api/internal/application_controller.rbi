...
# This is an autogenerated file for dynamic methods in `Api::Internal::ApplicationController`.
# Please instead update this file by running `bin/tapioca dsl Api::Internal::ApplicationController`.


class Api::Internal::ApplicationController
