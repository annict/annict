...
class Activity
  ...
  module GeneratedAssociationMethods
    ...
    sig { params(args: T.untyped, blk: T.untyped).returns(::ActivityGroup) }
    def create_activity_group(*args, &blk); end
    ...
    sig { returns(T.untyped) }
    def reload_itemable; end

    sig { returns(T.nilable(::User)) }
    def reload_user; end

    sig { void }
    def reset_activity_group; end

    sig { void }
    def reset_itemable; end
  ...
  module GeneratedAttributeMethods
    sig { returns(::Integer) }
    def activity_group_id; end

    sig { params(value: ::Integer).returns(::Integer) }
    def activity_group_id=(value); end

    sig { returns(T::Boolean) }
    def activity_group_id?; end

    sig { returns(T.nilable(::Integer)) }
    def activity_group_id_before_last_save; end

    sig { returns(T.untyped) }
    def activity_group_id_before_type_cast; end

    sig { returns(T::Boolean) }
    def activity_group_id_came_from_user?; end

    sig { returns(T.nilable([::Integer, ::Integer])) }
    def activity_group_id_change; end
    ...
    sig { returns(T.nilable(::Integer)) }
    def activity_group_id_in_database; end
    ...
    sig { returns(T.nilable(::Integer)) }
    def activity_group_id_previously_was; end

    sig { returns(T.nilable(::Integer)) }
    def activity_group_id_was; end

    sig { void }
    def activity_group_id_will_change!; end
    ...
    sig { void }
    def restore_activity_group_id!; end
