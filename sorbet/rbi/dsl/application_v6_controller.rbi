...
# This is an autogenerated file for dynamic methods in `ApplicationV6Controller`.
# Please instead update this file by running `bin/tapioca dsl ApplicationV6Controller`.


class ApplicationV6Controller
