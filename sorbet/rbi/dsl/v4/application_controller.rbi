...
# This is an autogenerated file for dynamic methods in `V4::ApplicationController`.
# Please instead update this file by running `bin/tapioca dsl V4::ApplicationController`.


class V4::ApplicationController
