...
# This is an autogenerated file for dynamic methods in `V4::LocalApi::GraphqlController`.
# Please instead update this file by running `bin/tapioca dsl V4::LocalApi::GraphqlController`.


class V4::LocalApi::GraphqlController
